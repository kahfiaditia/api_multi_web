        ...
        <div class="page-title-box">
            <div class="row">
                ...
                <div class="col-auto align-self-center">
                    <a href="{{ route('data_invoice.create') }}" class="btn btn-sm btn-outline-primary">
        ...
        <div class="card">
            <div class="card-body">
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        @foreach ($data_pengirim as $item)
                            <tr>
                                <td>
                                    <img src="assets/pengirim_gambar/{{ $item->logo_perusahaan }}" alt="" height="40">
                                    <p class="d-inline-block align-middle mb-0">
                                       {{ $item->nama }}
                                        <br>
                                        <span class="text-muted font-13">{{ $item->created_at }}</span> 
                                    </p>
                                </td>
