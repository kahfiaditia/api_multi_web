                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if($sosial->path_logo)
                                        ...
                                        <img src="{{ asset($sosial->path_logo) }}" alt="Logo" class="img-thumbnail mt-1" width="100">
                                    @endif
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="status1" id="status1" class="form-select">
                                        <option value="1" {{ $sosial->status == 1 ? 'selected' : '' }}>Aktif</option>
                                        <option value="0" {{ $sosial->status == 0 ? 'selected' : '' }}>Non Aktif</option>
                                    </select>
                                </div>
                            </div>
