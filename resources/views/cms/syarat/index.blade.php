                    ...
                    <div class="card shadow-sm rounded-3">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <!-- Tombol Tambah -->
                                <a href="{{ route('syarat_web.create') }}" class="btn btn-success btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($syarat->path_gambar)
                                                        <img src="{{ asset($syarat->path_gambar) }}" 
                                                             alt="gambar-syarat" class="img-thumbnail" width="80">
                                                    @else
                                                ...
                                                <td>
                                                    <form class="delete-form d-inline"
                                                        action="{{ route('syarat_web.destroy', Crypt::encryptString($syarat->id)) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            <!-- View -->
                                                            <a href="{{ route('syarat_web.show', Crypt::encryptString($syarat->id)) }}"
                                                                class="btn btn-sm btn-info">
                                                                <i class="fas fa-eye"></i>
                                                            </a>

                                                            <!-- Edit -->
                                                            <a href="{{ route('syarat_web.edit', Crypt::encryptString($syarat->id)) }}"
