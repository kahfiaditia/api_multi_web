                ...
                <form id="formUpload" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mt-3">
                            ...
                            <input type="text" name="judul_banner" id="judul_banner" class="form-control" placeholder="Masukkan judul_banner" required>
                        </div>
...
<script>
    ...
    $('#simpanMedia').click(function () {
            ...
            if ($('#gambar_banner')[0].files[0]) {
                formData.append('gambar_banner', $('#gambar_banner')[0].files[0]);
            }
          
            $.ajax({
                type: "POST",
                url: "{{ route('desa_banner.store') }}",
                data: formData,
                processData: false,
                contentType: false,
                success: (response) => {
                    ...
                    if (response.code === 200) {
                        Swal.fire(
                            ...
                            window.location = APP_URL + '/desa_banner';
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',
