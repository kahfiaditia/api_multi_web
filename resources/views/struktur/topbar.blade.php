<div class="topbar">            
    ...
    <nav class="navbar-custom">    
        <ul class="list-unstyled topbar-nav float-right mb-0">  
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                    ...
                    <img src="{{ asset('assets/user_foto/'. Auth::user()->image ) }}" alt="profile-user" class="rounded-circle" />                                 
                </a>
        ...
        <ul class="list-unstyled topbar-nav mb-0">                        
            ...
            <li class="creat-btn">
                <div class="nav-link">
                    <a class=" btn btn-sm btn-soft-primary"><i class="fas fa-user-shield mr-2"></i>{{ Auth::user()->roles }}</a>
                </div>                                
            </li>                           
        </ul>
    </nav>
