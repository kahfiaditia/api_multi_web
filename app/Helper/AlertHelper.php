...
class AlertHelper
{
    ...
    public static function AddKode($success)
    {
        Alert::error('Gagal!', 'Kode sudah terdaftar.');
    }

    public static function AddEmail($success)
    {
        Alert::error('Gagal!', 'Email sudah digunakan.');
    }

    public static function AddUsername($success)
    {
        Alert::error('Gagal!', 'Username sudah terpakai.');
    }

    public static function AddTelepon($success)
    {
