...
(!(function (e, t) {
        ...
        V = (e, t, o) => {
            if (
                ...
                if (
                    ...
                    return void l(
                        `Invalid type of customClass.${o}! Expected string or iterable object, got "${typeof t.customClass[o]}"`,
                    );
                R(e, t.customClass[o]);
            }
        },
    ...
    const tt = (e) => {
        ...
        ft = (e, t) => {
            ...
            if (!n.input)
                return void c(
                    `The "input" parameter is needed to be set when using returnInputValueOn${a(t)}`,
                );
            const i = ((e, t) => {
                const o = e.getInput();
                if (!o) return null;
