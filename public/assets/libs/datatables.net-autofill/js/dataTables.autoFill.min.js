...
!(function (o) {
    ...
    function r(t, e) {
        ...
        ((this.c = m.extend(!0, {}, n.defaults.autoFill, r.defaults, e)),
            (this.s = {
                dt: new n.Api(t),
        ...
        t =
            (m.extend(r.prototype, {
                ...
                _constructor: function () {
                    ...
                    ((e.settings()[0].autoFill = this),
                        o.length &&
                            "static" ===
                                (this.dom.dtScroll = o).css("position") &&
                ...
                _attach: function (t) {
                    var e = this.s.dt,
                        ...
                        n = this.s.handle;
                    o &&
                    -1 !== e.columns(this.c.columns).indexes().indexOf(o.column)
                        ? (this.dom.offsetParent ||
                              (this.dom.offsetParent = m(
                                  e.table().node(),
                              ).offsetParent()),
                          (n.height && n.width) ||
                              (i.appendTo("body"),
                ...
                _drawSelection: function (t, e) {
                    ...
                    i.cell(a).any() &&
                        ...
                        (t =
                            this._getPosition(s.get(0)).top +
                            s.outerHeight() -
                            i),
                        (a =
                            this._getPosition(n.get(0)).left +
                            n.outerWidth() -
                            o),
                    ...
                    if (o) {
                        for (
                            ...
                            for (var r = 0, d = t[s].length; r < d; r++) {
                                var c = t[s][r],
                                    u =
                                        e.settings()[0].aoColumns[
                                            c.index.column
                                        ],
                                    h = u.editField;
                                if (h === b)
                                    for (
                                        var f = u.mData, m = 0, p = l.length;
                                        m < p;
                                        m++
                                    ) {
                                        var v = o.field(l[m]);
                        ...
                        : "click" === o
                          ? (m(e.table().body()).on(
                            ...
                            m(p.body).on("click" + t, function (t) {
                                m(t.target).parents().filter(e.table().body())
                                    .length || i._detach();
                            }))
                          : m(e.table().body())
                                .on(
                                ...
                                .on(
                                    "mouseleave" + t + "touchend" + t,
                                    function (t) {
                                        m(t.relatedTarget).hasClass(
                                            "dt-autofill-handle",
                                        ) || i._detach();
                                    },
                                );
                ...
                _mousedown: function (t) {
                    var e = this,
                        ...
                        i =
                            ...
                            m(p.body)
                                .on(
                                    "mousemove.autoFill touchmove.autoFill",
                                    function (t) {
                                        (e._mousemove(t),
                                            "touchmove" === t.type &&
                                                m(p.body).one(
                                ...
                                .on(
                                    "mouseup.autoFill touchend.autoFill",
                                    function (t) {
                                        e._mouseup(t);
                                    },
                                ),
                ...
                _shiftScroll: function (t) {
                    ...
                    (t < 65 ? (e = -5) : t > s.windowHeight - 65 && (e = 5),
                        ...
                        null !== s.dtTop && t < s.dtTop + 65
                            ? (i = -5)
                            : null !== s.dtTop &&
                              t > s.dtTop + s.dtHeight - 65 &&
                              (i = 5),
                        null !== s.dtLeft && r < s.dtLeft + 65
                            ? (n = -5)
                            : null !== s.dtLeft &&
                              r > s.dtLeft + s.dtWidth - 65 &&
                              (n = 5),
                        e || o || i || n
                            ? ((s.windowVert = e),
                              (s.windowHoriz = o),
            ...
            (r.actions = {
                ...
                fill: {
                    ...
                    execute: function (t, e, o) {
                        for (
                            var i = e[0][0].data, n = 0, l = e.length;
                            n < l;
                            n++
                        )
                            for (var s = 0, a = e[n].length; s < a; s++)
    ...
    return (
        ...
        m(p).on("preInit.dt.autofill", function (t, e, o) {
            ...
            "dt" === t.namespace &&
                ((t = e.oInit.autoFill),
                (i = n.defaults.autoFill),
                (t || i) &&
                    ((i = m.extend({}, t, i)), !1 !== t && new r(e, i)));
        }),
        (n.AutoFill = r),
