                        ...
                        if (unit == "year") {
                            if (
                                ...
                                var magn = Math.pow(
                                    ...
                                    Math.floor(
                                        Math.log(
                                            axis.delta / timeUnitSize.year,
                                        ) / Math.LN10,
                                    ),
                                );
                                var norm =
                                    axis.delta / timeUnitSize.year / magn;
                                if (norm < 1.5) {
                                    size = 1;
                                } else if (norm < 3) {
                                    size = 2;
