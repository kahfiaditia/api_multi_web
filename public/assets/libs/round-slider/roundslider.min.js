    ...
    ((p.fn[o] = function (t) {
                ...
                if (a) {
                    if (p.isPlainObject(t))
                        "function" == typeof a.option
                            ...
                            : s.id &&
                              window[s.id] &&
                              "function" == typeof window[s.id].option &&
                              window[s.id].option(t);
                    else if (
                        "string" == typeof t &&
                        "function" == typeof a[t]
                    ) {
                        if (
                            ("option" === t || 0 === t.indexOf("get")) &&
                            void 0 === e[2]
                        )
                            return a[t](e[1]);
                        a[t](e[1], e[2]);
        ...
        (r.prototype = {
            ...
            _init: function () {
                ...
                (e.svgMode &&
                    ...
                    this.control.is("input") &&
                        ...
                        (e.value = this._hiddenField.val() || e.value)),
                    this._isBrowserSupported() && this._onInit());
            },
            _onInit: function () {
            ...
            _createLayers: function () {
                ...
                var e = t.width,
                    i = this._start,
                    s = this.$createElement("div.rs-path rs-transition");
                (this._showRange
                    ? ((this.block1 = s
                          .clone()
                      ...
                      this.block
                          ...
                          .addClass("rs-split"))
                    : this.block.append(s.addClass("rs-path-color")),
            ...
            _setProperties: function () {
                ...
                (this._setHandleShape(),
                    this._addAnimation(),
                    this._appendTooltip(),
                    t.showTooltip || this._removeTooltip(),
                    t.disabled
                        ? this.disable()
                        : t.readOnly && this._readOnly(!0),
                    t.mouseScrollAction && this._bindScrollEvents("_bind"));
            },
            _updatePre: function () {
                this._prechange =
                    this._predrag =
            ...
            _setValue: function () {
                ...
                this._rangeSlider
                    ...
                    : (this._minRange &&
                      ...
                      (t = this._minRange ? 2 : this._active || 1),
            ...
            _appendTooltip: function () {
                ...
                0 === this.container.children(".rs-tooltip").length &&
                    ((t = this.tooltip =
                        this.$createElement("span.rs-tooltip rs-tooltip-text")),
            ...
            _setTooltipColor: function (t) {
                var e = this.options,
                    i = e.tooltipColor,
                    s = "inherit" !== i ? i : e.rangeColor;
                t && null != s && t.css("color", s);
            },
            _tooltipEditable: function () {
                ...
                e &&
                    ...
                    this[
                        t.editableTooltip
                            ? (e.addClass("rs-edit"), "_bind")
                            : (e.removeClass("rs-edit"), "_unbind")
            ...
            _editTooltip: function (t) {
                ...
                s.hasClass("rs-edit") &&
                    !this._isReadOnly &&
                    ((e = 2 * parseFloat(s.css("border-left-width"))),
                    (i = this.input =
                        this.$createElement(
                            "input.rs-input rs-tooltip-text",
                        ).css({
                            height: s.outerHeight() - e,
                            width: s.outerWidth() - e,
                        })),
                    this._setTooltipColor(i),
                    s.html(i).removeClass("rs-edit").addClass("rs-hover"),
                    i.focus().val(this._getTooltipValue(!0)),
                    this._bind(i, "blur change", this._focusOut));
            },
            _focusOut: function (t) {
                var e;
                "change" == t.type
                    ? ("," == (e = this.input.val().replace("-", ","))[0] &&
                          (e = "-" + e.slice(1).replace("-", ",")),
            ...
            _setHandleShape: function () {
                var t = this.options,
                    e = t.handleShape,
                    i = this._handles();
                (i.removeClass("rs-handle-dot rs-handle-square"),
                    "dot" == e
                        ? i.addClass("rs-handle-dot")
                        : "square" == e
                          ? i.addClass("rs-handle-square")
                          : (t.handleShape = "round"));
            },
            ...
            _setContainerClass: function () {
                ...
                "full" == t || "pie" == t || 0 === t.indexOf("custom")
                    ? this.container.addClass("rs-full rs-" + t)
            ...
            _setRadius: function () {
                var t,
                    ...
                    h = (t = n),
                    l = (e = n),
                    d = "full" == r || "pie" == r || 0 === r.indexOf("custom");
                if (
                    (s.svgMode &&
                        !d &&
                        ((i = this._handleBars()),
                        "none" != s.lineCap
                            ? ((o =
                                  "butt" === s.lineCap
                                      ? s.borderWidth / 2
                                      : s.width / 2 + s.borderWidth),
                              -1 != r.indexOf("bottom") &&
                                  i.css("margin-top", o + "px"),
                              -1 != r.indexOf("right") &&
                                  i.css("margin-right", -o + "px"))
                ...
                else 0 === r.indexOf("quarter") && (t = e = (h = l = a) + o);
                (this.container.css({ height: h, width: l }),
            ...
            _addSeperator: function (t, e) {
                var i = this.$createElement("span.rs-seperator rs-border"),
                    s = this.$createElement("span.rs-bar rs-transition " + e)
                        .append(i)
                        .rsRotate(t);
            ...
            _createHandle: function (t) {
                ...
                return (
                    r.addClass(
                        this._rangeSlider && 2 == t ? "rs-second" : "rs-first",
                    ),
                    r.rsRotate(n.angle),
                    ...
                    1 != (this._active = t) &&
                        2 != t &&
                        (this["_handle" + t] = n),
                    this._bind(i, "focus blur", this._handleFocus),
                    i
                );
            },
                    ...
                    ("+" === a.charAt(0) || "-" === a.charAt(0)
                        ...
                        : !a.indexOf(",") ||
                          (o((i = a.split(","))[0]) &&
                              ...
                              (t = parseFloat(i[1])),
                              (r = !1)))),
                    r && (t = e = o(a) ? parseFloat(a) : n));
                var h = (n + this._border() - e) / 2;
                this._handles().css({
                    height: t,
                    width: e,
            ...
            _activeHandleBar: function (t) {
                return this._minRange
                    ? this.bar
                    : ((t = null != t ? t : this._active),
                      p(this._handleBars()[t - 1]));
            },
            _handleArgs: function (t) {
                var e =
                    this["_handle" + (t = null != t ? t : this._active)] || {};
                return {
            ...
            _raiseEvent: function (t) {
                var e,
                    i = this["_pre" + t],
                    s = this.options.value;
                i !== s &&
                    ((this["_pre" + t] = s),
                    "change" == t &&
                        ((this._predrag = s), this._updateHidden()),
                    this._updateTooltip(),
                    (e = this._handleArgs()),
                    this._raise(t, { value: s, preValue: i, handle: e }),
                    s != this._preValue &&
                        (this._raise("update", {
                            value: s,
                            preValue: i,
            ...
            _raiseBeforeValueChange: function (t, e) {
                ...
                var s = {
                    ...
                    a = 0 != this._raise("beforeValueChange", s);
                return (a && (this._pre_bvc = e), a);
            },
            ...
            _elementDown: function (t) {
                var e, i, s, a, n, r, o, h, l;
                this._isReadOnly ||
                    (p(t.target).hasClass("rs-handle")
                        ? this._handleDown(t)
                        : ((e = this._getXY(t)),
                          (i = this._getCenterPoint()),
                          (s = this._getDistance(e, i)),
                          (a =
                              (this.block || this.svgContainer).outerWidth() /
                              2) -
                              (this.options.width + this._border()) <=
                              s &&
                              s <= a &&
                              (0 !==
                                  (n = this.control.find(".rs-handle.rs-focus"))
                                      .length && t.preventDefault(),
                              (h = (r = this._getAngleValue(e, i)).angle),
                              (l = r.value),
                              this._rangeSlider &&
                                  (1 == n.length
                                      ? ((o = parseFloat(n.attr("index"))),
                                        this._invertRange ||
                                            (1 == o && h > this._handle2.angle
                                                ? (o = 2)
                                                : 2 == o &&
                                                  h < this._handle1.angle &&
                                                  (o = 1)),
                                        (this._active = o))
                                      : (this._active =
                                            this._handle2.angle - h <
                                            h - this._handle1.angle
                                                ? 2
                                                : 1),
                                  (this.bar = this._activeHandleBar())),
                              this._raiseBeforeValueChange("change", l) &&
                                  (this._changeSliderValue(l, h),
                                  this._raiseEvent("change")))));
            },
            ...
            _handleMove: function (t) {
                ...
                var e = this._getXY(t),
                    i = this._getCenterPoint(),
                    s = this._getAngleValue(e, i, !0),
                    a = s.angle,
                    n = s.value;
                this._raiseBeforeValueChange("drag", n) &&
                    (this._changeSliderValue(n, a), this._raiseEvent("drag"));
            },
            ...
            _handleFocus: function (t) {
                ...
                this._isReadOnly ||
                    ...
                    (e = this.options.keyboardAction) &&
                        this._bindKeyboardEvents("_unbind"),
                    "blur" !== t.type &&
                        ((i = p(t.target)).addClass("rs-focus"),
                        (this.bar = i.parent()),
                        (this._active = parseFloat(i.attr("index"))),
                        e && this._bindKeyboardEvents("_bind"),
            ...
            _handleKeyDown: function (t) {
                var e,
                    ...
                    a = t.keyCode,
                    n = this.keys;
                (27 == a && this._handles().blur(),
                    35 <= a &&
                        a <= 40 &&
                        (37 <= a && a <= 40 && this._removeAnimation(),
                        (e = this["_handle" + this._active]),
                        t.preventDefault(),
                        a == n.UP || a == n.RIGHT
                            ? (i = this._round(
                                  this._limitValue(e.value + this.options.step),
                              ))
                            : a == n.DOWN || a == n.LEFT
                              ? (i = this._round(
                                    this._limitValue(
                                        e.value - this._getMinusStep(e.value),
                                    ),
                                ))
                              : 36 == a
                                ? (i = this._getKeyValue("Home"))
                                : 35 == a && (i = this._getKeyValue("End")),
            ...
            _elementScroll: function (t) {
                ...
                this._isReadOnly ||
                    (t.preventDefault(),
                    0 !=
                        (n = (e = t.originalEvent || t).wheelDelta
                            ? e.wheelDelta / 60
                            : e.detail
                              ? -e.detail / 2
                              : 0) &&
                        ...
                        (s =
                            (i = this["_handle" + this._active]).value +
                            (0 < n
                                ? this.options.step
                                : -this._getMinusStep(i.value))),
                        (s = this._limitValue(s)),
                        (a = this._valueToAngle(s)),
                        this._raiseBeforeValueChange("change", s) &&
                            (this._removeAnimation(),
                            this._changeSliderValue(s, a),
                            this._raiseEvent("change"),
                            this._addAnimation())));
            },
            ...
            _bindMouseEvents: function (t) {
                var e = p(document);
                (this[t](e, "mousemove touchmove", this._handleMove),
                    this[t](
                        e,
            ...
            _bindKeyboardEvents: function (t) {
                var e = p(document);
                (this[t](e, "keydown", this._handleKeyDown),
                    this[t](e, "keyup", this._handleKeyUp));
            },
            _changeSliderValue: function (t, e) {
                ...
                if (this._showRange) {
                    var r =
                            (1 == a &&
                                i <= this._oriAngle(this._handle2.angle)) ||
                            (2 == a &&
                                i >= this._oriAngle(this._handle1.angle)),
                        o = this._invertRange;
                    if (this._minRange || r || o) {
                        if (
                            ((this["_handle" + a] = { angle: e, value: t }),
                            (n.value = this._rangeSlider
                                ? this._handle1.value +
                                  "," +
                                  this._handle2.value
                                : t),
                        ...
                        (h <= 180 &&
                            !(h < 0 && -180 < h) &&
                            ((l = "0"), (d = "1")),
                            this.block2.css("opacity", l),
                            this.block3.css("opacity", d),
                            (1 == a ? this.block4 : this.block2).rsRotate(
                                s - 180,
                            ),
            ...
            _setSVGStyles: function () {
                ...
                (e &&
                    ("inherit" == e && (e = s),
                    p(this.$border).css("stroke", e)),
                    i &&
                        (this.svgContainer[
                            "inherit" == i ? "addClass" : "removeClass"
                        ]("rs-path-inherited"),
                        "inherit" == i && (i = s),
                        p(this.$path).css("stroke", i)),
            ...
            _moveSliderRange: function (t) {
                ...
                this._showRange &&
                    ((e = this._start),
                    (i = this._end),
                    (r = this._handle1.angle),
                    (o = this._handle2.angle),
                    t && (r = o = this._handleDefaults().angle),
                    (s = []),
                    (a = (r -= e) <= (o -= e)),
                    (this._isInvertedRange = !a),
                    a
                        ? s.push(0)
                        : (this._minRange && s.push(0),
                          (n = r),
                          (r = o),
                          (o = n)),
                    (h = (r / i) * this.svgPathLength),
                    s.push(h),
                    (l = ((o - r) / i) * this.svgPathLength),
                    s.push(l, this.svgPathLength),
                    (this.$range.style.strokeDasharray = s.join(" ")));
            },
            ...
            _updateARIA: function (t) {
                var e,
                    ...
                    s = i.min,
                    a = i.max;
                (this.bar.children().attr({ "aria-valuenow": t }),
                    this._rangeSlider
                        ? ((e = this._handles())
                              .eq(0)
                              .attr({ "aria-valuemin": s }),
                          e.eq(1).attr({ "aria-valuemax": a }),
                          1 == this._active
                              ? e.eq(1).attr({ "aria-valuemin": t })
                              : e.eq(0).attr({ "aria-valuemax": t }))
                        : this.bar
                              .children()
                              .attr({
                                  "aria-valuemin": s,
            ...
            _processStepByValue: function (t) {
                var e = this.options,
                    ...
                    n = s < i,
                    r = t - ((t - i) % (a = n ? -a : a)),
                    o = this._limitValue(r + a),
                    h = this._limitValue(r - a),
                    l = n
                        ? t <= r
                            ? r - t < t - o
                                ? r
                        ...
                        : r <= t
                          ...
                          : t - h < r - t
                            ...
                            : h;
                return {
                    value: (l = this._round(l)),
                    angle: this._valueToAngle(l),
                };
            },
            _round: function (t) {
                var e = this.options.step.toString().split(".");
                return e[1]
                    ? parseFloat(t.toFixed(e[1].length))
                    : Math.round(t);
            },
            ...
            _updateTooltip: function () {
                var t = this.options,
                    e = this.tooltip;
                (e &&
                    (e.hasClass("rs-hover") || e.html(this._getTooltipValue()),
                    this._updateTooltipPos()),
                    !t.showTooltip &&
                        t.mouseScrollAction &&
                        this.control.height());
            ...
            _updateTooltipPos: function () {
                ...
                s.showTooltip &&
                    0 !== a.indexOf("quarter") &&
                    ((t = this.tooltip).is(":visible")
                        ? (t.removeClass("rs-center").addClass("rs-reset"),
                          (e = -t.outerHeight() / 2),
                          (i = -t.outerWidth() / 2),
                          t.removeClass("rs-reset"),
                          "full" == a || "pie" == a || 0 === a.indexOf("custom")
                              ? (n = { "margin-top": e, "margin-left": i })
                              : "half-top" == a || "half-bottom" == a
                                ? (n = { "margin-left": i })
                                : ("half-left" != a && "half-right" != a) ||
                                  (n = { "margin-top": e }))
                        : t.addClass("rs-center"),
                    t.css(n));
            },
            _getTooltipValue: function (t) {
                ...
                if (this._rangeSlider) {
                    ...
                    return t
                        ? i[0] + " - " + i[1]
                        : this._tooltipValue(i[0], 1) +
                              " - " +
                              this._tooltipValue(i[1], 2);
                }
            ...
            _checkOverlay: function (t, e) {
                ...
                (0 == i.length &&
                    ((i = this.$createElement(
                        "div" + t + " rs-transition rs-bg-color",
                    )),
            ...
            _analyzeModelValue: function () {
                ...
                (1 == a.length && this.isNumber(a[0])
                    ? (a = [t.min, a[0]])
                    : 2 <= a.length && !this.isNumber(a[1]) && (a[1] = t.max),
                    (s = this._rangeSlider
                        ? [
                              this._parseModelValue(a[0]),
                              this._parseModelValue(a[1]),
                          ].toString()
                        : ((i = a.pop()), this._parseModelValue(i))),
                    (t.value = s));
            },
            ...
            _validateModelValue: function () {
                ...
                (this._rangeSlider
                    ? ((t = n.split(",")),
                      ...
                      this._invertRange ||
                          ((e = a.min),
                          a.max < e ? i < s && (i = s) : s < i && (s = i)),
                      (this._handle1 = this._processStepByValue(i)),
                      (this._handle2 = this._processStepByValue(s)))
                    : (this[
                          "_handle" + (this._minRange ? 2 : this._active || 1)
                      ] = this._processStepByValue(this._limitValue(n))),
                    this._updateModelValue());
            },
            _updateModelValue: function () {
                ...
                ((t = this._rangeSlider
                    ...
                    : this["_handle" + (this._minRange ? 2 : this._active || 1)]
                          .value),
                ...
                return (
                    ...
                    0 <= e.indexOf(" OPR/")
                        ...
                        : "undefined" != typeof InstallTrigger
                          ? (t = "firefox")
                          : 0 < e.indexOf("MSIE ") || 0 < e.indexOf("Trident/")
                            ? (t = "ie")
                            : window.StyleMedia
                              ? (t = "edge")
                              : -1 != e.indexOf("Safari") &&
            ...
            _isBrowserSupported: function () {
                for (
                    ...
                    if (void 0 !== document.body.style[t[e]]) return !0;
                console.error(o + " : Browser not supported");
            },
            _raise: function (t, e) {
                var i = this.options,
                    s = i[t],
                ...
                return (
                    ...
                    s &&
                        ((e.type = t),
                        "string" == typeof s && (s = window[s]),
                        p.isFunction(s) &&
                            (a = !1 !== (a = s.call(this, e)) && a)),
            ...
            _saveInstanceOnID: function () {
                var t = this.id;
                t && void 0 !== window[t] && (window[t] = this);
            },
            _removeData: function () {
                var t = this._dataElement()[0];
                (p.removeData && p.removeData(t, o),
                    t.id &&
                        "function" == typeof window[t.id]._init &&
                        delete window[t.id]);
            },
            ...
            _set: function (t, e, i) {
                ...
                if (-1 != p.inArray(t, s.numberType)) {
                    ...
                    -1 != p.inArray(t, s.booleanType)
                        ? (e = "false" != e && !!e)
                        : -1 != p.inArray(t, s.stringType) &&
                          (e = e.toLowerCase());
                var a = this.options;
                if (((this._preValue = a.value), i || a[t] !== e)) {
                    switch (((a[t] = e), t)) {
                        case "startAngle":
                        case "endAngle":
                            (this._validateStartEnd(),
                        ...
                        case "readOnly":
                            a.readOnly
                                ? this._readOnly(!0)
                                : a.disabled || this._readOnly(!1);
                            break;
                        case "mouseScrollAction":
                            this._bindScrollEvents(
                                a.mouseScrollAction ? "_bind" : "_unbind",
                            );
                            break;
                        case "lineCap":
                ...
                if (t && this._getInstance()) {
                    ...
                    if (p.isPlainObject(t)) {
                        var s,
                            ...
                            r = void 0 !== t.max;
                        for (var o in ((n || r) &&
                            (n && ((i.min = t.min), delete t.min),
                            r && ((i.max = t.max), delete t.max),
                            (s = i.value),
                            void 0 !== t[a] && ((s = t[a]), delete t[a]),
                            this._set(a, s, !0)),
                        t))
                            this._set(o, t[o]);
                    } else if ("string" == typeof t) {
                        if (void 0 === e) return this._get(t);
                        this._set(t, e);
                    }
                    return (
                        i.svgMode &&
                            ...
                            this._isPropsRelatedToSVGStyles(t) &&
                                this._setSVGStyles()),
                        this
                    );
                }
        ...
        (r.prototype.$drawArc = function (t, e, i, s, a) {
            ...
            return (
                h
                    ? ((n = (i + s) / 2),
                      (r = this.$polarToCartesian(t, e, n)),
                      (o = this.$polarToCartesian(t, e, u)),
                      _.push("A", 1, 1, 0, 0, d, r, "A", 1, 1, 0, 0, d, o))
                    : ((o = this.$polarToCartesian(t, e, u)),
                      _.push("A", e, e, 0, l, d, o)),
                _.join(" ")
            );
        }),
        (r.prototype.$drawPath = function (t, e, i, s, a, n) {
            var r,
                o,
                h = this.$polarToCartesian(t, e, i),
                l = ["M " + h, this.$drawArc(t, e, i, s, !0)];
            return (
                a &&
                    ((r = this.$polarToCartesian(t, a, s)),
                    (o = this.$drawArc(t, a, i, s, !1)),
                    "none" == n
                        ? l.push("M " + r, o)
                        : "round" == n
                          ? l.push(
