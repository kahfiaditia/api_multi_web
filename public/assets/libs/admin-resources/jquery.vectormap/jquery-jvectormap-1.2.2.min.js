    ...
    (jvm.DataSeries.prototype = {
            ...
            if (
                ...
                for (i in e)
                    e[i]
                        ...
                        : (s[i] =
                              this.elements[i].element.style.initial[
                                  this.params.attribute
                              ]);
            else {
        ...
        clear: function () {
            ...
            for (e in this.values)
                this.elements[e] &&
                    (t[e] =
                        this.elements[e].element.style.initial[
                            this.params.attribute
                        ]);
    ...
    (jvm.Proj = {
        ...
        mill: function (e, t, n) {
            return {
                ...
                y:
                    (-this.radius *
                        Math.log(Math.tan((45 + 0.4 * e) * this.radDeg))) /
                    0.8,
            };
        },
        ...
        lcc: function (e, t, n) {
            var r = 0,
                ...
                l =
                    (Math.cos(o) * Math.pow(Math.tan(Math.PI / 4 + o / 2), f)) /
                    f,
        ...
        lcc_inv: function (e, t, n) {
                ...
                f =
                    ...
                    Math.log(
                        Math.tan(Math.PI / 4 + a / 2) *
                            (1 / Math.tan(Math.PI / 4 + u / 2)),
                    ),
                l =
                    (Math.cos(u) * Math.pow(Math.tan(Math.PI / 4 + u / 2), f)) /
                    f,
            ...
            return {
                lat:
                    (2 * Math.atan(Math.pow(l / h, 1 / f)) - Math.PI / 2) *
                    this.degRad,
                lng: (o + p / f) * this.degRad,
            };
        },
                ...
                typeof t != "undefined" &&
                    ...
                    r
                        ? ((this.transX =
                              t +
                              (this.defaultWidth *
                                  (this.width / (this.defaultWidth * e))) /
                                  2),
                          (this.transY =
                              n +
                              (this.defaultHeight *
        ...
        latLngToPoint: function (e, t) {
            ...
            return (
                ...
                u
                    ? ((a = u.bbox),
                      (n.x =
                          ((n.x - a[0].x) / (a[1].x - a[0].x)) *
                          u.width *
                          this.scale),
                      (n.y =
                          ((n.y - a[0].y) / (a[1].y - a[0].y)) *
                          u.height *
                          this.scale),
                      {
                          x:
        ...
        pointToLatLng: function (e, t) {
            ...
            for (s = 0; s < i.length; s++) {
                ((o = i[s]),
                    ...
                    (a =
                        (a / (o.width * this.scale)) * (u[1].x - u[0].x) +
                        u[0].x),
                    (f =
                        (f / (o.height * this.scale)) * (u[1].y - u[0].y) +
                        u[0].y));
