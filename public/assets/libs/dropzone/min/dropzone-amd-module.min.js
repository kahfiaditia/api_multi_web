        ...
        h = (function () {
            ...
            function F(e, t) {
                ...
                if (
                    ...
                    n.options.forceFallback || !F.isBrowserSupported())
                )
                    return s(n, n.options.fallback.call(l(n)));
                if (
                    (null == n.options.url &&
                ...
                return (
                    ...
                    !1 !== n.options.previewsContainer &&
                        (n.options.previewsContainer
                            ? (n.previewsContainer = F.getElement(
                                  n.options.previewsContainer,
                                  "previewsContainer",
                              ))
                    ...
                    n.options.clickable &&
                        (!0 === n.options.clickable
                            ...
                            : (n.clickableElements = F.getElements(
                                  n.options.clickable,
                                  "clickable",
                              ))),
                    n.init(),
                            ...
                            ((this.prototype.Emitter = p),
                                ...
                                (this.prototype.defaultOptions = {
                                    ...
                                    resize: function (e, t, n, i) {
                                        ...
                                        return (
                                            (r.srcX =
                                                (e.width - r.srcWidth) / 2),
                                            (r.srcY =
                                                (e.height - r.srcHeight) / 2),
                                            (r.trgWidth = t),
                                            (r.trgHeight = n),
                                            r
                                        );
                ...
                d(
                    ...
                    [
                        ...
                        },
                        {
                            key: "getQueuedFiles",
                            value: function () {
                                return this.getFilesWithStatus(F.QUEUED);
                            },
                        },
                        {
                            key: "getUploadingFiles",
                            value: function () {
                                return this.getFilesWithStatus(F.UPLOADING);
                            },
                        },
                        {
                            key: "getAddedFiles",
                            value: function () {
                                return this.getFilesWithStatus(F.ADDED);
                            },
                        },
                        {
                            key: "getActiveFiles",
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                var t = this;
                                if (e.status !== F.ADDED || !0 !== e.accepted)
                                    throw new Error(
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                null == e && (e = !1);
                                var t,
                                    n = w(this.files.slice());
                                try {
                                    for (n.s(); !(t = n.n()).done; ) {
                                        var i = t.value;
                                        (i.status === F.UPLOADING && !e) ||
                                            this.removeFile(i);
                                    }
                                } catch (e) {
                                    n.e(e);
                            ...
                            value: function (r, e, t, n, a) {
                                ...
                                return this.createThumbnail(
                                    ...
                                    function (e, t) {
                                        ...
                                        var i = t.toDataURL(
                                            n,
                                            o.options.resizeQuality,
                                        );
                                        return (
                                            ("image/jpeg" !== n &&
                                                "image/jpg" !== n) ||
                                                (i = g.restore(r.dataURL, i)),
                                            a(F.dataURItoBlob(i))
                                        );
                                    },
                                );
                                ...
                                this._transformFiles(l, function (e) {
                                    ...
                                    if (l[0].upload.chunked) {
                                        ...
                                        for (
                                            ...
                                            o[s] = {
                                                name: u._getParamName(s),
                                                data: e[s],
                                                filename: l[s].upload.filename,
                                            };
                                        u._uploadData(l, o);
                                    }
                                });
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                ...
                                t[0].upload.chunked &&
                                    (t[0].upload.chunks[e[0].chunkIndex].xhr =
                                        r);
                                var o = this.resolveOption(
                                        this.options.method,
                                        t,
                                    ),
                                ...
                                for (var u in (this.options.headers &&
                                    F.extend(l, this.options.headers),
                                l)) {
                                    var c = l[u];
    ...
    ((h.createElement = function (e) {
        ...
        (h.getElements = function (e, t) {
            ...
            if (e instanceof Array) {
                ...
                i = [];
                var o,
                    s = w(document.querySelectorAll(e));
                try {
                    for (s.s(); !(o = s.n()).done; ) ((n = o.value), i.push(n));
                } catch (e) {
                    s.e(e);
                } finally {
                    s.f();
        ...
        null != e &&
            (e.fn.dropzone = function (e) {
                return this.each(function () {
                    return new h(this, e);
                });
            }),
        null != t ? (t.exports = h) : (window.Dropzone = h),
        (h.ADDED = "added"),
        (h.QUEUED = "queued"),
        (h.ACCEPTED = h.QUEUED),
        ...
        (function (t, n) {
            function i(e) {
                if (
                    ...
                    return (
                        ("load" === e.type ? t : a)[l](u + e.type, i, !1),
            ...
            if ("complete" !== a.readyState) {
                ...
                (a[s](u + "DOMContentLoaded", i, !1),
                    a[s](u + "readystatechange", i, !1),
                    t[s](u + "load", i, !1));
            }
