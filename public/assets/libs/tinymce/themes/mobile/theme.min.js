...
!(function () {
    ...
    var Qt,
        ...
        go =
            ...
            _t(function (n) {
                ...
                return Qt(n)
                    ? no(n)
                    : eo("Expected type: function but got: " + e);
            })),
        po = function (n) {
            return (
                "Errors: \n" +
    ...
    var ni = w(lo(Sr())),
        ...
        ti = Ao({
            fields: [
                $t(
                    "channels",
                    Nt(ht.value, It([Cr("onReceive"), Yt("schema", mo())])),
                ),
            ],
            name: "receiving",
            active: pr,
    ...
    function eu(n) {
        return (
            ("input" === le(n) && "radio" !== Be(n, "type")) ||
            "textarea" === le(n)
        );
    }
    function tu(n, e, t) {
        return eu(t) && Si(Ui)(e.event)
            ? mn.none()
            : (nn(n, t, Zn()), mn.some(!0));
    }
    function ou(n, e) {
    ...
    function Sa(n) {
        var r,
            ...
            o =
                ...
                (i = {}),
                M(e, function (n) {
                    n.fold(mn.some, mn.none, mn.some, mn.some).each(
                        function (t) {
                            var o = js(r, t.pname);
                            i[t.name] = function (n) {
                                var e = zt(
        ...
        var r,
            ...
            c =
                ...
                n.replace(/\$\{([^{}]*)\}/g, function (n, e) {
                    var t,
                        o = r[e];
                    return "string" == (t = typeof o) || "number" == t
                        ? o.toString()
                        : n;
                }));
        return (
    ...
    function ls(n) {
        ...
        var h,
            ...
            x,
            w = fs(
                (((x = l), Math.min(d, Math.max(r, x)) - x) / m) * o + e,
                g,
                p,
            );
        return u && e <= w && w <= t
        ...
        var e = {
            onChange: function (n, e, t) {
                o.undoManager.transact(function () {
                    (o.formatter.apply("forecolor", { value: t }),
                        o.nodeChanged());
                });
            },
            getInitialValue: w(-1),
            ...
            function () {
                return [
                    ...
                    $f.sketch({
                        ...
                        onChange: function (n, e, t) {
                            var o = i(t.x());
                            ($r(e.element, "background-color", o),
                                r.onChange(n, e, o));
                        },
        ...
        zf = Object.freeze({
            ...
            setPositionFromValue: function (n, e, t, o) {
                var r = is(t),
                    ...
                    c = Ba(e.element) / 2,
                    a = Kr(e.element) / 2;
                ($r(e.element, "left", i - c + "px"),
                    $r(e.element, "top", u - a + "px"));
            },
            onLeft: Bf,
            onRight: Af,
            onUp: Nf,
                ...
                function (r) {
                    ...
                    u.link.bind(K).fold(
                        function () {
                            ...
                            t.insertContent(
                                t.dom.createHTML("a", i, t.dom.encode(n)),
                            );
                        },
                        function (e) {
                            var t,
    ...
    function vl(n) {
        ...
        return (
            ...
            })),
            {
                list: o,
                data: De(
                    Ht("component.behaviours", lo(r), e.behaviours).fold(
                        function (n) {
                            throw new Error(
                                po(n) +
                                    "\nComplete spec:\n" +
    ...
    function Dl(t, o, n) {
        ...
        qd((e = t), (r = o))
            ...
            .each(function (n) {
                var e = n.transition;
                (Le(t.element, e.transitionClass),
                    He(t.element, o.destinationAttr));
            });
    }
    function Ml(n, e, t, o) {
        (Dl(n, e, t),
            ...
            (m = Ns(
                Wd.sketch({
                    ...
                    onOpenSubmenu: function (n, e, t) {
                        var o = Ba(n.element),
                            r = pi(e.element, '[role="menu"]').getOrDie(
                                "hacky",
                            ),
                    ...
                    onCollapseMenu: function (n, e, t) {
                        var o = pi(e.element, '[role="menu"]').getOrDie(
                                "hacky",
                            ),
                            r = n.getSystem().getByDom(o).getOrDie();
                        (Jd.progressTo(r, "after"),
                            Jd.progressTo(t, "current"));
                    },
                    navigateOnHover: !1,
                        ...
                        ? ((t._handled = !0),
                          i._immediateFn(function () {
                              ...
                              if (null !== e) {
                                  ...
                                  (1 === t._state ? c : a)(o.promise, t._value);
                          }))
                        : t._deferreds.push(o);
                }
                function c(e, n) {
    ...
    var Kl,
            ...
            factory: function (n) {
                ...
                return {
                    ...
                    dom: y(
                        {
                            tag: "div",
                            attributes: y({ role: "presentation" }, t),
                        },
                        o,
                    ),
                    components: n.components,
        ...
        id = Object.freeze({
            ...
            exhibit: function (n, e) {
                return Io({
                    attributes: xo([{ key: e.tabAttr, value: "true" }]),
                });
            },
        }),
        ud = Ao({
            ...
            return [
                {
                    ...
                    items: [
                        ...
                        (l = Ns({
                            dom: Oa(
                                '<div class="${prefix}-dot-container"></div>',
                            ),
                            behaviours: or([
                                Qi.config({
                        ...
                        {
                            dom: Oa(
                                '<div class="${prefix}-serializer-wrapper"></div>',
                            ),
                ...
                hi(n.element, "." + ci("serialised-dialog-chain")).each(
                    function (o) {
                        0 <= s.state.currentScreen.get() + r &&
                            ...
                            s.state.currentScreen.set(
                                s.state.currentScreen.get() + r,
                            ));
                    },
                );
            }
        ...
        wd = function (n, c) {
            var e,
                ...
                a = Me(n, function (r, u) {
                    return (
                        1 === r.length ? ht.value(r[0].handler) : gl(r, c, u)
                    ).map(function (n) {
                        var e,
                            i,
                            t =
                                ...
                                function (n, e) {
                                    ...
                                    i.abort.apply(void 0, r)
                                        ? e.stop()
                                        : i.can.apply(void 0, r) &&
                                          i.run.apply(void 0, r);
                                }),
                            o =
                                1 < r.length
                                    ? E(c[u], function (e) {
        ...
        Wd = wa({
            ...
            factory: function (c, n) {
                ...
                function p(t) {
                    return function (e, n) {
                        return vi(n.getSource(), "." + c.markers.item).bind(
                            function (n) {
                                return e
                                    .getSystem()
                                    .getByDom(n)
                        ...
                        [
                            ...
                            Qo(function (e, n) {
                                ...
                                e.getSystem()
                                    .getByDom(t)
                                    .each(function (n) {
                                        (0 === a(n).indexOf("collapse-item") &&
                                            o(e, n),
                                            g(e, n, d.HighlightSubmenu).fold(
                                                function () {
                                                    c.onExecute(e, n);
                                                },
                                                Y,
        ...
        Yd = Object.freeze({
            ...
            progressTo: function (t, o, r, i) {
                ...
                var n,
                    c =
                        ((n = i),
                        { start: Be(t.element, o.stateAttr), destination: n });
                Xd(t, o, r, c).fold(
                    function () {
                        Ml(t, o, r, i);
                    },
            ...
            rtl: function (r, i, u, c) {
                sm(s).each(function (n) {
                    if (n.setBaseAndExtent)
                        n.setBaseAndExtent(r.dom, i, u.dom, c);
                    else if (n.extend)
                        try {
                            ((t = u),
                                (o = c),
                                (e = n).collapse(r.dom, i),
                                e.extend(t.dom, o));
                        } catch (n) {
                            fm(s, u, c, r, i);
                        }
    ...
    function pm(n, e) {
        ...
        return 0 <
            (o = 0 < r.length ? r[0] : t.getBoundingClientRect()).width ||
            0 < o.height
            ? mn.some(o).map(Ul)
            : mn.none();
    }
                  ...
                  if (o.collapsed) {
                      ...
                      return pe(r)
                          .bind(function (n) {
                              ...
                              return pm(
                                  o.startContainer.ownerDocument.defaultView,
                                  t,
                              )
                                  .map(Dm)
                                  .map(P);
        ...
        return a.fold(
            ...
            function (e) {
                ...
                return (
                    dl(t)(s),
                    s.isStopped()
                        ? (i.logEventStopped(o, e.element, t.purpose),
                          Bg.stopped())
                        : s.isCut()
                          ? (i.logEventCut(o, e.element, t.purpose),
                            Bg.complete())
                          : pe(e.element).fold(
                                function () {
                                    return (
                                        i.logNoParent(o, e.element, t.purpose),
                                        Bg.complete()
                                    );
                                },
                                function (n) {
                ...
                return qo([
                    Mo(Wn())(function (n, e) {
                        e.event.raw.propertyName === t.dimension.property &&
                            (Um(n, t),
                            o.isExpanded() &&
                                Xr(n.element, t.dimension.property),
    ...
    function Wg(n) {
        ...
        return (e ? n.screen.height : n.screen.width) - n.innerHeight > i
            ? 0
            : i;
    }
    function Xg(n, e) {
    ...
    function yp(n) {
        ...
        var B,
            ...
            q = (function (e, t) {
                ...
                (je(o, ci("unfocused-selections")),
                    Qe(fe.fromDom(n.documentElement), o));
        ...
        return {
            ...
            syncHeight: function () {
                $r(
                    k,
                    "height",
                    k.dom.contentWindow.document.body.scrollHeight + "px",
                );
            },
                ...
                function O(n, e, t, o) {
                    ...
                    var r,
                        ...
                        c =
                            ...
                            (i = t),
                            {
                                readOnly: (u = n.get()).backToMask.concat(
                                    r.get(),
                                ),
                        ...
                        w.init({
                            editor: {
                                ...
                                onTouchContent: function () {
                                    (jo(
                                        fe.fromDom(
                                            E.editorContainer.querySelector(
                                                "." + ci("toolbar"),
                                            ),
                                        ),
                                    )
