                    ...
                    ? ((r = { title: e }),
                      t.schema.getTextBlockElements()[o]
                          ...
                          : t.schema.getBlockElements()[o] || c[o.toLowerCase()]
                            ...
                            : (r.inline = o))
                    : n[2] &&
                      (r = { inline: "span", title: e.substr(1), classes: i }),
        ...
        v.on("init", function () {
            function o(t, e) {
                if (
                    ((f = t),
                    (p = g),
                    !(d(v, (m = e)) ? f in p : f in m.selectors))
                ) {
                    ((a = t),
                        (l = g),
                        d(v, (u = e)) ? (l[a] = !0) : (u.selectors[a] = !0));
                    var r =
                    ...
                    if (r) {
                        ...
                        return (
                            v.formatter.register(n, r),
                            { title: r.title, format: n }
                        );
                    }
                }
