    ...
    function j(t) {
        ...
        return (
            ...
            M(t.selection.getRng(), function (t) {
                return (
                    1 === t.nodeType && !L(t) && !D(n, t.nodeName.toLowerCase())
                );
            }).length
        );
    }
                    ...
                    body: {
                        ...
                        items: x([
                            ...
                            (function (t) {
                                ...
                                m.targets.map(
                                    ft.createUi("target", "Open link in..."),
                                ),
                                m.link.map(ft.createUi("link", "Link list")),
                                m.classes.map(
                                    ft.createUi("linkClass", "Class"),
                                ),
                            ]),
                        ]),
                    },
                ...
                onChange: function (t, n) {
                    ...
                    return "url" === l
                        ? ((r = t()),
                          ...
                          (u = w(
                              s.text.length <= 0,
                              it.from(o.meta.text).getOr(o.value),
                          )),
                          (i = r.url),
                          (a = w(
                              s.title.length <= 0,
                              it.from(i.meta.title).getOr(""),
                          )),
                          u.isSome() || a.isSome()
                              ? it.some(
                                    st(
                    ...
                    .then(function (t) {
                        var n,
                            ...
                            s =
                                ...
                                (r = (n = m).dom),
                                (o = j(n)
                                    ? it.some(K(n.selection, e))
                                    : it.none()),
                                (i = e
                                    ? it.some(r.getAttrib(e, "href"))
                                    : it.none()),
                                (u = e
                                    ? it.from(r.getAttrib(e, "target"))
                                    : it.none()),
                                (a = H(r, e, "rel")),
                                (l = H(r, e, "class")),
                                {
        ...
        ((n = t).ui.registry.addToggleButton("link", {
            ...
            (a = t).ui.registry.addContextForm("quicklink", {
                ...
                predicate: function (t) {
                    return (
                        !!I(a, t) &&
                        a.getParam("link_context_toolbar", !1, "boolean")
                    );
                },
                initValue: function () {
                    var t = I(a);
