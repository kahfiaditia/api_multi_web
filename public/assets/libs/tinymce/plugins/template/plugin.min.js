...
!(function () {
    ...
    function p(e, t, n) {
        ...
        return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t =
            ...
            "%y",
            "" + n.getYear(),
        )).replace("%m", f(n.getMonth() + 1, 2))).replace(
            "%d",
            f(n.getDate(), 2),
        )).replace("%H", "" + f(n.getHours(), 2))).replace(
            "%M",
            "" + f(n.getMinutes(), 2),
        )).replace("%S", "" + f(n.getSeconds(), 2))).replace(
            "%I",
            "" + (((n.getHours() + 11) % 12) + 1),
                ...
                return {
                    ...
                    onSubmit: function (t) {
                        ...
                        l(n, e.template).each(function (e) {
                            u(e)
                                .then(function (e) {
                                    (M.execCommand("mceInsertTemplate", !1, e),
                                        t.close());
                                })
                                .catch(function () {
                                    (t.disable("save"), i(t));
                ...
                c = function (e, t, n) {
                    var r,
                        ...
                        y =
                            ...
                            x(
                                a,
                                r.getParam("template_preview_replace_values"),
                            )),
                        v = [
                            {
                                type: "selectbox",
