            ...
            ((t = l = u),
                ...
                w.each(c.getAll("link"), function (e) {
                    "stylesheet" === e.attr("rel") &&
                        s.stylesheets.push(e.attr("href"));
                }),
                (r = c.getAll("body")[0]) &&
                    ((s.langdir = d(r, "dir")),
                    (s.style = d(r, "style")),
                                ...
                                (s ||
                                    ...
                                    o.doctype
                                        ? (a ||
                                              ((a = new f("#doctype", 10)),
                                              o.xml_pi
                                                  ? c.insert(a, c.firstChild)
                                                  : r(a)),
                                          (a.value = o.doctype.substring(
                                              9,
                                              o.doctype.length - 1,
                                          )))
                                        : a && a.remove(),
