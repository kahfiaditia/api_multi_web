...
!(function () {
    ...
    function F(t, n, r, e, o) {
        return { start: z(t, n, r), end: z(t, e, o) };
    }
    function G(t, n) {
        var r = n.slice(),
            e = r.pop(),
    ...
    function H(n, r) {
        return G(n, r.start).bind(function (t) {
            var o = t.node,
                a = t.offset;
            return G(n, r.end).map(function (t) {
                var n = t.node,
                    r = t.offset,
        ...
        return V(e, t)
            ...
            .bind(function (n) {
                ...
                return (function (t, n, r) {
                    ...
                    function (t) {
                        return (
                            0 === r.indexOf(t.start) || 0 === o.indexOf(t.start)
                        );
                    },
                    l,
                ).map(function (t) {
                    return dt.trim(e).length === t.start.length
                        ? []
                        : [{ pattern: t, range: F(i.getRoot(), n, 0, n, 0) }];
                });
            })
            .getOr([]);
    }
    ...
    function Y(t, n, r) {
        var e = H(t.getRoot(), r).getOrDie("Unable to resolve path range"),
            o = e.startContainer,
            a = e.endContainer,
        ...
        return {
            prefix: n,
            end: i.parentNode.insertBefore(X(t, n + "-end"), i),
            start: u.parentNode.insertBefore(X(t, n + "-start"), u),
        };
    }
    function Z(t, n, r) {
        (pt(t, t.get(n.prefix + "-end"), r),
            pt(t, t.get(n.prefix + "-start"), r));
    }
    function $(n, t, r) {
                    ...
                    if (
                        ...
                        var s = (function (a, i, u) {
                            var f = a.dom,
                                ...
                                d = u.position.offset;
                            return vt(l, d - u.pattern.end.length, i).bind(
                                function (t) {
                                    var r = F(c, t.container, t.offset, l, d);
                                    if (L(s))
                                        return w.some({
                                            matches: [
                                                {
