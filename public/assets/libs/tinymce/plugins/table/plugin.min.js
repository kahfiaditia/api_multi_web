...
!(function () {
    ...
    function Q(e, n, t) {
        return (
            "" === n ||
            (e.length >= n.length && e.substr(t, t + n.length) === n)
        );
    }
    function Z(e, n) {
                ...
                return (
                        ...
                        .fold(je, Fe)),
                    {
                        ...
                        deviceType:
                            ...
                            (a = o.isiOS() && !l),
                            (s =
                                (f = o.isiOS() || o.isAndroid()) ||
                                c("(pointer:coarse)")),
                            (m =
                                l ||
                                (!a && f && c("(min-device-width:768px)"))),
                            (d = a || (f && !m)),
                            (g =
                                u.isSafari() &&
                                o.isiOS() &&
    ...
    var _r,
        ...
        ro = function (e) {
            return dr()
                ? ((t = pr((n = e))),
                  (o =
                      (r = n.dom).getBoundingClientRect().height ||
                      r.offsetHeight),
    ...
    function xu(n, e) {
        ...
        0 < t.length &&
            (function () {
                throw new Error(
                    "Unsupported keys for object: " + Tu(t).join(", "),
                );
            })();
    }
    function Ru(e) {
    ...
    function Du() {
        var u,
            ...
            e = {
                onEvent: E,
                reset: E,
                events: Su({ move: Cu(["info"]) }).registry,
            },
            n =
                ((u = q.none()),
                {
    ...
    function Wu(e, n) {
        var t;
        (zu(e),
            e.isResizable(n) && _u((t = $t.fromTable(n)), e, n, Cr(t), yr(t)));
    }
    function ju(e, n) {
        A(dn(e.parent(), "." + ha), n);
    }
        ...
        var n,
            ...
            l =
                ...
                (c = {
                    ...
                    events: (r = Su({ drag: Cu(["xDelta", "yDelta"]) }))
                        .registry,
        ...
        return function (o, u, e, i, c) {
            ...
            return n(l, e)
                ...
                .bind(function (e) {
                    var n = ki(u, e.grid),
                        t = q
                            .from(null == c ? void 0 : c.sizing)
                            .getOrThunk(function () {
                                return Vl(u);
                            }),
                        r = q
                            .from(null == c ? void 0 : c.resize)
                            .getOrThunk(gu);
                    return (
                        s(u, e.grid, e.info, {
                            sizing: t,
                        ...
                        Wu(o, u),
                        Wt(u, Gt),
                        0 < e.lockedColumns.length &&
                            Mn(u, Gt, e.lockedColumns.join(",")),
                        q.some({
                            cursor: e.cursor,
                            newRows: n.newRows,
                            newCells: n.newCells,
        ...
        return D(e, function (e) {
            return (function (e, n, t, r) {
                for (var o = Ve.fromTag("tr"), u = 0; u < e; u++) {
                    var i =
                        r < n || u < t ? Ve.fromTag("th") : Ve.fromTag("td");
                    (u < t && Mn(i, "scope", "row"),
                        r < n && Mn(i, "scope", "col"),
                        Xt(i, Ve.fromTag("br")),
                        Xt(o, i));
                ...
                value:
                    ...
                    qc((r = e.value))
                        .orThunk(function () {
                            return (function (e) {
                                if ("transparent" === e)
                                    return q.some($c(0, 0, 0, 0));
                                var n = kf.exec(e);
                                if (null !== n)
                                    return q.some(Kc(n[1], n[2], n[3], "1"));
                                var t = If.exec(e);
                                return null !== t
    ...
    function gl(e) {
        return _f.concat(
            (0 <
            (n = Bf(e.getParam("table_row_class_list", [], "array"))).length
                ? q.some({
                      name: "class",
                      type: "listbox",
                      label: "Class",
                    ...
                    ? ((u = r.dom),
                      {
                          ...
                          backgroundcolor: cl(u)(
                              pe(a, "background-color").getOr(""),
                          ),
                      })
                    : {}),
                K(
        ...
        !1 === n
            ? (t = C.getParent(e.selection.getStart(), "table", e.getBody()))
                ? ((d = t),
                  ...
                  (v = m.dom),
                  (w = ti(m)
                      ? v.getStyle(d, "border-spacing") ||
                        v.getAttrib(d, "cellspacing")
                      : v.getAttrib(d, "cellspacing") ||
                        v.getStyle(d, "border-spacing")),
                  (y = ti(m)
                  ...
                  (S = K(
                      {
                          width:
                              v.getStyle(d, "width") || v.getAttrib(d, "width"),
                          height:
                              v.getStyle(d, "height") ||
                              v.getAttrib(d, "height"),
                          cellspacing: w,
                          cellpadding: y,
                          border:
                              ((p = v),
                                ...
                                function (e) {
                                    (en("caption")(n) &&
                                        ie("td", r).each(function (e) {
                                            return l.selection.setCursorLocation(
                                                e.dom,
                                                0,
                                            );
                                        }),
                ...
                var o,
                    ...
                    c =
                        ...
                        N(o, function (e) {
                            ...
                            return 0 < t.length
                                ? [ye(e.element, t, e.section, e.isNew)]
                                : [];
                        })),
            ...
            rtl: function (o, u, i, c) {
                ls(l).each(function (e) {
                    if (e.setBaseAndExtent)
                        e.setBaseAndExtent(o.dom, u, i.dom, c);
                    else if (e.extend)
                        try {
                            ((t = i),
                                (r = c),
                                (n = e).collapse(o.dom, u),
                                n.extend(t.dom, r));
                        } catch (e) {
                            fs(l, i, c, o, u);
                        }
    ...
    function zs(n, t, e) {
        ...
        return (
            ...
            function (e) {
                return (
                    t.scrollBy(0, e),
                    t.situsFromPoint(u.left, n.point(u) - e)
                );
            },
        );
    }
                    ...
                    Dn(
                        ...
                        ? ((o = t = a),
                          ...
                          o
                              ...
                              .bind(function (n) {
                                  return In(n.finish, "td,th", f).map(
                                      function (e) {
                                          return {
                                              start: l,
                                              finish: e,
        ...
        return He().browser.isIE()
            ...
            : u(r, n).orThunk(function () {
                  return Ls(e, n, t, r, o).map(function (e) {
                      var n = e.range;
                      return nm(
                          q.some(rm(n.start, n.soffset, n.finish, n.foffset)),
                          !0,
                      );
                  });
              });
        ...
        return {
            ...
            getRangedRect: function (e, n, t, r) {
                ...
                return (
                    ...
                    0 <
                        (u = 0 < i.length ? i[0] : o.getBoundingClientRect())
                            .width || 0 < u.height
                        ? q.some(u).map(Dl)
                        : q.none()
                );
            ...
            scrollBy: function (e, n) {
                ...
                (t = (void 0 !== u ? u.dom : document).defaultView) &&
                    t.scrollBy(r, o);
            },
        };
    }
    ...
    var Ys = function (e, n, t, r) {
            return pn(n)
                ...
                : ((f = n),
                  ...
                  H(ln(f), function (e) {
                      return (
                          d.selectNode(e.dom),
                          Zf(d.getBoundingClientRect(), s, m)
                              ? Ys(a, e, s, m)
                              : q.none()
                      );
                  }));
        ...
        Js = document.caretPositionFromPoint
            ? function (t, e, n) {
                  ...
                  return q
                      .from(
                          null === (o = (r = t.dom).caretPositionFromPoint) ||
                              void 0 === o
                              ? void 0
                              : o.call(r, e, n),
                      )
            ...
            : document.caretRangeFromPoint
              ? function (e, n, t) {
                    var r, o;
                    return q.from(
                        null === (o = (r = e.dom).caretRangeFromPoint) ||
                            void 0 === o
                            ? void 0
                            : o.call(r, n, t),
                    );
        ...
        Zs = function (n, t, e) {
            return e.fold(
                ...
                function (e) {
                    return (
                        n.execCommand("mceTableInsertRowAfter"),
                        vs(n, t, e)
                    );
                },
            );
        ...
        pm = function (e, n, t) {
            return n(e, t).bind(function (e) {
                return pn(e) && 0 === Et(e).trim().length
                    ? pm(e, n, t)
                    : q.some(e);
            });
        },
                ...
                (I.on("dragstart", function (e) {
                    ...
                    I.on("keyup", function (e) {
                        ...
                        o.raw.shiftKey &&
                            ...
                            C.keyup(o, t, n.startOffset, r, n.endOffset).each(
                                function (e) {
                                    R(o, e);
                                },
                            ));
            ...
            (function (n, e, t, r) {
                ...
                (n.ui.registry.addMenuItem("tableinsertcolumnbefore", {
                    ...
                    n.ui.registry.addMenuItem("tablepastecolumnbefore", {
                        ...
                        onSetup: t.onSetupPasteableColumn(
                            r.getColumns,
                            "onFirst",
                        ),
                    }),
                ...
                (0 !== m.length &&
                    ...
                    n.ui.registry.addNestedMenuItem(
                        "tablecellbackgroundcolor",
                        {
            ...
            c.getParam("table_tab_navigation", !0, "boolean") &&
                c.on("keydown", function (e) {
                    ...
                    (n = e).keyCode === Qs.TAB &&
                        ...
                        et(
                            Ve.fromDom(
                                n.shiftKey ? o.startContainer : o.endContainer,
                            ),
                            r,
                        ).each(function (e) {
                            (n.preventDefault(),
