...
!(function () {
    ...
    function D(e, t) {
        ...
        return p(
            p(
                p(p(p({}, s("source")), s("altsource")), s("poster")),
                s("embed"),
            ),
            ((r = a),
            (n = {}),
    ...
    function N(m) {
        ...
        0 < i.length &&
            c.push({ title: "Advanced", name: "advanced", items: i });
        var h = m.windowManager.open({
            ...
            onSubmit: function (e) {
                ...
                ((t = d.get()),
                    ...
                    r.embed &&
                    (t.source === r.source || ((a = r.source), J(ae, a)))
                        ? z(n, r.embed)
                        : C(n, r)
                              .then(function (e) {
                                  z(n, e.html);
    ...
    var B = function (r) {
        ...
        se = function (e, t, r) {
            ...
            c &&
                (r.attr("data-mce-html", escape(U(e, c))),
                (r.firstChild = null));
        };
            ...
            (d = e).on("preInit", function () {
                ...
                (K.each(
                    ...
                    d.serializer.addAttributeFilter(
                        ...
                        function (e, t) {
                            for (
                                var r, n, a, o, i, c, s, u, l = e.length;
                                l--;
