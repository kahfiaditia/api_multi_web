...
!(function () {
    ...
    function ae(r, e) {
        ...
        (r.dom.setAttrib(i, "data-mce-id", null),
            Z(i)
                ? ((n = ie(r, i)), r.selection.select(n))
                : r.selection.select(i));
    }
    function oe(t, e) {
        var n,
            r,
              ...
              r.src
                  ? ((m = i),
                    ...
                    Z(h.parentNode)
                        ? ((d = h.parentNode),
                          ie(u, d),
                          u.selection.select(h.parentNode))
                  ...
                  : ((a = t),
                    (o = b) &&
                        ((l = a.dom.is(o.parentNode, "figure.image")
                            ? o.parentNode
                            : o),
                        a.dom.remove(l),
                        a.focus(),
        ...
        ((U = t),
            ...
            (/^(?:[a-zA-Z]+:)?\/\//.test(O)
                ...
                : x.prependURL.bind(function (e) {
                      return O.substring(0, e.length) !== e
                          ? L.some(e + O)
                          : L.none();
                  })
            ).each(function (e) {
                      ...
                      ? ((o = S),
                        ...
                        (w.hspace =
                            ...
                            D["margin-right"] === D["margin-left"]
                                ...
                                : ""),
                        (w.border = D["border-width"]
                            ? O(String(D["border-width"]))
                            : ""),
                        (w.borderstyle = D["border-style"]
                            ? String(D["border-style"])
                            : ""),
                        (w.style = v(y(v(D)))),
                        l.setData(w))
                      : "vspace" === t.name ||
