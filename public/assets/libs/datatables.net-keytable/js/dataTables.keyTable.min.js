...
!(function (n) {
    ...
    function s(e, t) {
        ...
        if (
            ((this.c = c.extend(!0, {}, o.defaults.keyTable, s.defaults, t)),
            (this.s = {
                dt: new o.Api(e),
                dtDrawing: !1,
                enable: !0,
    ...
    return (
                ...
                var i,
                    ...
                    n =
                        ...
                        this.c.blurable &&
                            c(d).on("mousedown" + l, function (e) {
                                (c(e.target).parents(
                                    ...
                                    c(e.target)
                                        .parents()
                                        .filter(s.table().container()).length ||
                                        c(e.target).parents("div.DTE").length ||
                                        c(e.target).parents(
                                            "div.editor-datetime",
                                        ).length ||
                                        c(e.target).parents("div.dt-datetime")
                                            .length ||
                                        c(e.target)
                                            .parents()
                        ...
                        s.on("stateSaveParams" + l, function (e, t, n) {
                            n.keyTable = o.s.lastFocus
                                ? o.s.lastFocus.cell.index()
                                : null;
                        }),
                        ...
                        s.on(
                            "preDraw" + l + " scroller-will-draw" + l,
                            function (e) {
                                o.s.dtDrawing = !0;
                            },
                        ),
                ...
                if (((i = i || null), this.s.enable)) {
                    ...
                    if (
                        ...
                        ((r = o
                            ...
                            .flatten()),
                            (l = o.cell(r[e])),
                            (r = this._emitEvent("key-prefocus", [
                                this.s.dt,
                                l,
                                i || null,
                            ])));
                    ...
                    if (
                        ...
                        if (i)
                            if (this.s.dt.cell(i.node).any()) {
                                ...
                                if (
                                    !this.c.keys ||
                                    -1 !== c.inArray(n.keyCode, this.c.keys)
                                )
                                    switch (n.keyCode) {
                                        case 9:
                                            (n.preventDefault(),
        ...
        (s.version = "2.10.0"),
        (c.fn.dataTable.KeyTable = s),
        (c.fn.DataTable.KeyTable = s),
        o.Api.register("cell.blur()", function () {
            return this.iterator("table", function (e) {
                e.keytable && e.keytable.blur();
            });
        }),
        o.Api.register("cell().focus()", function () {
            return this.iterator("cell", function (e, t, n) {
                e.keytable && e.keytable.focus(t, n);
            });
        }),
        o.Api.register("keys.disable()", function () {
            return this.iterator("table", function (e) {
                e.keytable && e.keytable.enable(!1);
            });
        }),
        o.Api.register("keys.enable()", function (t) {
            return this.iterator("table", function (e) {
                e.keytable && e.keytable.enable(t === f || t);
            });
        }),
        o.Api.register("keys.enabled()", function (e) {
            var t = this.context;
            return !!t.length && !!t[0].keytable && t[0].keytable.enabled();
        }),
        o.Api.register("keys.move()", function (t) {
            return this.iterator("table", function (e) {
                e.keytable && e.keytable._shift(null, t, !1);
            });
        }),
        o.ext.selector.cell.push(function (e, t, n) {
            var i = t.focused,
                s = e.keytable,
                o = [];
            if (!s || i === f) return n;
