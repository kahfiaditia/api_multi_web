            ...
            var c = document,
                d = function (b) {
                    ...
                    ((this.map = new google.maps.Map(this.el, A)),
                        o &&
                            (this.markerClusterer = o.apply(this, [this.map])));
                    var D = function (a, b) {
                        var c = "",
                        ...
                        if ("marker" === a) {
                            ...
                            (c.setMap(j.map),
                                (c.draw = function () {
                                    ...
                                    ((b.pixel =
                                        d.fromLatLngToContainerPixel(e)),
                                        D(a, b));
                                }));
                        } else D(a, b);
                ...
                case "places":
                    if (
                        ...
                        (b.radarSearch && c.radarSearch(d, b.radarSearch),
                            ...
                            b.nearbySearch &&
                                c.nearbySearch(d, b.nearbySearch));
                    }
                    if (b.textSearch) {
                        var e = {
                            bounds: b.bounds || null,
    ...
    return (
        ...
        (j.staticMapURL = function (a) {
            ...
            if ((delete a.polyline, a.center))
                ...
                (d.push("center=" + a.address), delete a.address);
            else if (a.lat)
            ...
            if (g)
                for (var o = 0; o < g.length; o++) {
                    ...
                    (g[o].featureType &&
                        ...
                        g[o].elementType &&
                            p.push(
                                "element:" + g[o].elementType.toLowerCase(),
                            ));
