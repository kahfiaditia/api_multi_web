...
!(function (a) {
    ...
    return (
        a.extend(a.validator.messages, {
            ...
            step: a.validator.format("يرجى تقديم قيمة من مضاعفات {0}"),
            maxWords: a.validator.format("يرجى تقديم ما لا يزيد عن {0} كلمات"),
            minWords: a.validator.format("يرجى تقديم {0} كلمات على الأقل"),
            rangeWords: a.validator.format("يرجى تقديم ما بين {0} و{1} كلمة"),
            ...
            require_from_group: a.validator.format(
                "يرجى تقديم ما لا يقل عن {0} من هذه الحقول",
            ),
