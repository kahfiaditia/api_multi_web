...
function getScrollParent(element) {
    ...
    return position === "fixed" || !scrollParent.length
        ? $__default["default"](element.ownerDocument || document)
        : scrollParent;
}
/**
...
var methods = {
    ...
    show: function show() {
        ...
        this.$picker
            ...
            .on(EVENT_CLICK, $__default["default"].proxy(this.click, this));
        this.showView(this.options.startView);

        if (!this.inline) {
            this.$scrollParent.on(
                EVENT_SCROLL,
                $__default["default"].proxy(this.place, this),
            );
    ...
    setDate: function setDate(date, _updated) {
        ...
        if (isDate(date) || isString(date)) {
            ...
            if (
                $__default["default"].isFunction(filter) &&
...
var handlers = {
    click: function click(e) {
        ...
        switch (view) {
            ...
            case "month":
                viewMonth = $__default["default"].inArray(
                    $target.text(),
                    options.monthsShort,
                );
    ...
    touchstart: function touchstart(_ref3) {
        ...
        if (
            this.isInput &&
            target !== this.element &&
            !$__default["default"].contains(this.$picker[0], target)
        ) {
            this.hide();
            this.element.blur();
        }
...
var render = {
    ...
    renderMonths: function renderMonths() {
        ...
        var filter =
            $__default["default"].isFunction(options.filter) && options.filter;
        var viewYear = viewDate.getFullYear();
        var now = new Date();
        var thisYear = now.getFullYear();
        ...
        for (i = 0; i <= 11; i += 1) {
            ...
            items.push(
                this.createItem({
                    ...
                    picked: picked,
                    highlighted:
                        viewYear === thisYear && date.getMonth() === thisMonth,
                    index: i,
                    text: months[i],
...
var Datepicker = /*#__PURE__*/ (function () {
    function Datepicker(element) {
        ...
        this.options = $__default["default"].extend(
            ...
            $__default["default"].isPlainObject(options) && options,
        );
            ...
            },
            {
                ...
                value: function build() {
                    ...
                    if (this.inline) {
                        ...
                        $__default["default"](document.body).append(
            ...
            },
            {
                ...
                value: function bind() {
                    ...
                    if (this.isInput) {
                        $this.on(
                            EVENT_KEYUP,
                            $__default["default"].proxy(this.keyup, this),
                        );
                    }
                    ...
                    if (!this.inline) {
                        if (options.trigger) {
                            this.$trigger.on(
                                EVENT_CLICK,
                                $__default["default"].proxy(this.toggle, this),
                            );
                        } else if (this.isInput) {
                            $this.on(
                                EVENT_FOCUS,
                                $__default["default"].proxy(this.show, this),
                            );
                        } else {
                            $this.on(
                                EVENT_CLICK,
            ...
            },
            {
                ...
                value: function place() {
                    ...
                    var $this = this.$element,
                        ...
                        $picker = this.$picker;
                    var containerWidth =
                        $__default["default"](document).outerWidth();
                    var containerHeight =
                        $__default["default"](document).outerHeight();
        ...
        this.each(function (i, element) {
            ...
            if (!datepicker) {
                ...
                var options = $__default["default"].extend(
                    {},
                    $element.data(),
                    $__default["default"].isPlainObject(option) && option,
                );
