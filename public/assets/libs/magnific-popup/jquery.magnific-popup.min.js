                        ...
                        if (!m.isOpen) {
                            ...
                            return (
                                ...
                                m.bgOverlay
                                    .add(m.wrap)
                                    .prependTo(
                                        m.st.prependTo || c(document.body),
                                    ),
            ...
            initZoom: function () {
                ...
                a.enabled &&
                    ...
                    d(F + s, function () {
                        if (m._allowZoom()) {
                            if (
                                (clearTimeout(i), (m.st.removalDelay = t), !e)
                            ) {
                ...
                var e = e
                    ...
                    e =
                        ((t.top -= c(window).scrollTop() - n),
                        {
                            width: e.width(),
                            height:
                                (P ? e.innerHeight() : e[0].offsetHeight) -
                                o -
                                n,
                        });
                return (
