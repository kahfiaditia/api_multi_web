...
(function (f) {
    "function" === typeof define && define.amd
        ...
        : "object" === typeof exports
          ? (module.exports = function (q, r) {
                ...
                r.fn.dataTable.Buttons ||
                    require("datatables.net-buttons")(q, r);
    ...
    function K(a) {
        E === y &&
            (E =
                -1 ===
                I.serializeToString(
                    f.parseXML(A["xl/worksheets/sheet1.xml"]),
                ).indexOf("xmlns:r"));
            ...
            if (f.isPlainObject(c)) K(c);
                ...
                if (E) {
                    ...
                    for (g = d.attributes.length - 1; 0 <= g; g--) {
                        ...
                        -1 !== n.indexOf(":") &&
                            (e.push({ name: n, value: m }),
                            d.removeAttribute(n));
                    }
                    g = 0;
                    for (n = e.length; g < n; g++)
                        ((m = c.createAttribute(
                            e[g].name.replace(":", "_dt_b_namespace_token_"),
                        )),
                            (m.value = e[g].value),
    ...
    var L = function (a, b) {
        ...
        F = function (a, b) {
            var c =
                "*" === a.filename && "*" !== a.title && a.title !== y
                    ? a.title
                    : a.filename;
            "function" === typeof c && (c = c());
            -1 !== c.indexOf("*") &&
                (c = f.trim(c.replace("*", f("title").text())));
            ...
            var d = b.fieldBoundary,
                ...
                m = function (k) {
                    for (var h = "", B = 0, u = k.length; B < u; B++)
                        (0 < B && (h += g),
                            (h += d
                                ? d + ("" + k[B]).replace(e, n + d) + d
                                : k[B]));
                    return h;
                },
                C = b.header ? m(a.header) + c : "";
            b = b.footer && a.footer ? c + m(a.footer) : "";
            for (var v = [], p = 0, D = a.body.length; p < D; p++)
                v.push(m(a.body[p]));
    ...
    z.ext.buttons.excelFlash = f.extend({}, H, {
        ...
        action: function (a, b, c, d) {
            ...
            var m,
                ...
                v = function (k) {
                    ...
                    for (var h = 0, B = k.length; h < B; h++) {
                        for (var u = h, w = ""; 0 <= u; )
                            ((w = String.fromCharCode((u % 26) + 65) + w),
                                (u = Math.floor(u / 26) - 1));
                        u = w + "" + m;
                        var x = null;
            ...
            d.footer &&
                b.footer &&
                (v(b.footer, g), f("row:last c", e).attr("s", "2"));
            v = t(e, "cols");
