            ...
            return (
                r.duration
                    ...
                    : (n = this.props.dayCount)
                      ? ((s = "day"),
                        (o = this.buildRangeFromDayCount(e, t, n)))
    ...
    class Da extends Gn {
        render() {
            return p(
                ...
                ...this.props.widgetGroups.map((e) =>
                    this.renderWidgetGroup(e),
                ),
            );
        }
        renderWidgetGroup(e) {
    ...
    class _a extends Vn {
        ...
        componentDidMount() {
            ...
            ((this.calendarInteractions =
                e.pluginHooks.calendarInteractions.map((t) => new t(e))),
