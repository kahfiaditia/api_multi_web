!(function (t, e) {
    ...
    a.prototype = {
        ...
        getErrorMessage: function (t) {
            var e;
            "type" === t.name
                ? (e = (this.catalog[this.locale][t.name] || {})[
                      t.requirements
                  ])
                    ...
                    t.push(
                        this.validationResult[e].errorMessage ||
                            this._getErrorMessage(
                                this.validationResult[e].assert,
                            ),
                    );
                return t;
            },
    ...
    y.prototype = {
        onSubmitValidate: function (t) {
            ...
            if (!0 !== t.parsley) {
                var i =
                    this._submitSource ||
                    this.$element.find(d._SubmitSelector)[0];
                if (
        ...
        rejected: !(b.prototype = {
            ...
            _parseRequirements: function (i) {
                ...
                this.requirementList = this.validator.parseRequirements(
                    ...
                    function (t) {
                        return i[
                            r.name + ((e = t)[0].toUpperCase() + e.slice(1))
                        ];
                        var e;
                    },
                );
            ...
            if ((this.refresh(), !s || this._isInGroup(s)))
                return (
                    ...
                    (e = this.whenValid({
                        ...
                        e,
                        u(this._pipeAccordingToValidationResult()),
                    )
                );
        },
