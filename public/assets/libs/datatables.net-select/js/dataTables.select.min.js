        ...
        : "object" == typeof exports
          ? ((s = require("jquery")),
            ...
            "undefined" == typeof window
                ...
                : (c(window, s),
                  (module.exports = l(s, window, window.document))))
    ...
    function r(n, e, t) {
        ...
        function s(t, l) {
            var e,
                ...
                c =
                    (s.indexOf(t) > s.indexOf(l) && ((e = l), (l = t), (t = e)),
                    !1);
        ...
        (t
            ...
            .on("click.dtSelect", s, function (e) {
                ...
                if (a) {
                    ...
                    if (
                        (!s.anchorNode ||
                            m(s.anchorNode).closest("table")[0] ===
                                o.table().node()) &&
                        s !== a
                    )
                        return;
        ...
        ((o._select_init = !0),
            o.aoRowCreatedCallback.push({
                fn: function (e, t, l) {
                    ...
                    for (
                        n._select_selected &&
                            m(e).addClass(o._select.className),
                            s = 0,
                ...
                : "multi+shift" == n && e.shiftKey
                  ? "cell" === s
                      ...
                      : d(
                            ...
                            s,
                            c,
                            l._select_lastCell ? l._select_lastCell[s] : null,
                        )
                  : t[s](c).select(!a));
    }
    function p(e) {
            ...
            f._select ||
                ...
                (t = function (e, t, l) {
                    if (null !== l && l.select !== h) {
                        if (
                            (c.rows({ selected: !0 }).any() &&
                                c.rows().deselect(),
                            l.select.rows !== h &&
                                c.rows(l.select.rows).select(),
                            c.columns({ selected: !0 }).any() &&
                                c.columns().deselect(),
                            l.select.columns !== h &&
                                c.columns(l.select.columns).select(),
                            c.cells({ selected: !0 }).any() &&
                                c.cells().deselect(),
                            l.select.cells !== h)
                        )
            ...
            return !1 === e
                ...
                : (this.iterator("cell", function (e, t, l) {
                      ...
                      (t._selected_cells === h && (t._selected_cells = []),
                          ...
                          t.anCells &&
                              m(t.anCells[l]).addClass(e._select.className));
                  }),
                  this.iterator("table", function (e, t) {
                      u(
                          l,
                          "select",
                          ["cell", l.cells(l[t]).indexes().toArray()],
                          !0,
                      );
                  }),
                  this);
                    ...
                    (m(l.header()).removeClass(s._select.className),
                        ...
                        t
                            ...
                            .each(function (e) {
                                ...
                                !t.anCells ||
                                    (l && l[e.column]) ||
                                    m(t.anCells[e.column]).removeClass(
                                        s._select.className,
                                    );
                            }));
                }),
