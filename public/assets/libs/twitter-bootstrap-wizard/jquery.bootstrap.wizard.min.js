...
(function (e) {
    var n = function (d, k) {
        ...
        this.fixNavigationButtons = function () {
            f.length ||
                (b.find("a:first").tab("show"),
                (f = b.find('li:has([data-toggle="tab"]):first')));
            e(c.previousSelector, d).toggleClass(
                "disabled",
                a.firstIndex() >= a.currentIndex(),
            );
            e(c.nextSelector, d).toggleClass(
                "disabled",
            ...
            if (
                c.onTabShow &&
                "function" === typeof c.onTabShow &&
                !1 === c.onTabShow(f, b, a.currentIndex())
            )
                return !1;
        };
        this.next = function (h) {
            if (
                d.hasClass("last") ||
                (c.onNext &&
                    "function" === typeof c.onNext &&
                    !1 === c.onNext(f, b, a.nextIndex()))
            )
                return !1;
            h = a.currentIndex();
            $index = a.nextIndex();
            $index > a.navigationLength() ||
                (g.push(h),
                b
                    .find('li:has([data-toggle="tab"]):eq(' + $index + ") a")
                    .tab("show"));
        };
        this.previous = function (h) {
            if (
                d.hasClass("first") ||
                (c.onPrevious &&
                    "function" === typeof c.onPrevious &&
                    !1 === c.onPrevious(f, b, a.previousIndex()))
            )
                return !1;
            h = a.currentIndex();
        ...
        this.first = function (h) {
            if (
                (c.onFirst &&
                    "function" === typeof c.onFirst &&
                    !1 === c.onFirst(f, b, a.firstIndex())) ||
                d.hasClass("disabled")
            )
                return !1;
        ...
        this.last = function (h) {
            if (
                (c.onLast &&
                    "function" === typeof c.onLast &&
                    !1 === c.onLast(f, b, a.lastIndex())) ||
                d.hasClass("disabled")
            )
                return !1;
            g.push(a.currentIndex());
        ...
        this.disable = function (a) {
            b.find('li:has([data-toggle="tab"]):eq(' + a + ")").addClass(
                "disabled",
            );
        };
        this.enable = function (a) {
            b.find('li:has([data-toggle="tab"]):eq(' + a + ")").removeClass(
                "disabled",
            );
        };
        ...
        var l = function (d) {
                ...
                d = g.index(
                    e(d.currentTarget).parent('li:has([data-toggle="tab"])'),
                );
                g = e(g[d]);
                if (
                    c.onTabClick &&
                    "function" === typeof c.onTabClick &&
                    !1 === c.onTabClick(f, b, a.currentIndex(), d, g)
                )
                    return !1;
            },
            m = function (d) {
                ...
                if (
                    ...
                    (c.onTabChange &&
                        "function" === typeof c.onTabChange &&
                        !1 === c.onTabChange(f, b, a.currentIndex(), d))
                )
                    return !1;
                f = $element;
        ...
        if (c.onShow && "function" === typeof c.onShow)
            c.onShow(f, b, a.nextIndex());
        e('a[data-toggle="tab"]', b).on("click", l);
        e('a[data-toggle="tab"]', b).on("shown shown.bs.tab", m);
    };
