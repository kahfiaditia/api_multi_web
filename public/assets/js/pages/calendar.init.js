(!(function (e) {
    ...
    ((t.prototype.init = function () {
        var c = new bootstrap.Modal(document.getElementById("event-modal"), {
            keyboard: !1,
        });
        ...
        var t = document.getElementById("modal-title"),
            ...
            d = e.getMonth(),
            l = e.getFullYear(),
            i = FullCalendar.Draggable,
            r = document.getElementById("external-events"),
            g = [
                { title: "All Day Event", start: new Date(l, d, 1) },
                {
                    title: "Long Event",
                    start: new Date(l, d, a - 5),
                    end: new Date(l, d, a - 2),
                    className: "bg-warning",
                },
                {
                    id: 999,
                    title: "Repeating Event",
                    start: new Date(l, d, a - 3, 16, 0),
                    allDay: !1,
                    className: "bg-info",
                },
                {
                    id: 999,
                    title: "Repeating Event",
                    start: new Date(l, d, a + 4, 16, 0),
                    allDay: !1,
                    className: "bg-primary",
                },
                {
                    title: "Meeting",
                    start: new Date(l, d, a, 10, 30),
                    allDay: !1,
                    className: "bg-success",
                },
                {
                    title: "Lunch",
                    start: new Date(l, d, a, 12, 0),
                    end: new Date(l, d, a, 14, 0),
                    allDay: !1,
                    className: "bg-danger",
                },
                {
                    title: "Birthday Party",
                    start: new Date(l, d, a + 1, 19, 0),
                    end: new Date(l, d, a + 1, 22, 30),
                    allDay: !1,
                    className: "bg-success",
                },
                {
                    title: "Click for Google",
                    start: new Date(l, d, 28),
                    end: new Date(l, d, 29),
                    url: "http://google.com/",
                    className: "bg-dark",
                },
        ...
        var w = new FullCalendar.Calendar(o, {
            ...
            eventResize: function (t) {
                ...
                g[e] &&
                    ...
                    (g[e].description = t.event._def.extendedProps.description
                        ? t.event._def.extendedProps.description
                        : ""),
                    (g[e].location = t.event._def.extendedProps.location
        ...
        (w.render(),
            n.addEventListener("submit", function (e) {
                ...
                var t = document.getElementById("event-title").value,
                    ...
                    i = !1;
                1 < a.length &&
                    ((d = new Date(a[1])).setDate(d.getDate() + 1),
                    new Date(a[0]),
                    (i = !0));
                var r,
                    o,
                    s = g.length + 1;
                !1 === m[0].checkValidity()
                    ? m[0].classList.add("was-validated")
                    : (v
                          ? (v.setProp("id", l),
                            v.setProp("title", t),
