(!(function (a) {
    ...
    ((e.prototype.init = function () {
        (a(".select2").select2(),
            ...
            a("#colorpicker-default").spectrum(),
            a("#colorpicker-showalpha").spectrum({ showAlpha: !0 }),
            a("#colorpicker-showpaletteonly").spectrum({
                showPaletteOnly: !0,
                showPalette: !0,
                color: "#34c38f",
                palette: [
            ...
            a("#colorpicker-togglepaletteonly").spectrum({
                showPaletteOnly: !0,
                togglePaletteOnly: !0,
            ...
            a("#colorpicker-showintial").spectrum({ showInitial: !0 }),
            a("#colorpicker-showinput-intial").spectrum({
                showInitial: !0,
                showInput: !0,
            }));
        (a(".vertical-spin").TouchSpin({
            verticalbuttons: !0,
            ...
            a("input[name='demo3']").TouchSpin({
                initval: 40,
                buttondown_class: "btn btn-primary",
                buttonup_class: "btn btn-primary",
            }),
            a("input[name='demo3_21']").TouchSpin({
                initval: 40,
                buttondown_class: "btn btn-primary",
                buttonup_class: "btn btn-primary",
            }),
            a("input[name='demo3_22']").TouchSpin({
                initval: 40,
                buttondown_class: "btn btn-primary",
                buttonup_class: "btn btn-primary",
            }),
            a("input[name='demo5']").TouchSpin({
                initval: 40,
                prefix: "pre",
                postfix: "post",
                buttondown_class: "btn btn-primary",
            ...
            a("input[name='demo0']").TouchSpin({
                initval: 40,
                buttondown_class: "btn btn-primary",
                buttonup_class: "btn btn-primary",
            }),
            a("input[name='demo_vertical']").TouchSpin({
                initval: 40,
                verticalbuttons: !0,
            }),
            a("input#defaultconfig").maxlength({
                warningClass: "badge bg-info",
                limitReachedClass: "badge bg-warning",
            }),
            a("input#thresholdconfig").maxlength({
                threshold: 20,
                warningClass: "badge bg-info",
                limitReachedClass: "badge bg-warning",
            }),
            a("input#moreoptions").maxlength({
                alwaysShow: !0,
                warningClass: "badge bg-success",
                limitReachedClass: "badge bg-danger",
            }),
            a("input#alloptions").maxlength({
                alwaysShow: !0,
                warningClass: "badge bg-success",
                limitReachedClass: "badge bg-danger",
                separator: " out of ",
            ...
            a("textarea#textarea").maxlength({
                alwaysShow: !0,
                warningClass: "badge bg-info",
                limitReachedClass: "badge bg-warning",
            }),
            a("input#placement").maxlength({
                alwaysShow: !0,
                placement: "top-left",
                warningClass: "badge bg-info",
                limitReachedClass: "badge bg-warning",
