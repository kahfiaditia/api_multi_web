(function () {
    var modern = (function () {
        ...
        var getUiContainerDelta = function (ctrl) {
            ...
            if (
                uiContainer &&
                global$3.DOM.getStyle(uiContainer, "position", true) !==
                    "static"
            ) {
        ...
        var setUiContainer = function (editor, ctrl) {
            var uiContainer = global$3.DOM.select(
        ...
        var addContextualToolbars = function (editor) {
            ...
            var getElementRect = function (elm) {
                ...
                if (root.nodeName === "BODY") {
                    targetRect.x -=
                        root.ownerDocument.documentElement.scrollLeft ||
                        root.scrollLeft;
                    targetRect.y -=
            ...
            var reposition = function (match, shouldShow) {
                ...
                var delta = $_ee91zwu4jkmcdy7u
                    .getUiContainerDelta(panel)
                    .getOr({
                        x: 0,
                        y: 0,
                    });
                ...
                if (!editor.inline) {
                    contentAreaRect.w =
                        editor.getDoc().documentElement.offsetWidth;
                }
                if (
                    editor.selection.controlSelection.isResizable(
                        match.element,
                    ) &&
                ...
                if (relPos) {
                    ...
                    elementRect = global$6.intersect(
                        contentAreaRect,
                        elementRect,
                    );
                    if (elementRect) {
            ...
            var repositionHandler = function (show) {
                return function () {
                    var execute = function () {
                        if (editor.selection) {
                            reposition(
                                findFrontMostMatch(editor.selection.getNode()),
                                show,
                            );
                        }
                    };
            ...
            var bindScrollEvent = function (panel) {
                if (!scrollContainer) {
                    ...
                    var uiContainer_1 =
                        $_ee91zwu4jkmcdy7u.getUiContainer(panel);
                    scrollContainer =
                        editor.selection.getScrollContainer() ||
                        editor.getWin();
            ...
            var showContextToolbar = function (match) {
                ...
                panel = global$4.create({
                    ...
                    fixed: true,
                    border: 1,
                    items: $_7x5kdxu7jkmcdy83.createToolbar(
                        editor,
                        match.toolbar.items,
                    ),
                    oncancel: function () {
        ...
        var cleanupMenu = function (namedMenuItems, removedMenuItems) {
            var menuItemsPass1 = filter(
                ...
                function (namedMenuItem) {
                    return (
                        removedMenuItems.hasOwnProperty(namedMenuItem.name) ===
                        false
                    );
                },
            );
            var menuItemsPass2 = filter(
                menuItemsPass1,
                function (namedMenuItem, i, namedMenuItems) {
                    return (
                        !isSeparator(namedMenuItem) ||
                        !isSeparator(namedMenuItems[i - 1])
                    );
                },
            );
            return filter(
                    ...
                    global$2.each(editorMenuItems, function (item, name) {
                        if (
                            ...
                            if (item.prependToContext) {
                                namedMenuItems.unshift(
                                    createMenuNameItemPair(name, item),
                                );
                            } else {
                                namedMenuItems.push(
                                    createMenuNameItemPair(name, item),
                        ...
                        items: [
                            hasMenubar(editor) === false
                                ...
                                : {
                                      type: "menubar",
                                      border: "0 0 1 0",
                                      items: $_5dpfyiu8jkmcdy85.createMenuButtons(
                                          editor,
                                      ),
                                  },
                            $_7x5kdxu7jkmcdy83.createToolbars(
                                editor,
                                getToolbarSize(editor),
                            ),
                        ],
                    },
                    $_8qd8cgucjkmcdy8h.hasSidebar(editor)
        ...
        function calculateRelativePosition(ctrl, targetElm, rel) {
            ...
            pos = funcs.getPos(
                targetElm,
                $_ee91zwu4jkmcdy7u.getUiContainer(ctrl),
            );
            x = pos.x;
            y = pos.y;
        ...
        var global$11 = tinymce.util.Tools.resolve(
        ...
        var proto$1 = {
            ...
            init: function (settings) {
                ...
                self$$1.settings = settings = global$2.extend(
                    {},
                    self$$1.Defaults,
                    settings,
                );
                ...
                self$$1.borderBox = $_dghgu3uqjkmcdyaa.parseBox(
                    settings.border,
                );
                self$$1.paddingBox = $_dghgu3uqjkmcdyaa.parseBox(
                    settings.padding,
                );
                self$$1.marginBox = $_dghgu3uqjkmcdyaa.parseBox(
                    settings.margin,
                );
                if (settings.hidden) {
                    self$$1.hide();
            ...
            initLayoutRect: function () {
                ...
                borderBox = self$$1.borderBox =
                    self$$1.borderBox ||
                    $_dghgu3uqjkmcdyaa.measureBox(elm, "border");
                self$$1.paddingBox =
                    self$$1.paddingBox ||
                    $_dghgu3uqjkmcdyaa.measureBox(elm, "padding");
                self$$1.marginBox =
                    self$$1.marginBox ||
                    $_dghgu3uqjkmcdyaa.measureBox(elm, "margin");
            ...
            renderTo: function (elm) {
                global$9(elm || this.getContainerElm()).append(
                    this.renderHtml(),
                );
                this.postRender();
                return this;
        ...
        var FloatPanel = Panel.extend({
            Mixins: [$_4990vqukjkmcdy9i, $_ejnwl8v1jkmcdyb0],
            init: function (settings) {
                var self$$1 = this;
                    ...
                    if (e.control === self$$1) {
                        ...
                        if (self$$1.modal && !hasModal) {
                            ...
                            global$7.setTimeout(function () {
                                ...
                                global$9(self$$1.getEl()).addClass(
                                    prefix_1 + "in",
                                );
                            });
                            hasModal = true;
        ...
        var renderUI = function (editor, theme, args) {
            ...
            return isInline(editor)
                ? $_asw9u6ufjkmcdy8l.render(editor, theme, args)
                : $_53fm6mtvjkmcdy7f.render(editor, theme, args);
        };
        ...
        function toggleBodyFullScreenClasses(classPrefix, state) {
            if (checkFullscreenWindows() && state === false) {
                global$9([document.documentElement, document.body]).removeClass(
            ...
            fullscreen: function (state) {
                ...
                if (state !== self$$1._fullscreen) {
                    global$9(window).on("resize", function () {
                        ...
                        if (self$$1._fullscreen) {
                            if (!slowRendering) {
                                ...
                                if (!self$$1._timer) {
                                    self$$1._timer = global$7.setTimeout(
                                        function () {
                                            var rect = funcs.getWindowSize();
                                            self$$1
                                                .moveTo(0, 0)
                    ...
                    if (!state) {
                        ...
                        global$9([documentElement, document.body]).removeClass(
                            prefix + "fullscreen",
                        );
                        ...
                        global$9([documentElement, document.body]).addClass(
                            prefix + "fullscreen",
                        );
        ...
        var isComment = function (element) {
            return (
                type(element) === $_4ps4ckw5jkmcdye6.COMMENT ||
        ...
        var inBody = function (element) {
            var dom = $_7p9wzbw4jkmcdye2.isText(element)
        ...
        var detectBrowser = function (browsers, userAgent) {
            return detect$1(browsers, userAgent).map(function (browser) {
                var version = $_52l1dwljkmcdyfn.detect(
        ...
        var detect$2 = function (userAgent) {
            ...
            var browser = $_469cgwwojkmcdyfv
                .detectBrowser(browsers, userAgent)
                .fold($_86ub36wkjkmcdyfk.unknown, $_86ub36wkjkmcdyfk.nu);
            var os = $_469cgwwojkmcdyfv
                .detectOs(oses, userAgent)
                .fold($_3hjfqmwmjkmcdyfp.unknown, $_3hjfqmwmjkmcdyfp.nu);
        ...
        var ieContains = function (e1, e2) {
            return $_8howtqwejkmcdyfa.documentPositionContainedBy(
                e1.dom(),
                e2.dom(),
            );
        };
        ...
        var ancestors$1 = function (scope, selector, isRoot) {
            return $_2mfngbw1jkmcdydu.ancestors(
                scope,
                function (e) {
        ...
        var ancestor$1 = function (scope, selector, isRoot) {
            return $_6xy2e5wzjkmcdygx.ancestor(
                scope,
                function (e) {
                    return $_5kj9i7wtjkmcdygd.is(e, selector);
                },
        ...
        var trimMenuItems = function (menuItems) {
            var menuItems2 = filter(
                ...
                function (menuItem, i, menuItems) {
                    return (
                        !isSeparator$1(menuItem) ||
                        !isSeparator$1(menuItems[i - 1])
                    );
                },
            );
        ...
        var setupUiContainer = function (editor) {
            if (editor.settings.ui_container) {
                global$8.container = $_c1uaw9wyjkmcdygw
                    .descendant(
        ...
        var ListBox = MenuButton.extend({
            ...
            value: function (value) {
                ...
                if (this.settings.values) {
                    var matchingValues = global$2.grep(
        ...
        var SplitButton = MenuButton.extend({
            ...
            activeMenu: function (state) {
                var self$$1 = this;
                global$9(self$$1.getEl().lastChild).toggleClass(
        ...
        var TabPanel = Panel.extend({
            ...
            activateTab: function (idx) {
                ...
                if (this.activeTabId) {
                    ...
                    global$9(activeTabElm).removeClass(
