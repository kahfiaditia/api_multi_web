!(function () {
        ...
        V = function (x) {
            var i,
                    ...
                    if (!x.removed) {
                        ...
                        ((l = [
                            ...
                            "BODY" === (m = x.dom.getRoot()).nodeName &&
                                ...
                                (h.y -=
                                    m.ownerDocument.documentElement.scrollTop ||
                                    m.scrollTop)),
                            (h.x += f.x),
                            (h.y += f.y),
                            (r = h),
                        ...
                        var g,
                            p,
                            v,
                            b = O.getUiContainerDelta(s).getOr({ x: 0, y: 0 });
                        if (
                            ((r.x += b.x),
                            (r.y += b.y),
                            (i.x += b.x),
                        ...
                        (x.inline ||
                            (o.w = x.getDoc().documentElement.offsetWidth),
                            x.selection.controlSelection.isResizable(
                                e.element,
                            ) &&
                                r.w < 25 &&
                                (r = R.inflate(r, 0, 8)),
                ...
                t = function (e) {
                    var t;
                    if (e.toolbar.panel)
                        return (e.toolbar.panel.show(), void n(e));
                    ((t = b.create({
                        type: "floatpanel",
                        role: "dialog",
                        ...
                        (function (e) {
                            if (!i) {
                                ...
                                ((i =
                                    x.selection.getScrollContainer() ||
                                    x.getWin()),
                                    I.bind(i, "scroll", t),
                                    I.bind(n, "scroll", t),
                ...
                a = function (e) {
                    var t,
                        ...
                        r = o();
                    for (
                        t = (i = x.$(e).parents().add(e)).length - 1;
                        0 <= t;
                        t--
                    )
                        for (n = r.length - 1; 0 <= n; n--)
                            if (r[n].predicate(i[t]))
                                return { toolbar: r[n], element: i[t] };
                    return null;
                };
    ...
    function ke(e, t, n) {
        ...
        return (
            (d = Te()),
            (o = (r = Ce.getPos(t, O.getUiContainer(e))).x),
            (s = r.y),
            Ee(e) && Re(document.body) && ((o -= d.x), (s -= d.y)),
            (i = e.getEl()),
            (a = (f = Ce.getSize(i)).width),
            (l = f.height),
            (u = (f = Ce.getSize(t)).width),
            (c = f.height),
            "b" === (n = (n || "").split(""))[0] && (s += c),
            "r" === n[1] && (o += u),
    ...
    var Je,
        ...
        Ke = Me.extend({
            ...
            init: function (e) {
                var t, n;
                for (t in (e = e || {}))
                    (n = e[t]) instanceof Xe && (e[t] = n.create(this, t));
                this.data = e;
            },
            set: function (t, n) {
                var i,
                    ...
                    o = this.data[t];
                if (
                    (n instanceof Xe && (n = n.create(this, t)),
                    "object" == typeof t)
                ) {
        ...
        it = {
            ...
            initLayoutRect: function () {
                var e,
                    ...
                    d = c.settings,
                    f = c.getEl();
                ((e = c.borderBox = c.borderBox || De(f, "border")),
                    (c.paddingBox = c.paddingBox || De(f, "padding")),
                    (c.marginBox = c.marginBox || De(f, "margin")),
                    (u = Ce.getSize(f)),
                    (a = d.minWidth),
                    (l = d.minHeight),
                    (r = a || u.width),
    ...
    var ut = {},
        ct = st.extend({
            ...
            prepend: function (e) {
                return (
                    this.items().set(
                        this.create(e).concat(this.items().toArray()),
                    ),
                    this.renderNew()
                );
            },
            ...
            for (var n, i = 0; i < xt.length; i++)
                if (xt[i] !== r)
                    for (n = xt[i].parent(); n && (n = n.parent()); )
                        n === r && xt[i].fixed(e).moveBy(0, t).repaint();
        }
        r.settings.autofix &&
            (r.state.get("fixed")
                ? r._autoFixY > e &&
    ...
    var Ht = function (e, t) {
        ...
        St = function (s, e, t) {
            ...
            var r = function () {
                    if (a && a.moveRel && a.visible() && !a._fixed) {
                        ...
                        if (e) {
                            var r = l.getPos(t),
                                o = l.getPos(e);
                            ((n = Math.max(0, o.x - r.x)),
                                (i = Math.max(0, o.y - r.y)));
                        }
                        a.fixed(!1)
                            .moveRel(
                                t,
                ...
                o = function () {
                    a &&
                        (a.show(),
                        r(),
                        l.addClass(s.getBody(), "mce-edit-focus"));
                },
                u = function () {
                    a &&
                        (a.hide(),
            ...
            return (
                ...
                !1 === g(s) && t.skinUiCss
                    ? l.styleSheetLoader.load(t.skinUiCss, ve(s))
                    : ve(s)(),
                {}
            );
        };
    ...
    var Nt = function (e, t) {
        ...
        Wt = st.extend({
            ...
            tooltip: function () {
                return (
                    this._tooltip ||
                        ((this._tooltip = new Dt({ type: "tooltip" })),
                        O.inheritUiContainer(this, this._tooltip),
            ...
            bindStates: function () {
                ...
                function n(e) {
                    ((e = t.settings.filter(e)),
                        ...
                        (t.getEl().firstChild.firstChild.style.width =
                            e + "%"));
                }
                return (
        ...
        Bt = st.extend({
            ...
            init: function (e) {
                ...
                (t._super(e),
                    ...
                    e.timeout &&
                    (e.timeout < 0 || 0 < e.timeout) &&
                    !e.closeButton
                        ? (t.closeButton = !1)
                        : (t.classes.add("has-close"), (t.closeButton = !0)),
                    e.progressBar && (t.progressBar = new Ot()),
            ...
            bindStates: function () {
                ...
                return (
                    t.state.on("change:text", function (e) {
                        ((t.getEl().firstChild.innerHTML = e.value),
                            At(t, e.value));
                    }),
                    t.progressBar &&
    ...
    function Ut(e, t) {
        (function () {
            ...
            !1 === t &&
            we([document.documentElement, document.body]).removeClass(
                e + "fullscreen",
            );
    }
    var Vt = kt.extend({
        ...
        init: function (e) {
            ...
            (n._super(e),
                ...
                n.on("click", function (e) {
                    ...
                    (Ce.hasClass(e.target, t) ||
                        Ce.hasClass(e.target.parentNode, t)) &&
                        n.close();
                }),
            ...
            if (e !== i._fullscreen)
                if (
                    ...
                    ((i._initial = { x: t.x, y: t.y, w: t.w, h: t.h }),
                        ...
                        we([r, document.body]).addClass(o + "fullscreen"),
                    ...
                    ((i.borderBox = Pe(i.settings.border)),
                        ...
                        (t.deltaH += t.headerH),
                        we([r, document.body]).removeClass(o + "fullscreen"),
    ...
    !(function () {
        if (!fe.desktop) {
            ...
            u.setInterval(function () {
                ...
                (n.w === e && n.h === t) ||
                    ((n = { w: e, h: t }), we(window).trigger("resize"));
            }, 100);
        }
        we(window).on("resize", function () {
            var e,
            ...
            for (e = 0; e < It.length; e++)
                ((t = It[e].layoutRect()),
                    It[e].moveTo(
                        It[e].settings.x || Math.max(0, n.w / 2 - t.w / 2),
                        It[e].settings.y || Math.max(0, n.h / 2 - t.h / 2),
                    ));
        });
    })();
    var Yt = Vt.extend({
        ...
        Qt = Wt.extend({
            ...
            repaint: function () {
                ...
                (n.statusLevel() &&
                    "none" !== n.statusLevel() &&
                    (s =
                        parseInt(Ce.getRuntimeStyle(a, "padding-right"), 10) -
                        parseInt(Ce.getRuntimeStyle(a, "padding-left"), 10)),
                    (e = r ? o.w - Ce.getSize(r).width - 10 : o.w - 10));
                var l = document;
                return (
                    l.all &&
                ...
                (r.state.on("change:value", function (e) {
                    ...
                    r.state.on("change:statusLevel", function (e) {
                        var t = r.getEl("status"),
                            n = r.classPrefix,
                            i = e.value;
                        (Ce.css(t, "display", "none" === i ? "none" : ""),
                            Ce.toggleClass(t, n + "i-checkmark", "ok" === i),
                            Ce.toggleClass(t, n + "i-warning", "warn" === i),
                            Ce.toggleClass(t, n + "i-error", "error" === i),
        ...
        sn = Wt.extend({
            ...
            postRender: function () {
                ...
                function u(e, t) {
                    ...
                    return (
                        ...
                        (i = t.pageY - r.y),
                        {
                            x: (n = Math.max(
                                0,
                                Math.min(n / e.clientWidth, 1),
                            )),
                            y: (i = Math.max(
                                0,
                                Math.min(i / e.clientHeight, 1),
                            )),
                        }
                    );
                }
                ...
                ((i = a.getEl("h")),
                    ...
                    a._super(),
                    (a._svdraghelper = new ft(a._id + "-sv", {
                        start: e,
                        drag: e,
                    })),
                ...
                (i.settings.formItemDefaults ||
                    ...
                    e.each(function (e) {
                        ...
                        n &&
                            ...
                            "undefined" == typeof e.settings.flex &&
                                (e.settings.flex = 1),
                            i.replace(e, t),
                            t.add(e));
                    }));
        ...
        Hn = {
            unknown: function () {
                return Tn({ current: undefined, version: Rn.unknown() });
            },
            nu: Tn,
            edge: k("Edge"),
            chrome: k("Chrome"),
        ...
        Gn = {
            ...
            one: function (e, t) {
                ...
                return Jn(n)
                    ? D.none()
                    : D.from(n.querySelector(e)).map(gn.fromDom);
            },
        },
        Kn =
            (Xn().browser.isIE(),
        ...
        ui = function (e) {
            ...
            return ni(
                ...
                ii(e),
                "#" + n,
                si((t = e)) ? parseInt(t.nodeName.substr(1), 10) : 0,
                function () {
                    e.id = n;
                },
            );
        ...
        di = function (e) {
            ...
            return (
                ...
                (n = e),
                J(Kn(gn.fromDom(n), t), function (e) {
                    return e.dom();
                })
            );
        },
                ...
                : "file" === r
                  ? ((n = [
                        ...
                        xi(
                            e,
                            ((a = f("anchor")),
                            (l = vi(t, "anchor_top", "#top")),
                            (u = vi(t, "anchor_bottom", "#bottom")),
                            null !== l && a.unshift(pi("<top>", l)),
                            null !== u && a.push(pi("<bottom>", u)),
                            a),
                        ),
                    ]),
                    (o = function (e, t) {
            ...
            recalc: function (e) {
                ...
                if (
                    ...
                    for (
                        ...
                        ((p =
                            (m = (h = i[t]).layoutRect()).maxFlexSize || m[C]),
                            "center" === a
                                ? (y[M] = Math.round(r[N] / 2 - m[P] / 2))
                                : "stretch" === a
                                  ? ((y[P] = I(m[D] || 0, r[N] - o[W] - o[O])),
                                    (y[M] = o[W]))
                    ...
                    l.on("init nodeChange", function (e) {
                        var t,
                            ...
                            s =
                                ...
                                (r = (n = o) ? n.toLowerCase() : ""),
                                w.each(t, function (e) {
                                    e.value.toLowerCase() === r &&
                                        (i = e.value);
                                }),
                                w.each(t, function (e) {
                                    i ||
                                        Ni(e.value).toLowerCase() !==
                                            Ni(r).toLowerCase() ||
                                        (i = e.value);
                                }),
                                i);
        ...
        Ii = function (n, e) {
            ...
            return (
                w.each(e, function (e) {
                    ...
                    var t = e.format;
                    (t && (e.hidden = !n.formatter.canApply(t)),
                        e.hidden && i--);
                }),
                i
            );
        ...
        zi = function (n, e) {
            ...
            return (
                e.items().each(function (e) {
                    (e.menu && e.visible(0 < zi(n, e.menu)),
                        !e.menu &&
                            e.settings.menu &&
                            e.visible(0 < Ii(n, e.settings.menu)));
                    var t = e.settings.format;
                    (t && e.visible(n.formatter.canApply(t)),
                        e.visible() || i--);
                }),
                i
            );
                            ...
                            onPostRender: function () {
                                ...
                                n.parent().on("show", function () {
                                    ...
                                    ((e = n.settings.format) &&
                                        ...
                                        (t = n.settings.cmd) &&
                                            n.active(i.queryCommandState(t)));
                                });
                            },
                            onclick: function () {
                                (this.settings.format &&
                                    Ti(i, this.settings.format)(),
                                    this.settings.cmd &&
            ...
            setup: function (e) {
                ...
                (e.rtl && (st.rtl = !0),
                    ...
                    (t = e).settings.ui_container &&
                        (fe.container = ki(
                            gn.fromDom(document.body),
                            t.settings.ui_container,
                        ).fold(k(null), function (e) {
                            return e.dom();
                        })),
                    (Wt.tooltips = !fe.iOS),
        ...
        tr = qt.extend({
            recalc: function (e) {
                ...
                ((t = e.settings),
                    ...
                    (w = t.alignV || t.align),
                    (p = e.paddingBox),
                    (H = "reverseRows" in t ? t.reverseRows : e.isRtl()),
            ...
            initLayoutRect: function () {
                ...
                return (
                    e.settings.multiline &&
                        (Ce.getSize(e.getEl()).width > t.maxW &&
        ...
        ar = jt.extend({
            ...
            showMenu: function (e) {
                ...
                (n.menu ||
                    ...
                    t.renderTo
                        ? (n.menu = t.parent(n).show().renderTo())
                        : (n.menu = b.create(t).parent(n).renderTo()),
                    n.fire("createmenu"),
                    n.menu.reflow(),
            ...
            renderHtml: function () {
                ...
                return (
                    ...
                    t.aria(
                        "role",
                        t.parent() instanceof sr ? "menuitem" : "button",
                    ),
                    '<div id="' +
                        n +
                        '" class="' +
        ...
        lr = kt.extend({
            ...
            load: function () {
                ...
                n.settings.itemsFactory &&
                    (n.throbber ||
                        ((n.throbber = new Mt(n.getEl("body"), !0)),
                        0 === n.items().length
            ...
            preRender: function () {
                ...
                return (
                    n.items().each(function (e) {
                        var t = e.settings;
                        if (t.icon || t.image || t.selectable)
                ...
                if (
                    ...
                    ((t = n.menu)
                        ...
                        : ((t = e.menu).length
                          ...
                          (t = n.menu =
                              b.create(t).parent(n).renderTo()).reflow(),
        ...
        dr = Kt.extend({ Defaults: { classes: "radio", role: "radio" } }),
        fr = Wt.extend({
            renderHtml: function () {
                var e = this,
                    t = e.classPrefix;
    ...
    function vr(e, t) {
        ...
        ("v" === e.settings.orientation
            ...
            (s = e.getEl("handle")),
            (o =
                ((e.layoutRect()[n] || 100) - Ce.getSize(s)[i]) *
                    ((t - e._minValue) / (e._maxValue - e._minValue)) +
                "px"),
            (s.style[r] = o),
            (s.style.height = e.layoutRect().h + "px"),
            pr(s, "valuenow", t),
            pr(s, "valuetext", "" + e.settings.previewFilter(t)),
            pr(s, "valuemin", e._minValue),
            pr(s, "valuemax", e._maxValue));
    }
    var br = Wt.extend({
            init: function (e) {
                var t = this;
        ...
        _r = bt.extend({
            ...
            initLayoutRect: function () {
                var e,
                    ...
                    n,
                    i = this;
                ((t = (t = Ce.getSize(i.getEl("head")).width) < 0 ? 0 : t),
                    (n = 0),
                    i.items().each(function (e) {
    ...
    (w.each(Rr(), function (e, t) {
        ...
        Er(window.tinymce ? window.tinymce : {}),
