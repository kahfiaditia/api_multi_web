(function () {
    var inlite = (function () {
        ...
        var getSelectionRect = function (editor) {
            ...
            return clientRect
                ? toAbsolute($_296847181jkmce22h.fromClientRect(clientRect))
                : null;
        };
            ...
            return function (editor) {
                for (var i = 0; i < predicateIds.length; i++) {
                    if (predicateIds[i].predicate(element)) {
                        var result = $_e0a9ur17zjkmce22f.result(
                            predicateIds[i].id,
                            $_aeqh8m180jkmce22g.getElementRect(editor, element),
                        );
                        return result;
                    }
                }
                ...
                for (var i = 0; i < elements.length; i++) {
                    for (var x = 0; x < predicateIds.length; x++) {
                        if (predicateIds[x].predicate(elements[i])) {
                            return $_e0a9ur17zjkmce22f.result(
                                predicateIds[x].id,
                                $_aeqh8m180jkmce22g.getElementRect(
                                    editor,
                                    elements[i],
                                ),
                            );
        ...
        var textSelection = function (id) {
            return function (editor) {
                if (!editor.selection.isCollapsed()) {
                    var result = $_e0a9ur17zjkmce22f.result(
                        id,
                        $_aeqh8m180jkmce22g.getSelectionRect(editor),
                    );
                    return result;
                }
                return null;
        ...
        var calcByPositions = function (
            ...
            var paddedContentRect = {
                ...
                w:
                    contentAreaRect.w +
                    (contentAreaRect.w < panelRect.w + targetRect.w
                        ? panelRect.w
                        : 0),
                h:
                    contentAreaRect.h +
                    (contentAreaRect.h < panelRect.h + targetRect.h
                        ? panelRect.h
                        : 0),
            };
        ...
        var userConstrain = function (
            ...
            if (typeof handler === "function") {
                userConstrainedPanelRect = handler({
                    ...
                    contentAreaRect:
                        $_296847181jkmce22h.toClientRect(contentAreaRect),
                    panelRect: $_296847181jkmce22h.toClientRect(panelRect),
                });
                return $_296847181jkmce22h.fromClientRect(
        ...
        var getTextSelectionToolbarItems = function (editor) {
            return $_8duj8f189jkmce22o.getToolbarItemsOr(
                editor,
                "selection_toolbar",
        ...
        var getPositionHandler = function (editor) {
            return $_8duj8f189jkmce22o.getHandlerOr(
                editor,
                "inline_toolbar_position_handler",
                $_bj13hp18bjkmce22r.defaultHandler,
            );
        };
        ...
        var load = function (editor, callback) {
            ...
            if ($_d1dtfi187jkmce22m.isSkinDisabled(editor)) {
                ...
                global$2.DOM.styleSheetLoader.load(
                    skinUrl + "/skin.min.css",
                    done,
                );
        ...
        var findMatchResult = function (editor, toolbars) {
            ...
            contextToolbarsPredicateIds =
                $_ftyqcr182jkmce22i.fromContextToolbars(toolbars);
            result = $_e0a9ur17zjkmce22f.match(editor, [
                $_f6pf0u17yjkmce22d.element(
                    elements[0],
                    contextToolbarsPredicateIds,
                ),
                $_fb6b2a184jkmce22j.textSelection("text"),
                $_fb6b2a184jkmce22j.emptyTextBlock(elements, "insert"),
                $_f6pf0u17yjkmce22d.parent(
                    elements,
                    contextToolbarsPredicateIds,
                ),
            ]);
        ...
        var overrideLinkShortcut = function (editor, panel) {
            ...
            editor.shortcuts.add("meta+k", "", function () {
                var toolbars = getToolbars(editor);
                var result = $_e0a9ur17zjkmce22f.match(editor, [
                    $_fb6b2a184jkmce22j.textSelection("quicklink"),
                ]);
                if (result) {
                    panel.show(editor, result.id, result.rect, toolbars);
                }
        ...
        var global$9 = tinymce.util.Tools.resolve(
        ...
        var $_18mjqa18pjkmce24g = {
            ...
            measureBox: function (elm, prefix) {
                function getStyle(name) {
                    ...
                    if (defaultView) {
                        var computedStyle = defaultView.getComputedStyle(
                            elm,
                            null,
                        );
                        if (computedStyle) {
        ...
        var getUiContainerDelta = function (ctrl) {
            ...
            if (
                uiContainer &&
                global$2.DOM.getStyle(uiContainer, "position", true) !==
                    "static"
            ) {
        ...
        var setUiContainer = function (editor, ctrl) {
            var uiContainer = global$2.DOM.select(
        ...
        var proto$1 = {
            ...
            init: function (settings) {
                ...
                self$$1.borderBox = $_18mjqa18pjkmce24g.parseBox(
                    settings.border,
                );
                self$$1.paddingBox = $_18mjqa18pjkmce24g.parseBox(
                    settings.padding,
                );
                self$$1.marginBox = $_18mjqa18pjkmce24g.parseBox(
                    settings.margin,
                );
                if (settings.hidden) {
                    self$$1.hide();
            ...
            initLayoutRect: function () {
                ...
                borderBox = self$$1.borderBox =
                    self$$1.borderBox ||
                    $_18mjqa18pjkmce24g.measureBox(elm, "border");
                self$$1.paddingBox =
                    self$$1.paddingBox ||
                    $_18mjqa18pjkmce24g.measureBox(elm, "padding");
                self$$1.marginBox =
                    self$$1.marginBox ||
                    $_18mjqa18pjkmce24g.measureBox(elm, "margin");
                ...
                if (newRect) {
                    ...
                    if (
                        ...
                        if (repaintControls) {
                            if (
                                repaintControls.map &&
                                !repaintControls.map[self$$1._id]
                            ) {
            ...
            repaint: function () {
                ...
                if (
                    self$$1._hasBody &&
                    rect.innerW !== lastRepaintRect.innerW
                ) {
                ...
                if (
                    self$$1._hasBody &&
                    rect.innerH !== lastRepaintRect.innerH
                ) {
            ...
            on: function (name$$1, callback) {
                ...
                getEventDispatcher(self$$1).on(
                    name$$1,
                    resolveCallbackName(callback),
                );
                return self$$1;
            },
            ...
            renderTo: function (elm) {
                global$7(elm || this.getContainerElm()).append(
                    this.renderHtml(),
                );
                this.postRender();
                return this;
        ...
        function calculateRelativePosition(ctrl, targetElm, rel) {
            ...
            pos = funcs.getPos(
                targetElm,
                $_9szbhj18xjkmce24x.getUiContainer(ctrl),
            );
            x = pos.x;
            y = pos.y;
                    ...
                    self.on("mouseenter", function (e) {
                        ...
                        if (e.control === self) {
                            var rel = tooltip
                                ...
                                .show()
                                .testMoveRel(self.getEl(), [
                                    "bc-tc",
                                    "bc-tl",
                                    "bc-tr",
                                ]);
                            tooltip.classes.toggle(
                                "tooltip-n",
                                rel === "bc-tc",
                            );
                            tooltip.classes.toggle(
        ...
        var Progress = Widget.extend({
            ...
            bindStates: function () {
                ...
                function setValue(value) {
                    ...
                    self.getEl().firstChild.firstChild.style.width =
                        value + "%";
                }
        ...
        var updateLiveRegion = function (ctx, text) {
            ctx.getEl().lastChild.textContent =
                text +
                (ctx.progressBar ? " " + ctx.progressBar.value() + "%" : "");
        };
        ...
        function getDocumentSize(doc) {
            ...
            return {
                ...
                height:
                    scrollHeight < offsetHeight ? clientHeight : scrollHeight,
            };
        }
        ...
        var Container = Control$1.extend({
            ...
            focus: function (keyboard) {
                ...
                if (keyboard) {
                    keyboardNav =
                        self.keyboardNav ||
                        self.parents().eq(-1)[0].keyboardNav;
                    if (keyboardNav) {
            ...
            prepend: function (items) {
                var self = this;
                self.items().set(
                    self.create(items).concat(self.items().toArray()),
                );
                ...
                function repaintScroll() {
                    ...
                    function repaintAxis(
                        ...
                        if (scrollBarElm) {
                            ...
                            containerElm = self.getEl("body");
                            scrollThumbElm = self.getEl(
                                "scroll" + axisName + "t",
                            );
                            containerSize =
                                containerElm["client" + sizeName] - margin * 2;
                            containerSize -=
                                hasScrollH && hasScrollV
                                    ? scrollBarElm["client" + ax]
                                    : 0;
                            scrollSize = containerElm["scroll" + sizeName];
                            ratio = containerSize / scrollSize;
                            rect = {};
                            rect[posNameLower] =
                                containerElm["offset" + posName] + margin;
                            rect[sizeNameLower] = containerSize;
                            global$7(scrollBarElm).css(rect);
                            rect = {};
                            rect[posNameLower] =
                                containerElm["scroll" + posName] * ratio;
                    ...
                    function addScrollAxis(
                        ...
                        self.draghelper = new DragHelper(axisId + "t", {
                            ...
                            drag: function (e) {
                                ...
                                hasScrollH =
                                    layoutRect.contentW > layoutRect.innerW;
                                hasScrollV =
                                    layoutRect.contentH > layoutRect.innerH;
                                containerSize =
                                    self.getEl("body")["client" + sizeName] -
                                    margin * 2;
                                containerSize -=
                                    hasScrollH && hasScrollV
                                        ? self.getEl("scroll" + axisName)[
                                              "client" + ax
                                          ]
                                        : 0;
                                ratio =
                                    containerSize /
                                    self.getEl("body")["scroll" + sizeName];
                                self.getEl("body")["scroll" + posName] =
                                    scrollStart +
                                    e["delta" + deltaPosName] / ratio;
                            },
                            stop: function () {
                                global$7("#" + axisId).removeClass(
                                    prefix + "active",
                                );
                            },
                        });
        ...
        function skipOrHidePanels(e) {
            ...
            while (i--) {
                ...
                if (panel.settings.autohide) {
                    if (clickCtrl) {
                        if (
                            isChildOf(clickCtrl, panel) ||
                            panel.parent() === clickCtrl
                        ) {
                            continue;
                        }
                    }
        ...
        var FloatPanel = Panel.extend({
            Mixins: [$_csk62318yjkmce251, $_79om9j19bjkmce267],
            init: function (settings) {
                var self$$1 = this;
                    ...
                    if (e.control === self$$1) {
                        ...
                        if (self$$1.modal && !hasModal) {
                            ...
                            global$3.setTimeout(function () {
                                ...
                                global$7(self$$1.getEl()).addClass(
                                    prefix_1 + "in",
                                );
                            });
                            hasModal = true;
            ...
            postRender: function () {
                ...
                if (self$$1.settings.bodyRole) {
                    this.getEl("body").setAttribute(
                        "role",
                        self$$1.settings.bodyRole,
                    );
                }
        ...
        function toggleFullScreenState(state) {
            ...
            viewport.setAttribute(
                "content",
                state ? noScaleMetaValue : oldMetaValue,
            );
        }
        ...
        function handleWindowResize() {
            ...
            function reposition() {
                ...
                for (i = 0; i < windows.length; i++) {
                    ...
                    windows[i].moveTo(
                        windows[i].settings.x ||
                            Math.max(0, rect.w / 2 - layoutRect.w / 2),
                        windows[i].settings.y ||
                            Math.max(0, rect.h / 2 - layoutRect.h / 2),
                    );
                }
            }
        ...
        var Window$$1 = FloatPanel.extend({
            ...
            recalc: function () {
                ...
                if (statusbar$$1) {
                    statusbar$$1
                        .layoutRect({ w: self$$1.layoutRect().innerW })
                        .recalc();
                    ...
                    global$7(window).on("resize", function () {
                        ...
                        if (self$$1._fullscreen) {
                            if (!slowRendering) {
                                ...
                                if (!self$$1._timer) {
                                    self$$1._timer = global$3.setTimeout(
                                        function () {
                                            var rect = funcs.getWindowSize();
                                            self$$1
                                                .moveTo(0, 0)
                                                .resizeTo(rect.w, rect.h);
                                            self$$1._timer = 0;
                                        },
                                        50,
                                    );
        ...
        var getSelectedAnchors = function (editor) {
            ...
            startElm = getParentAnchorOrSelf(
                dom,
                global$14.getNode(rng.startContainer, rng.startOffset),
            );
        ...
        var $_1z26lf19sjkmce273 = {
            getUiContainerDelta: getUiContainerDelta$1,
        };
        ...
        var convertLinkToAbsolute = function (editor, href) {
            return !$_d65d2i19ujkmce278.isAbsolute(href) &&
                $_d65d2i19ujkmce278.isDomainLike(href)
                ? askAboutPrefix(editor, href)
                : global$12.resolve(href);
        };
            ...
            global$4.each(itemsToArray$1(items), function (item) {
                if (item === "|") {
                    ...
                    if (editor.buttons[item]) {
                        ...
                        button.on(
                            "postRender",
                            bindSelectorChanged(editor, item, button),
                        );
        ...
        var create$3 = function () {
            ...
            var createToolbars = function (editor, toolbars) {
                return global$4.map(toolbars, function (toolbar) {
                    return $_2o52v419vjkmce279.create(
                        editor,
                        toolbar.id,
                        toolbar.items,
                    );
            ...
            var create = function (editor, toolbars) {
                var items = createToolbars(editor, toolbars).concat([
                    $_2o52v419vjkmce279.create(
                        editor,
                        "text",
                        $_d1dtfi187jkmce22m.getTextSelectionToolbarItems(
                            editor,
                        ),
                    ),
                    $_2o52v419vjkmce279.create(
                        editor,
                        "insert",
                        $_d1dtfi187jkmce22m.getInsertToolbarItems(editor),
                    ),
            ...
            var repositionPanelAt = function (panel, id, editor, targetRect) {
                ...
                userConstainHandler =
                    $_d1dtfi187jkmce22m.getPositionHandler(editor);
                contentAreaRect =
                    $_aeqh8m180jkmce22g.getContentAreaRect(editor);
                panelRect = global$2.DOM.getRect(panel.getEl());
                if (id === "insert") {
                    result = $_bj13hp18bjkmce22r.calcInsert(
                        targetRect,
                        contentAreaRect,
                        panelRect,
                    );
                } else {
                    result = $_bj13hp18bjkmce22r.calc(
                        targetRect,
                        contentAreaRect,
                        panelRect,
                    );
                ...
                if (result) {
                    ...
                    movePanelTo(
                        panel,
                        $_bj13hp18bjkmce22r.userConstrain(
                            userConstainHandler,
                            targetRect,
                            contentAreaRect,
                            transposedPanelRect,
            ...
            var showPanelAt = function (panel, id, editor, targetRect) {
                ...
                if (
                    repositionPanelAt(panel, id, editor, targetRect) === false
                ) {
                    hide();
                }
            };
        ...
        var Checkbox = Widget.extend({
            ...
            bindStates: function () {
                ...
                self$$1.state.on("change:text", function (e) {
                    self$$1.getEl("al").firstChild.data = self$$1.translate(
                        e.value,
                    );
                });
        ...
        var ComboBox = Widget.extend({
            ...
            repaint: function () {
                ...
                if (self$$1.statusLevel() && self$$1.statusLevel() !== "none") {
                    innerPadding =
                        parseInt(
                            funcs.getRuntimeStyle(inputElm, "padding-right"),
                            10,
                        ) -
                        parseInt(
                            funcs.getRuntimeStyle(inputElm, "padding-left"),
                            10,
                        );
                }
                if (openElm) {
        ...
        var isComment = function (element) {
            return (
                type(element) === $_8c386m1apjkmce29k.COMMENT ||
        ...
        var inBody = function (element) {
            var dom = $_1fsqa01aojkmce29j.isText(element)
        ...
        var detectBrowser = function (browsers, userAgent) {
            return detect$1(browsers, userAgent).map(function (browser) {
                var version = $_adwesp1b2jkmce2at.detect(
        ...
        var detect$2 = function (userAgent) {
            ...
            var browser = $_dt98cn1b5jkmce2b0
                .detectBrowser(browsers, userAgent)
                .fold($_ctzvfw1b1jkmce2ap.unknown, $_ctzvfw1b1jkmce2ap.nu);
            var os = $_dt98cn1b5jkmce2b0
                .detectOs(oses, userAgent)
                .fold($_ggufc41b3jkmce2au.unknown, $_ggufc41b3jkmce2au.nu);
        ...
        var ieContains = function (e1, e2) {
            return $_8ieu131ayjkmce2ak.documentPositionContainedBy(
                e1.dom(),
                e2.dom(),
            );
        };
        ...
        var ancestors = function (scope, predicate, isRoot) {
            return filter(
                $_59ui3f1aqjkmce29m.parents(scope, isRoot),
                predicate,
            );
        };
        ...
        var ancestors$1 = function (scope, selector, isRoot) {
            return $_26vcl71aljkmce297.ancestors(
                scope,
                function (e) {
        ...
        var hasContentEditableState = function (value) {
            return function (node) {
                if (node && node.nodeType === 1) {
                    ...
                    if (
                        node.getAttribute("data-mce-contenteditable") === value
                    ) {
                        return true;
                    }
                }
        ...
        var select = function (selector, root) {
            return map(
                $_dlp1bt1akjkmce296.descendants(
                    Element$$1.fromDom(root),
                    selector,
                ),
                function (element) {
                    return element.dom();
        ...
        var isEditable = function (elm) {
            return (
                isChildOfContentEditableTrue(elm) &&
                !isContentEditableFalse(elm)
            );
        };
        ...
        var getSetting = function (editorSettings, name, defaultValue) {
            var value =
                name in editorSettings ? editorSettings[name] : defaultValue;
        ...
        var createMenuItems = function (
            ...
            var anchorMenuItems = function () {
                ...
                if (bottomAchor !== null) {
                    anchorMenuItems.push(
                        staticMenuItem("<bottom>", bottomAchor),
                    );
                }
        ...
        var setupLinkValidatorHandler = function (
            ctrl,
            editorSettings,
            fileType,
        ) {
        ...
        var FilePicker = ComboBox.extend({
            ...
            init: function (settings) {
                ...
                if (
                    !fileBrowserCallbackTypes ||
                    fileBrowserCallbackTypes[fileType]
                ) {
                ...
                container
                    ...
                    .each(function (ctrl) {
                        ctrl.layoutRect({
                            ...
                            y: paddingBox.top,
                            w:
                                contLayoutRect.innerW -
                                paddingBox.right -
                                paddingBox.left,
                            h:
                                contLayoutRect.innerH -
                                paddingBox.top -
                                paddingBox.bottom,
                        });
                        if (ctrl.recalc) {
        ...
        var FlexLayout = AbsoluteLayout.extend({
            recalc: function (container) {
                ...
                rect[contentSizeName] =
                    contLayoutRect[innerSizeName] - availableSpace;
                ...
                for (i = 0, l = maxSizeItems.length; i < l; i++) {
                    ...
                    size =
                        ctrlLayoutRect[minSizeName] +
                        ctrlLayoutRect.flex * ratio;
                    if (size > maxSize) {
                        availableSpace -=
                            ctrlLayoutRect[maxSizeName] -
                            ctrlLayoutRect[minSizeName];
        ...
        function ClosestOrAncestor(is, ancestor, scope, a, isRoot) {
            return is(scope, a)
                ? Option.some(scope)
                : isFunction$1(isRoot) && isRoot(scope)
                  ? Option.none()
        ...
        var ancestor$1 = function (scope, selector, isRoot) {
            return $_caxo931bgjkmce2c3.ancestor(
                scope,
                function (e) {
                    return $_1nmi6n1bajkmce2bj.is(e, selector);
                },
                ...
                onShowMenu: function (e) {
                    ...
                    global$4.each(alignFormats, function (formatName, idx) {
                        menu.items()
                            ...
                            .each(function (item) {
                                return item.active(
                                    editor.formatter.match(formatName),
                                );
                            });
                    });
                },
        ...
        var registerButtons = function (editor) {
            editor.addButton("fontselect", function () {
                ...
                return {
                    ...
                    values: items,
                    fixedWidth: true,
                    onPostRender: createFontNameListBoxChangeHandler(
                        editor,
                        items,
                    ),
                    onselect: function (e) {
        ...
        var toPt = function (fontSize, precision) {
            if (/[0-9.]+px$/.test(fontSize)) {
                return (
                    round((parseInt(fontSize, 10) * 72) / 96, precision || 0) +
                    "pt"
                );
            }
            return fontSize;
        ...
        var hideFormatMenuItems = function (editor, menu) {
            ...
            menu.items().each(function (item) {
                ...
                if (!item.menu && item.settings.menu) {
                    item.visible(
                        hideMenuObjects(editor, item.settings.menu) > 0,
                    );
                }
                ...
                itemDefaults: {
                    ...
                    onPostRender: function () {
                        ...
                        self.parent().on("show", function () {
                            ...
                            if (formatName) {
                                self.disabled(
                                    !editor.formatter.canApply(formatName),
                                );
        ...
        var createInsertMenu = function (editor) {
            ...
            if (insertButtonItems) {
                return trimMenuItems(
                    createCustomMenuItems(editor, insertButtonItems),
                );
            } else {
        ...
        var setupUiContainer = function (editor) {
            if (editor.settings.ui_container) {
                global$1.container = $_g20dhs1bfjkmce2c1
                    .descendant(
        ...
        var GridLayout = AbsoluteLayout.extend({
            recalc: function (container) {
                ...
                contPaddingBox = container.paddingBox;
                reverseRows =
                    "reverseRows" in settings
                        ? settings.reverseRows
                        : container.isRtl();
                ...
                for (y = 0; y < rows; y++) {
                    for (x = 0; x < cols; x++) {
                        ...
                        colWidths[x] =
                            ctrlMinWidth > colWidths[x]
                                ? ctrlMinWidth
                                : colWidths[x];
                        rowHeights[y] =
                            ctrlMinHeight > rowHeights[y]
                                ? ctrlMinHeight
                                : rowHeights[y];
                    }
                }
                ...
                for (y = 0; y < rows; y++) {
                    ...
                    for (x = 0; x < cols; x++) {
                        ...
                        width = Math.max(
                            colWidths[x],
                            ctrlLayoutRect.startMinWidth,
                        );
                        ctrlLayoutRect.x = posX;
                        ctrlLayoutRect.y = posY;
                        align =
                            ctrlSettings.alignH ||
                            (alignH ? alignH[x] || alignH[0] : null);
                        if (align === "center") {
                            ctrlLayoutRect.x =
                                posX + width / 2 - ctrlLayoutRect.w / 2;
                        } else if (align === "right") {
                        ...
                        align =
                            ctrlSettings.alignV ||
                            (alignV ? alignV[x] || alignV[0] : null);
                        if (align === "center") {
                            ctrlLayoutRect.y =
                                posY + height / 2 - ctrlLayoutRect.h / 2;
        ...
        var MenuButton = Button.extend({
            ...
            postRender: function () {
                ...
                self$$1.on("click", function (e) {
                    if (
                        e.control === self$$1 &&
                        isChildOf$1(e.target, self$$1.getEl())
                    ) {
                        self$$1.focus();
        ...
        var ListBox = MenuButton.extend({
            init: function (settings) {
                ...
                function setSelected(menuValues) {
                    for (var i = 0; i < menuValues.length; i++) {
                        selected =
                            menuValues[i].selected ||
                            settings.value === menuValues[i].value;
                        if (selected) {
            ...
            value: function (value) {
                ...
                if (this.settings.values) {
                    var matchingValues = global$4.grep(
        ...
        var MenuItem = Widget.extend({
            ...
            renderHtml: function () {
                ...
                function boldMatches(text) {
                    return text
                        .replace(
                            new RegExp(escapeRegExp("!mce~match["), "g"),
                            "<b>",
                        )
                        .replace(
                            new RegExp(escapeRegExp("]mce~match!"), "g"),
                ...
                icon =
                    ...
                    prefix +
                    "i-" +
                    (self.settings.icon || "none");
                iconHtml =
                    text !== "-"
                        ? '<i class="' + icon + '"' + image + "></i>\xA0"
                        : "";
        ...
        function updateSliderHandle(ctrl, value) {
            ...
            styleValue =
                maxHandlePos *
                    ((value - ctrl._minValue) /
                        (ctrl._maxValue - ctrl._minValue)) +
                "px";
                ...
                function handleKeyboard(minValue, maxValue) {
                    function alter(delta) {
                        ...
                        value = fromFraction(
                            minValue,
                            maxValue,
                            toFraction(minValue, maxValue, value) +
                                delta * 0.05,
                        );
        ...
        var TabPanel = Panel.extend({
            ...
            activateTab: function (idx) {
                ...
                if (this.activeTabId) {
                    ...
                    global$7(activeTabElm).removeClass(
