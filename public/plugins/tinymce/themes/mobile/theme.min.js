!(function () {
    ...
    var n,
        ...
        vn = {
            unknown: function () {
                return gn({ current: undefined, version: rn.unknown() });
            },
            nu: gn,
            windows: E(sn),
            ios: E("iOS"),
        ...
        _n = function (n) {
            ...
            return {
                ...
                deviceType:
                    ...
                    (f = s && !c),
                    (l = t.isSafari() && e.isiOS() && !1 === /safari/i.test(r)),
                    {
                        isiPad: E(o),
                        isiPhone: E(i),
                        isTablet: E(c),
        ...
        $n = { tap: E("alloy.tap") },
        Gn = E("alloy.focus"),
        qn = E("alloy.blur.post"),
        Yn = E("alloy.receive"),
        Xn = E("alloy.execute"),
        Kn = E("alloy.focus.item"),
        Jn = $n.tap,
        Qn = Wn.detect().deviceType.isTouch() ? $n.tap : K,
        Zn = E("alloy.longpress"),
        ne = E("alloy.system.init"),
        ee = E("alloy.system.scroll"),
        te = E("alloy.system.attached"),
        re = E("alloy.system.detached"),
        oe = function (n, e) {
            ce(n, n.element(), e, {});
        },
        ie = function (n, e, t) {
        ...
        Me = function (n, e) {
            return (function (n, e) {
                for (
                    var t = e !== undefined && null !== e ? e : Re, r = 0;
        ...
        Ve = {
            ...
            one: function (n, e) {
                ...
                return Fe(t)
                    ? B.none()
                    : B.from(t.querySelector(n)).map(fe.fromDom);
            },
        },
        He = function (n, e) {
            return n.dom() === e.dom();
        },
        ze = (Wn.detect().browser.isIE(), He),
        je = function (n) {
            var e = n.dom();
        ...
        lt = st.strict,
        dt = st.asOption,
        mt = st.defaultedThunk,
        gt = (st.asDefaultedOptionThunk, st.mergeWithThunk),
        vt =
            (ct([
        ...
        ht = function (n, e) {
            ...
            return 0 < o.errors.length
                ...
                : ((t = o.values),
                  (r = e),
                  at.value(C.apply(undefined, [r].concat(t))));
        },
        bt = function (n) {
            var e = vt(n);
        ...
        Rt = function (n, e) {
            return (
                (r = e),
                (t = n).hasOwnProperty(r) && t[r] !== undefined && null !== t[r]
            );
            var t, r;
        },
        Mt = ct([
        ...
        It = ct([{ field: ["name", "presence", "type"] }, { state: ["name"] }]),
        Nt = function () {
        ...
        Ft = function (n) {
            return g(n) && 100 < F(n).length
                ? " removed due to size"
                : Bt(n, null, 2);
        },
        Vt = function (n, e) {
            return at.error([{ path: n, getErrorInfo: e }]);
        },
        Ht = ct([
            ...
            return n.fold(
                function (i, e, n, t) {
                    ...
                    return n.fold(
                        ...
                        function () {
                            return ((n = a), (e = i), at.value(wt(n, e))).bind(
                                u,
                            );
                            var n, e;
                        },
        ...
        Jt = function (n, e, t, r) {
            return e.extract([n], t, r).fold(function (n) {
                return at.error({ input: r, errors: n });
            }, at.value);
        },
        Qt = function (n, e, t) {
            return Jt(n, e, E, t);
        ...
        ir =
            ...
            Ut(function (n) {
                ...
                return i(n)
                    ? at.value(n)
                    : at.error("Expected type: " + u + " but got: " + e);
            })),
        ur = function (n) {
            return qt(n, n, lt(), $t());
        },
        ...
        pr = function (n) {
            if (!Rt(n, "can") && !Rt(n, "abort") && !Rt(n, "run"))
                throw new Error(
            ...
            return nr(
                ...
                Pt([mr("can", E(!0)), mr("abort", E(!1)), mr("run", k)]),
                n,
            );
        },
        hr = function (t) {
        ...
        yr = function (n, e) {
            return { key: n, value: pr({ abort: e }) };
        },
        wr = function (n, e) {
            return { key: n, value: pr({ run: e }) };
        },
        xr = function (n, e, t) {
            return {
                key: n,
                ...
                return {
                    ...
                    value: pr({
                        run: function (n, e) {
                            var t;
                            ((t = e),
                                ze(n.element(), t.event().target()) && r(n, e));
                        },
                    }),
                };
            };
        ...
        Ir = function (n) {
            return {
                ...
                defChildren: n.defChildren().fold(
                    function () {
                        return "<none>";
                    },
                    function (n) {
        ...
        Lr = function (n, e) {
            return Ur(n, e, { validate: w, label: "function" });
        },
        Ur = function (r, o, i) {
            if (0 === o.length)
                throw new Error(
        ...
        Xr = function (n) {
            var e,
                ...
                a,
                c,
                s = nr("Creating behaviour: " + n.name, Yr, n);
            return (
                (e = s.fields),
                (t = s.name),
                (r = s.active),
    ...
    var Zr = function (n, e, t) {
        ...
        ao = function (n, e, t) {
            ...
            return (
                0 < r.length ? ro.set(n, e, r.join(" ")) : ro.remove(n, e),
                !1
            );
        },
        co = function (n) {
        ...
        bo = {
            ...
            remove: function (n, e) {
                var t;
                (po(n) ? n.dom().classList.remove(e) : go(n, e),
                    0 === (po((t = n)) ? t.dom().classList : lo(t)).length &&
                        ro.remove(t, "class"));
            },
            toggle: function (n, e) {
        ...
        wo = Object.freeze({
            ...
            clear: function (n, e, t) {
                (bo.remove(n.element(), e.alpha()),
                    bo.remove(n.element(), e.omega()));
            },
        }),
        xo = [ur("alpha"), ur("omega")],
        To = Xr({ fields: xo, name: "swapping", apis: wo }),
        So = function (n) {
            var e = n,
                t = function () {
                    return e;
    ...
    var Co = function (n, e, t) {
        ...
        Eo = function (n, r) {
            var o = function (n) {
                for (var e = 0; e < n.childNodes.length; e++) {
                    if (r(fe.fromDom(n.childNodes[e])))
                        return B.some(fe.fromDom(n.childNodes[e]));
        ...
        Do = {
            ...
            sibling: function (e, t) {
                var n = e.dom();
                return n.parentNode
                    ? ko(fe.fromDom(n.parentNode), function (n) {
                          return !ze(e, n) && t(n);
                      })
                    : B.none();
            },
        ...
        gi = [
            ar(
                "channels",
                Wt(at.value, Pt([si("onReceive"), mr("schema", or())])),
            ),
        ],
        vi = Xr({ fields: gi, name: "receiving", active: Yo }),
        pi = function (n, e) {
            var t = wi(n, e),
                r = e.aria();
            r.update()(n, r, t);
        ...
        Si = Object.freeze({
            ...
            events: function (n, e) {
                var t,
                    ...
                    u = Fr(n, e, xi);
                return br(Dn([n.toggleOnExecute() ? [i] : [], [u]]));
            },
        }),
        Oi = function (n, e, t) {
        ...
        Ci = [
            mr("selected", !1),
            ur("toggleClass"),
            mr("toggleOnExecute", !0),
            gr(
                "aria",
                { mode: "none" },
                rr("mode", {
                    pressed: [
                        mr("syncWithExpanded", !1),
                        li("update", function (n, e, t) {
                            (ro.set(n.element(), "aria-pressed", t),
                                e.syncWithExpanded() && Oi(n, e, t));
                        }),
                    ],
                    checked: [
                        li("update", function (n, e, t) {
        ...
        ki = Xr({ fields: Ci, name: "toggling", active: Si, apis: Ti }),
        Ei = function (t, r) {
            return vi.config({
        ...
        Di = function (n) {
            return vi.config({
                channels: Et(jo.orientationChanged(), { onReceive: n }),
            });
        },
        Ai = function (n, e) {
        ...
        Vi = Xr({ fields: Fi, name: "focusing", active: Bi, apis: Ni }),
        Hi = function (n) {
        ...
        _i = {
            ...
            preserve: function (n, e) {
                var t = ro.get(n, "style"),
                    r = e(n);
                return (
                    (t === undefined ? ro.remove : ro.set)(n, "style", t),
                    r
                );
            },
            setAll: function (n, e) {
    ...
    var $i,
        ...
        yu = function (n, e, t, r) {
            var o = wu(n, e, t, r);
            (bu(n, e),
                bo.add(r.element(), e.highlightClass()),
                o || e.onHighlight()(n, r));
        },
        wu = function (n, e, t, r) {
        ...
        Su = function (e, n, t) {
            ...
            return (0 < r.length ? B.some(r[r.length - 1]) : B.none()).bind(
                function (n) {
                    return e.getSystem().getByDom(n).toOption();
                },
            );
        ...
        Cu = Object.freeze({
            ...
            dehighlight: function (n, e, t, r) {
                var o = wu(n, e, t, r);
                (bo.remove(r.element(), e.highlightClass()),
                    o && e.onDehighlight()(n, r));
            },
            highlight: yu,
            ...
            getHighlighted: function (e, n, t) {
                return ou(e.element(), "." + n.highlightClass()).bind(
                    function (n) {
                        return e.getSystem().getByDom(n).toOption();
                    },
                );
        ...
        Eu = Xr({ fields: ku, name: "highlighting", apis: Cu }),
        Du = function () {
            return {
                get: function (n) {
                    return Fo(n.element());
        ...
        Ru = function (n) {
            var e = [
                    fr("onEscape"),
                    fr("onEnter"),
                    mr("selector", '[data-alloy-tabstop="true"]'),
                    mr("firstTabstop", 0),
                    mr("useTabstopAt", E(!0)),
                    fr("visibilitySelector"),
                ].concat([n]),
                u = function (n, e) {
                    var t = n
                        .visibilitySelector()
                ...
                t = E([
                    vu(lu([du, fu([9])]), function (n, e, t, r) {
        ...
        Nu = function (n) {
            return (
                ("input" === be.name(n) && "radio" !== ro.get(n, "type")) ||
                "textarea" === be.name(n)
            );
        },
        Bu = function (n, e, t) {
            return Nu(t) && fu([32])(e.event())
                ? B.none()
                : (ae(n, t, Xn()), B.some(!0));
        },
        Fu = [
        ...
        ju = Au(
            ...
            function (n, e, t, r) {
                ...
                return [vu(fu(a), Vu)].concat(
                    t.useControlEnter() ? [vu(lu([mu, fu([13])]), Vu)] : [],
                );
            },
            Hu,
            zu,
        ...
        Lu = function (n) {
            ...
            return Gr({
                ...
                setGridSize: function (n, e) {
                    t.set(B.some({ numRows: E(n), numColumns: E(e) }));
                },
                getNumRows: function () {
        ...
        ea = function (n, e, t, r) {
            ...
            return Cn((o = a), i).map(function (n) {
                return Zu({ index: n, candidates: o });
            });
        },
        ta = function (n, e) {
        ...
        oa = function (o, n, i, u, a) {
            return ra(o, n, u, function (n, e) {
                var t = n === i - 1 ? o.length - n * u : u,
                    r = pu(e, a, 0, t - 1);
                return B.some({ row: E(n), column: E(r) });
            });
        },
        ia = function (i, n, u, a, c) {
            return ra(i, n, a, function (n, e) {
                var t = pu(n, c, 0, u - 1),
                    ...
                    o = hu(e, 0, r - 1);
                return B.some({ row: E(t), column: E(o) });
            });
        },
        ua = [
            ur("selector"),
        ...
        ka = function (n, e, t) {
            return B.from(n[e]).bind(function (n) {
                return B.from(n[t]).map(function (n) {
                    return Ca({ rowIndex: e, columnIndex: t, cell: n });
                });
            });
        },
        Ea = function (n, e, t, r) {
        ...
        Ma = [
            sr("selectors", [ur("row"), ur("cell")]),
            mr("cycles", !0),
            mr("previousSelector", B.none),
            mr("execute", Bu),
        ],
        Ia = function (n, e) {
        ...
        Ha = E([
            ...
            vu(fu([38]), Xu(Fa)),
            vu(fu([40]), Ku(Va)),
            vu(fu([32].concat([13])), function (e, t, r) {
        ...
        Ka = Au(
            ...
            function (n, e, t) {
                return [
                    vu(fu([32]), t.onSpace()),
                    vu(lu([gu, fu([13])]), t.onEnter()),
                    vu(lu([du, fu([13])]), t.onShiftEnter()),
                    vu(lu([du, fu([9])]), t.onShiftTab()),
                    vu(lu([gu, fu([9])]), t.onTab()),
                    vu(fu([38]), t.onUp()),
                    vu(fu([40]), t.onDown()),
                    vu(fu([37]), t.onLeft()),
                    vu(fu([39]), t.onRight()),
        ...
        Hc = function (o, n) {
            ...
            return (
                wn(n, function (n) {
                    var e;
                    ((e = n), e.fold(B.some, B.none, B.some, B.some)).each(
                        function (t) {
                            var r = zc(o, t.pname());
                            i[t.name()] = function (n) {
                                var e = nr(
                                ...
                                return C(r, { config: n, validated: e });
                            };
                        },
                    );
                }),
        ...
        zc = function (n, e) {
            return { uiType: pc(), owner: n, name: e };
        },
        jc = function (n, e, t) {
            return (
                (r = e),
        ...
        rs = function (n, e, t, r, o) {
            var i = os(o),
                u = An(t, function (n) {
                    return n
                        .fold(B.none, B.some, B.none, B.none)
                        .map(function (n) {
            ...
            return C(r(c, f, i, s.externals()), { "debug.sketcher": Et(n, o) });
        },
        os = function (n) {
            return C({ uid: es("uid") }, n);
        },
        is = Pt([
            ur("name"),
            ur("factory"),
            ...
            factory: function (n) {
                var e,
                    ...
                    o =
                        ...
                        (r = Wn.detect().deviceType.isTouch()
                            ? [wr(Jn(), t)]
                            : [
                                  wr(K(), t),
                                  wr(_(), function (n, e) {
        ...
        ls = Xr({ fields: [], name: "unselecting", active: fs }),
        ds = function (n) {
            var e,
                t,
                r,
                ...
                u =
                    ...
                    Sn(
                        ...
                        function (n, e) {
                            return "class" === e.name
                                ? n
                                : C(n, Et(e.name, e.value));
                        },
                        {},
                    )),
                a = ((r = o), Array.prototype.slice.call(r.dom().classList, 0)),
                c = 0 === i.length ? {} : { innerHtml: Po(o) };
            return C({ tag: be.name(o), classes: a, attributes: u }, c);
        },
        ms = function (n) {
            var e,
                o,
        ...
        xs = function (n, e, t, r, o, i, u) {
            ...
            var c,
                ...
                f,
                l,
                d = Math.min(n.right, Math.max(r, n.left)) - n.left,
            ...
            return (function (n) {
                ...
                if (Ss) {
                    ...
                    return t.touches !== undefined && 1 === t.touches.length
                        ? B.some(t.touches[0]).map(function (n) {
        ...
        Rs = function (n, r) {
            return Nc({
                ...
                overrides: function (n) {
                    ...
                    return { events: As ? e : t };
                },
            });
        },
        Ms = [
            Rs("left", function (n, e) {
                Cs(n, e.min() - 1);
            }),
            ...
            Ic({
                name: "thumb",
                defaults: E({ dom: { styles: { position: "absolute" } } }),
                overrides: function (n) {
                    return {
                        events: br([
                            Sr(L(), n, "spectrum"),
        ...
        _s = [
            gr(
                "store",
                { mode: "memory" },
                rr("mode", { memory: Ps, manual: Us, dataset: Ls }),
            ),
            ai("onSetValue"),
            mr("resetOnDom", !1),
        ],
                ...
                var s = c.max() - c.min(),
                    ...
                    i = function (n) {
                        var e,
                            ...
                            a =
                                ((e = n),
                                (t = i),
                                (o = (r = c).value().get()) < r.min()
                                    ? Uc(e, r, "left-edge").fold(
                                          function () {
                                              return 0;
                                          },
                                          function (n) {
                    ...
                    r = function (n, e) {
                        var t = c.value().get(),
                            r = o(n);
                        return t !== e ||
                            _i.getRaw(r.element(), "left").isNone()
                            ? (c.value().set(e),
                              u(n),
                              c.onChange()(n, r, e),
                              B.some(!0))
        ...
        tf = function (n) {
            ...
            return Js.sketch({
                dom: {
                    tag: "div",
                    classes: [
                        Mi.resolve("slider-" + o.category + "-size-container"),
                        Mi.resolve("slider"),
                        Mi.resolve("slider-size-container"),
                    ],
                },
                onChange: function (n, e, t) {
                    var r;
                ...
                components: [
                    ...
                    Js.parts().thumb({
                        dom: ms('<div class="${prefix}-slider-thumb"></div>'),
                        behaviours: qr([
                            ki.config({
                                toggleClass: Mi.resolve("thumb-active"),
                            }),
        ...
        of = function (n) {
            var e,
                ...
                u =
                    ...
                    (t = o),
                    (be.isElement(t) ? B.some(t) : $e.parent(t))
                        .map(function (n) {
                            return Do.closest(
                                n,
                                function (n) {
        ...
        uf = {
            ...
            apply: function (r, n) {
                ...
                ((e = n), B.from(rf[e])).each(function (n) {
                    var e, t;
                    ((t = n),
                        of((e = r)) !== t && e.execCommand("fontSize", !1, t));
                });
            },
        },
        af = uf.candidates(),
                    ...
                    t(
                        0 === this.status
                            ? (((n = new Error(
                              ...
                              n)
                            : new Error(
                                  "Error " + e.status + " downloading image",
                              ),
                    );
                }),
                e.send());
    ...
    function wf(n) {
        ...
        for (
            ...
            for (
                ...
                v[h] = c[p].charCodeAt(0);
            l[d] = ((r = v), new (Ie.getOrDie("Uint8Array"))(r));
        }
        return B.some(
            ((o = l), (i = { type: u }), new (Ie.getOrDie("Blob"))(o, i)),
        );
    }
    function xf(t) {
        return new vf(function (n, e) {
    ...
    var Sf,
            ...
            blobToCanvas: function (n) {
                return bf(n).then(function (n) {
                    ...
                    return (
                        ...
                        (t = mf.create(gf.getWidth(n), gf.getHeight(n))),
                        mf.get2dContext(t).drawImage(n, 0, 0),
                        t
                    );
                });
            },
            ...
            var e = sf({
                ...
                events: br([
                    ...
                    wr(X(), function (n, e) {
                        ...
                        (r = t.event()),
                        (o =
                            r.raw().target.files || r.raw().dataTransfer.files),
                        B.from(o[0])).each(function (n) {
                            var o, i;
                            ((o = u),
                                If((i = n)).then(function (r) {
        ...
        Lf = {
            ...
            applyInfo: function (o, i) {
                i.url.filter(Vf).fold(
                    function () {
                        var e;
                        ((e = o),
                            i.link.bind(h).each(function (n) {
                    ...
                    function (t) {
                        var n,
                            ...
                            r =
                                ((n = i),
                                ((e = {}).href = t),
                                n.title.filter(Vf).each(function (n) {
                                    e.title = n;
                                }),
        ...
        Gf = [ur("find")],
        qf = Xr({ fields: Gf, name: "composing", apis: $f }),
        Yf = as({
            name: "Container",
            factory: function (n) {
                return {
        ...
        el = Object.freeze({
            exhibit: function (n, e) {
                return Nr({
                    attributes: Dt([{ key: e.tabAttr(), value: "true" }]),
                });
            },
        }),
        tl = [mr("tabAttr", "data-alloy-tabstop")],
        rl = Xr({ fields: tl, name: "tabstopping", active: el }),
        ol = function (n, e) {
            var t = sf(
                    nl.sketch({
                        placeholder: e,
            ...
            return {
                name: n,
                spec: Yf.sketch({
                    dom: ms('<div class="${prefix}-input-container"></div>'),
                    components: [t.asSpec(), r.asSpec()],
                    containerBehaviours: qr([
                        ki.config({
        ...
        ml = function (n) {
            return al(n)
                ? ro.has(n.element(), "disabled")
                : "true" === ro.get(n.element(), "aria-disabled");
        },
        gl = Object.freeze({
        ...
        hl = Xr({ fields: pl, name: "disabling", active: vl, apis: gl }),
        ...
        El = function (n) {
            var r = "navigateEvent",
                e = _t([
                    ur("fields"),
                    mr("maxFieldIndex", n.fields.length - 1),
                    ur("onExecute"),
                    ur("getInitialValue"),
                    vr("state", function () {
                        return { dialogSwipeState: Sl(), currentScreen: So(0) };
                    }),
                ]),
                ...
                i = function (n, o) {
                    var i = nu(
                        n.element(),
                        "." + Mi.resolve("serialised-dialog-screen"),
                    );
                    ou(
                        n.element(),
                        "." + Mi.resolve("serialised-dialog-chain"),
                    ).each(function (r) {
                        0 <= u.state.currentScreen.get() + o &&
                            u.state.currentScreen.get() + o < i.length &&
                            (_i.getRaw(r, "left").each(function (n) {
                                var e = parseInt(n, 10),
                                    t = Xs(i[0]);
                ...
                s = sf({
                    dom: ms('<div class="${prefix}-dot-container"></div>'),
                    behaviours: qr([
                        Eu.config({
            ...
            return {
                dom: ms('<div class="${prefix}-serializer-wrapper"></div>'),
                ...
                behaviours: qr([
                    ...
                    Wf("serializer-wrapper-events", [
                        wr(L(), function (n, e) {
                            var t = e.event();
                            u.state.dialogSwipeState.set(
                                Ol(t.touches[0].clientX),
                            );
                        }),
                        wr(U(), function (n, e) {
                            var t = e.event();
            ...
            return [
                {
                    ...
                    items: [
                        El({
                            fields: [
                                ol("url", "Type or paste URL"),
                                ol("text", "Link text"),
                                ol("title", "Link title"),
                                ol("target", "Link target"),
                                ((n = "link"),
                                {
                                    name: n,
                                    spec: Xf.sketch({
        ...
        Rl = br([
            ...
            { key: Sf, value: pr({ can: Of }) }),
        ]),
        Ml = Object.freeze({ events: Rl }),
        Il = h,
        Nl = Wr([
            "debugInfo",
            "triggerFocus",
        ...
        jl = function (n, e) {
            return (
                (t = l.apply(undefined, [n.handler].concat(e))),
                (r = n.purpose()),
                { cHandler: t, purpose: E(r) }
            );
            var t, r;
        },
        Ll = function (n) {
        ...
        _l = function (n) {
            var e,
                i = w((e = n)) ? { can: E(!0), abort: E(!1), run: e } : e;
            return function (n, e) {
        ...
        $l = function (n, i) {
            var e = j(n, function (r, o) {
                return (
                    1 === r.length ? at.value(r[0].handler()) : Wl(r, i, o)
                ).map(function (n) {
                    var e = _l(n),
                        t =
                            1 < r.length
                                ...
                                : r[0].name();
                    return Et(o, { handler: e, purpose: E(t) });
                });
            });
            return At(e, {});
        },
            ...
            return Qt(
                ...
                Pt([
                    ...
                    qt(
                        ...
                        st.mergeWithThunk(E(e))),
                        or(),
                    ),
                    fr("domModification"),
                    di("originalSpec"),
                    mr("debug.sketcher", "unknown"),
                ]),
                n,
            );
            var e;
        ...
        Jl = function (n) {
            ...
            (ro.setAll(e, n.attributes().getOr({})),
                Yl(e, n.classes().getOr([])),
                _i.setAll(e, n.styles().getOr({})),
                _o(e, n.innerHtml().getOr("")));
            var t = Kl(n);
            return (
                Ke(e, t),
        ...
        Zl = function (n, e) {
            return (
                ...
                (i = Qt("component.behaviours", _t(o), t.behaviours).fold(
                    function (n) {
                        throw new Error(
                            tr(n) + "\nComplete spec:\n" + Bt(t, null, 2),
                        );
                ...
                c = (function (e, n, t, r) {
                    ...
                    t,
                    {
                        "alloy.base.modification":
                            ((r = n),
                            r.domModification().fold(function () {
                                return Nr({});
                            }, Nr)),
                    },
                    e,
            ...
            return (
                ...
                (u = C(
                    ...
                    i
                        ...
                        .getOr({}),
                    Br("domChildren", i.domChildren(), o.domChildren()),
                    Br("defChildren", i.defChildren(), o.defChildren()),
                    i
                        .value()
                        .or(o.value())
                        .map(function (n) {
        ...
        rd = function (n, e, t) {
            var r,
                ...
                a,
                c,
                s = { "alloy.base.behaviour": ((r = n), r.events()) };
            return ((o = t),
            (i = n.eventOrder()),
            (u = e),
            (a = s),
        ...
        od = function (n) {
            ...
            return at.value(
                ...
                (u = Zt(Gl(C(r, { behaviours: undefined })))),
                (a = nd(r)),
                (c = a.list),
                (s = a.data),
                (f = td(u, c, s)),
        ...
        fd = "alloy.item-focus",
        ld = function (n) {
            (Fo(n.element()).isNone() || Vi.isFocused(n)) &&
                (Vi.isFocused(n) || Vi.focus(n), ie(n, sd, { item: n }));
        },
        dd = function (n) {
            ie(n, fd, { item: n });
        },
        ...
        vd = [
            ...
            li("builder", function (n) {
                return {
                    ...
                    behaviours: C(
                        qr([
                            n.toggling().fold(ki.revoke, function (n) {
                                return ki.config(
                                    C({ aria: { mode: "checked" } }, n),
                                );
                            }),
                            Vi.config({
                    ...
                    behaviours: qr([
                        ...
                        uc.config({
                            ...
                            onEscape: function (n, e) {
                                return Vi.isFocused(n) || t.autofocus()
                                    ? (t.autofocus() &&
                                          e.setSource(n.element()),
                                      B.none())
                                    : (Vi.focus(n), B.some(!0));
                            },
                        }),
        ...
        yd = rr("type", { widget: bd, item: vd, separator: pd }),
        wd = E([
            Bc({
                factory: {
                    sketch: function (n) {
        ...
        Sd = cs({
            ...
            factory: function (n, e, t, r) {
                return C({
                    dom: C(n.dom(), { attributes: { role: "menu" } }),
                    uid: n.uid(),
                    behaviours: C(
                        qr([
                            Eu.config({
                            ...
                            qf.config({ find: B.some }),
                            uc.config(n.movement().config()(n, n.movement())),
                        ]),
                        cc(n.menuBehaviours()),
                    ),
                    events: br([
        ...
        Ed = Xr({ fields: [], name: "replacing", apis: kd }),
        Dd = function (t, r, o, n) {
            return kt(o, n)
                .bind(function (n) {
        ...
        Id = as({
            ...
            configFields: [
                ...
                si("onOpenSubmenu"),
                ai("onCollapseMenu"),
                mr("openImmediately", !0),
                sr("data", [ur("primary"), ur("menus"), ur("expansions")]),
                mr("fakeFocus", !1),
                ai("onHighlight"),
                ai("onHover"),
                sr("markers", [ur("backgroundMenu")].concat(ti()).concat(ri())),
                ur("dom"),
                mr("navigateOnHover", !0),
                mr("stayInDom", !1),
                ac("tmenuBehaviours", [uc, Eu, qf, Ed]),
                mr("eventOrder", {}),
            ],
            apis: {
            ...
            extraApis: {
                ...
                singleData: function (n, e) {
                    return { primary: n, menus: Et(n, e), expansions: {} };
                },
                collapseItem: function (n) {
                    return { value: bc(Md()), text: n };
                },
            },
        }),
        Nd = function (n, e, t, r) {
            return kt(e.routes(), r.start())
                .map(s)
                .bind(function (n) {
        ...
        Bd = function (n, e, t, r) {
            return Nd(0, e, 0, r).bind(function (e) {
                return e.transition().map(function (n) {
                    return { transition: E(n), route: E(e) };
                });
            });
        },
        Fd = function (t, r, n) {
            ...
            (o = r),
            (i = n),
            Vd(e, o, i).bind(function (n) {
                return Bd(e, o, i, n);
            })).each(function (n) {
                var e = n.transition();
                (bo.remove(t.element(), e.transitionClass()),
                    ro.remove(t.element(), r.destinationAttr()));
            });
        },
        Vd = function (n, e, t) {
            var r = n.element();
            return ro.has(r, e.destinationAttr())
                ? B.some({
        ...
        Hd = function (n, e, t, r) {
            (Fd(n, e, t),
                ro.has(n.element(), e.stateAttr()) &&
                    ro.get(n.element(), e.stateAttr()) !== r &&
                    e.onFinish()(n, r),
                ro.set(n.element(), e.stateAttr(), r));
        },
        zd = Object.freeze({
            findRoute: Nd,
            ...
            progressTo: function (t, r, o, i) {
                var n, e;
                ((e = r),
                    ro.has((n = t).element(), e.destinationAttr()) &&
                        (ro.set(
                            n.element(),
                            e.stateAttr(),
                            ro.get(n.element(), e.destinationAttr()),
                        ),
                        ro.remove(n.element(), e.destinationAttr())));
                var u,
                    a,
                    c =
                        ((u = r),
                ...
                Bd(t, r, o, c).fold(
                    ...
                    function (n) {
                        Fd(t, r, o);
                        var e = n.transition();
                        (bo.add(t.element(), e.transitionClass()),
                            ro.set(t.element(), r.destinationAttr(), i));
                    },
                );
            },
            getState: function (n, e, t) {
                var r = n.element();
                return ro.has(r, e.stateAttr())
                    ? B.some(ro.get(r, e.stateAttr()))
                    : B.none();
            },
        }),
        jd = Object.freeze({
        ...
        Ld = [
            mr("destinationAttr", "data-transitioning-destination"),
            mr("stateAttr", "data-transitioning-state"),
            ur("initialState"),
            ai("onTransition"),
            ai("onFinish"),
            ar(
                ...
                components: [
                    ...
                    }),
                    {
                        dom: {
                            tag: "div",
                            classes: [
                                Mi.resolve("styles-menu-items-container"),
                            ],
                        },
                        components: [Sd.parts().items({})],
                        behaviours: qr([
                            Wf("adhoc-scrollable-menu", [
                                Cr(function (n, e) {
                                    (_i.set(n.element(), "overflow-y", "auto"),
                                        _i.set(
                                            n.element(),
                                            "-webkit-overflow-scrolling",
                                            "touch",
                                        ),
                                        _d.register(n.element()));
                                }),
                                kr(function (n) {
                                    (_i.remove(n.element(), "overflow-y"),
                                        _i.remove(
                                            n.element(),
                                            "-webkit-overflow-scrolling",
                                        ),
                                        _d.deregister(n.element()));
                                }),
                            ]),
                        ]),
                    },
            ...
            var o,
                ...
                u =
                    ...
                    (n = Gd(
                        "Styles",
                        [].concat(
                            yn(o.items, function (n) {
                                return $d(
                                    Wd(n),
                                    n.title,
                                    n.isSelected(),
                                    n.getPreview(),
                                    Rt(o.expansions, Wd(n)),
                                );
                            }),
                        ),
                        i,
                ...
                a = sf(
                    Id.sketch({
                        ...
                        onOpenSubmenu: function (n, e, t) {
                            var r = Xs(n.element()),
                                o = ru(e.element(), '[role="menu"]').getOrDie(
                                    "hacky",
                                ),
                                i = n.getSystem().getByDom(o).getOrDie();
                            (Ys(t.element(), r),
                                Ud.progressTo(i, "before"),
                                Ud.jumpTo(t, "after"),
                                Ud.progressTo(t, "current"));
                        },
                        onCollapseMenu: function (n, e, t) {
                            var r = ru(e.element(), '[role="menu"]').getOrDie(
                                    "hacky",
                                ),
                                o = n.getSystem().getByDom(r).getOrDie();
                            (Ud.progressTo(o, "after"),
                                Ud.progressTo(t, "current"));
                        },
                        navigateOnHover: !1,
                        openImmediately: !0,
                ...
                s = function (n) {
                    return yn(n, function (n) {
                        if (Rt(n, "items")) {
                            var e = s(n.items);
                            return C(
                                C(n, { isSelected: E(!1), getPreview: E("") }),
                                { items: e },
                            );
                        }
                        return Rt(n, "format")
            ...
            return {
                ...
                styleselect: p(B.none(), function () {
                    return hs.forToolbar(
                        ...
                        function (n) {
                            (o.fire("toReading"),
                                r.dropup().appear(v, ki.on, n));
                        },
                        qr([
                            ki.config({
                                toggleClass: Mi.resolve(
                            ...
                            vi.config({
                                channels: Dt([
                                    Ai(jo.orientationChanged(), ki.off),
                                    Ai(jo.dropupDismissed(), ki.off),
                                ]),
                            }),
                        ]),
                    );
            ...
            var n = fe.fromDom(r),
                ...
                i = function (n) {
                    ...
                    o = setInterval(function () {
                        (e !== r.innerHeight
                            ? (clearInterval(o), n(B.some(r.innerHeight)))
                            : 20 < t && (clearInterval(o), n(B.none())),
                            t++);
                    }, 50);
                };
            return {
        ...
        xm = function (r, e, t) {
            var o = ym(r),
                ...
                n = function () {
                    var n =
                        r.doc().dom().hasFocus() && r.getSelection().exists(u);
                    t.getByDom(e).each(
                        !0 ===
                            (n ||
                                Bo(i)
                ...
                a = [
                    lm(r.body(), "touchstart", function (n) {
                    ...
                    !0 === wm
                        ? []
                        : [
                              lm(fe.fromDom(r.win()), "blur", function () {
                                  t.getByDom(e).each(ki.off);
                              }),
                              lm(i, "select", n),
                              lm(r.doc(), "selectionchange", n),
                          ],
                );
            return {
                destroy: function () {
            ...
            return Um(l, n).match({
                ...
                rtl: function (n, e, t, r) {
                    ...
                    if (s.setBaseAndExtent)
                        s.setBaseAndExtent(n.dom(), e, t.dom(), r);
                    else if (s.extend)
                        try {
                            ((i = n),
                                (u = e),
        ...
        Xm = function (n) {
            ...
            return Nm(e, n.anchorOffset, t, n.focusOffset)
                ? B.some(
                      Mm.range(
                          fe.fromDom(n.anchorNode),
                          n.anchorOffset,
                          fe.fromDom(n.focusNode),
                          n.focusOffset,
                      ),
                  )
                : (function (n) {
        ...
        cg = function (n) {
            return { top: E(n.top()), bottom: E(n.top() + n.height()) };
        },
        sg = function (n, e) {
            var t = Tm(e, ug),
                r = n.innerHeight;
            ...
            var e = fe.fromDom(u.document.body),
                t = lm(fe.fromDom(n), "resize", function () {
                    (sg(n, e).each(function (i) {
                        ...
                        ((n = u),
                        (e = og(n)),
                        0 < e.length ? B.some(e[0]).map(cg) : B.none()).each(
                            function (n) {
                                var e,
                                    t,
                                    r,
        ...
        Og = function (n, e) {
            var t,
                ...
                a =
                    ((t = e),
                    (r = _i.get(t, "background-color")) !== undefined &&
                    "" !== r
                        ? "background-color:" + r + "!important"
                        : "background-color:rgb(255,255,255)!important;");
            (wn(u, o("display:none!important;")),
                wn(i, o(xg + Tg + a)),
                o((!0 === Sg ? "" : xg) + Tg + a)(n));
        },
        Cg = function () {
            ...
            return {
                ...
                restore: function () {
                    t !== undefined && null !== t && 0 < t.length
                        ? ro.set(n, "content", t)
                        : ro.set(n, "content", "user-scalable=yes");
                },
            };
        },
        Eg = function (e, n) {
            ...
            return {
                enter: function () {
                    (n.hide(),
                        bo.add(e.container, Mi.resolve("fullscreen-maximized")),
                        bo.add(e.container, Mi.resolve("android-maximized")),
                        t.maximize(),
                        bo.add(e.body, Mi.resolve("android-scroll-reload")),
                        r.set(fg(e.win, yg.getWin(e.editor).getOrDie("no"))),
                        yg.getActiveApi(e.editor).each(function (n) {
                            (Og(e.container, n.body()),
                                o.set(xm(n, e.toolstrip, e.alloy)));
                        }));
                },
                exit: function () {
                    (t.restore(),
                        ...
                        bo.remove(
                            e.container,
                            Mi.resolve("fullscreen-maximized"),
                        ),
                        bo.remove(e.container, Mi.resolve("android-maximized")),
                        Cg(),
                        bo.remove(e.body, Mi.resolve("android-scroll-reload")),
                        o.clear(),
                        r.clear());
                },
            };
        ...
        Ag = function (n, e) {
            ...
            return Yf.sketch({
                dom: ms('<div class="${prefix}-disabled-mask"></div>'),
                components: [
                    Yf.sketch({
                        dom: ms(
        ...
        Rg = _t([
            sr("editor", [
                ...
                mr("onTouchContent", k),
                mr("onTapContent", k),
                mr("onTouchToolstrip", k),
                mr("onScrollToCursor", E({ unbind: k })),
                mr("onScrollToElement", E({ unbind: k })),
                mr("onToEditing", E({ unbind: k })),
                mr("onToReading", E({ unbind: k })),
                mr("onToolbarScrollStart", h),
            ]),
            ur("socket"),
            ur("toolstrip"),
            ur("dropup"),
        ...
        Ng = E([
            Nc({
                name: "groups",
                overrides: function (n) {
                    return { behaviours: qr([Ed.config({})]) };
                },
            }),
        ]),
        Bg = cs({
            ...
            factory: function (e, n, t, r) {
                var o = function (n) {
                    ...
                    i = e.shell()
                        ? { behaviours: [Ed.config({})], components: [] }
        ...
        Fg = E([
            ur("items"),
            ((Rf = ["itemClass"]), sr("markers", yn(Rf, ur))),
            ac("tgroupBehaviours", [uc]),
        ]),
        Vg = E([
            Bc({
                name: "items",
                ...
                overrides: function (n) {
                    return {
                        domModification: { classes: [n.markers().itemClass()] },
                    };
                },
            }),
        ]),
    ...
    function Ug() {
        var e = function (n) {
                ...
                return {
                    ...
                    components: [
                        Yf.sketch({ components: [Hg.parts().items({})] }),
                    ],
                    markers: { itemClass: Mi.resolve("toolbar-group-item") },
                    items: n.items,
                };
            },
            t = ad(
                Bg.sketch({
                    dom: ms('<div class="${prefix}-toolbar"></div>'),
                    components: [Bg.parts().groups({})],
                    toolbarBehaviours: qr([
                        ki.config({
                            toggleClass: Mi.resolve("context-toolbar"),
                            toggleOnExecute: !1,
                            aria: { mode: "none" },
                        }),
                        uc.config({ mode: "cyclic" }),
                    ]),
                    shell: !0,
                }),
            ),
            n = ad(
                Yf.sketch({
                    dom: { classes: [Mi.resolve("toolstrip")] },
                    components: [cd(t)],
                    containerBehaviours: qr([
                        ki.config({
                            toggleClass: Mi.resolve(
    ...
    var Pg = function (n, e) {
        ...
        $g = function () {
            return ad(
                Yf.sketch({
                    dom: ms('<div class="${prefix}-editor-socket"></div>'),
                    components: [],
        ...
        Jg = function (n, e) {
            (bo.remove(n.element(), e.openClass()),
                bo.add(n.element(), e.closedClass()),
                _i.set(n.element(), Yg(e), "0px"),
                _i.reflow(n.element()));
        },
        Qg = function (n, e) {
            (bo.remove(n.element(), e.closedClass()),
                bo.add(n.element(), e.openClass()),
                _i.remove(n.element(), Yg(e)));
        },
        Zg = function (n, e, t) {
            (t.setCollapsed(),
                _i.set(n.element(), Yg(e), Xg(e, n.element())),
                _i.reflow(n.element()));
            var r = qg(n, e);
        ...
        nv = function (n, e, t) {
            var r = (function (n, e) {
                ...
                o = qg(n, e);
            (bo.add(o, e.growingClass()),
                Qg(n, e),
                _i.set(n.element(), Yg(e), r),
                t.setExpanded(),
                e.onStartGrow()(n));
        },
        ev = function (n, e, t) {
        ...
        rv = Object.freeze({
            ...
            immediateShrink: function (n, e, t) {
                ...
                t.isExpanded() &&
                    ...
                    (o = e),
                    t.setCollapsed(),
                    _i.set(r.element(), Yg(o), Xg(o, r.element())),
                    _i.reflow(r.element()),
                    Kg(r, o),
                    Jg(r, o),
                    o.onStartShrink()(r),
        ...
        cv = function (e, t) {
            var r = ad(
                    Yf.sketch({
                        dom: { tag: "div", classes: [Mi.resolve("dropup")] },
                        components: [],
                        containerBehaviours: qr([
                            Ed.config({}),
                            av.config({
        ...
        lv = function (e, n) {
            var t,
                ...
                o,
                i,
                u = nr("Getting GUI events settings", fv, n),
                a = Wn.detect().deviceType.isTouch()
                ...
                f = lm(e, "keydown", function (n) {
                    ...
                    u.triggerEvent("keydown", n)
                        ...
                        : !0 !== u.stopBackspace ||
                          8 !== (e = n).raw().which ||
                          hn(["input", "textarea"], be.name(e.target())) ||
                          n.prevent();
                }),
                l =
                    ((t = e),
        ...
        mv = ct([{ stopped: [] }, { resume: ["element"] }, { complete: [] }]),
    ...
    var Sv = function (t) {
            var r = function (e) {
                    return $e.parent(t.element()).fold(
                        function () {
                            return !0;
                        },
                        function (n) {
                ...
                u = function (n) {
                    (be.isText(n.element()) ||
                        (wn(n.components(), u), o.unregister(n)),
                        n.disconnect());
                },
                a = function (n) {
                    et(t, n);
                ...
                l = function (n) {
                    f({ universal: E(!0), data: E(n) });
                },
                d = function (n, e) {
                    f({ universal: E(!1), channels: E(n), data: E(e) });
                },
                m = function (n) {
    ...
    var Ev = function (n, e) {
        ...
        np = function (r, o, i, u) {
            var n,
                ...
                f,
                l,
                d = $e.owner(r).dom().defaultView,
                m =
                    ((l = ro.get((f = i), "style")),
                    _i.setAll(f, { position: "absolute", top: "0px" }),
                    ro.set(f, Wv, "0px"),
                    ro.set(f, $v, "top"),
                    {
                        restore: function () {
                ...
                b =
                    ((e = ro.get((n = u), "style")),
                    _i.setAll(n, { position: "absolute", bottom: "0px" }),
                    ro.set(n, Wv, "0px"),
                    ro.set(n, $v, "bottom"),
                    {
                        restore: function () {
                ...
                x = function () {
                    if (y) {
                        var n = Yi(i),
                            ...
                            t = Qv(r, n, e);
                        (ro.set(r, Wv, n + "px"),
                            _i.set(r, "height", t + "px"),
                            _i.set(u, "bottom", -(n + t + e) + "px"),
                            Pv(o, r, u));
                    }
                };
            return (
        ...
        cp = function (o, i) {
            return Fv.nu(function (n) {
                ...
                tp.animate(
                    ...
                    r,
                    function (n, e) {
                        Tm(o, rp) !== o.dom().scrollTop
                            ? e(o.dom().scrollTop)
                            : ((o.dom().scrollTop = n), ro.set(o, rp, n));
                    },
                    function () {
        ...
        lp = function (n, e, t, r, o) {
            var i = Uv(e, t),
                u = l(Dv, n);
            i < r || i < o
                ? cp(e, e.dom().scrollTop - i + o).get(u)
                : r < 0 && cp(e, e.dom().scrollTop + r).get(u);
        },
        dp = function (u, n) {
            return n(function (r) {
                var o = [],
        ...
        vp = function (e, t, n, r, o, i) {
            ...
            return (gp(n, r.pageYOffset).get(h), { unbind: f.unbind });
        },
        pp = function (n) {
            var t = n.cWin(),
                e = n.ceBody(),
                ...
                d = vm(c, { onChange: k, onReady: f.refresh });
            ...
            var m = lm(fe.fromDom(c), "resize", function () {
                ...
                v = (function (t, e) {
                    var n = t.document,
                        r = fe.fromTag("div");
                    (bo.add(r, Mi.resolve("unfocused-selections")),
                        Ye.append(fe.fromDom(n.documentElement), r));
                    var o = lm(r, "touchstart", function (n) {
                        ...
                        i = function (n) {
                            ...
                            return (
                                Yl(e, [
                                    Mi.resolve("layer-editor"),
                                    Mi.resolve("unfocused-selection"),
                                ]),
                                _i.setAll(e, {
                                    left: n.left() + "px",
                                    top: n.top() + "px",
            ...
            return {
                enter: function () {
                    ...
                    yg.getActiveApi(r.editor).each(function (n) {
                        (i.set({
                            ...
                            Og(r.container, n.body()),
                            o.maximize(),
                            _i.set(r.socket, "overflow", "scroll"),
                            _i.set(
                                r.socket,
                                "-webkit-overflow-scrolling",
                                "touch",
                ...
                exit: function () {
                    (o.restore(),
                        ...
                        Cg(),
                        _d.deregister(r.toolbar),
                        _i.remove(r.socket, "overflow"),
                        _i.remove(r.socket, "-webkit-overflow-scrolling"),
                        No(r.editor.getFrame()),
                        yg.getActiveApi(r.editor).each(function (n) {
                            n.clearSelection();
                        }));
                },
        ...
        bp = function (n) {
            ...
            (_i.set(e.toolstrip, "width", "100%"),
                _i.set(e.container, "position", "relative"));
            var t = ad(
                Ag(function () {
        ...
        wp = function (n) {
            var e = kt(n.settings, "skin_url").fold(
                function () {
        ...
        Sp =
            (E(["x-small", "small", "medium", "large", "x-large"]),
            function (n) {
                var e = function () {
    ...
    Ho.add("mobile", function (C) {
        return {
            getNotificationManagerImpl: function () {
                return { open: h, close: k, reposition: k, getArgs: h };
            },
            renderUI: function (n) {
                var e = wp(C);
                0 == (!1 === C.settings.skin)
                    ? (C.contentCSS.push(e.content),
                      Vo.DOM.styleSheetLoader.load(e.ui, Sp(C)))
                    : Sp(C)();
                var t,
                    r,
                    o,
                    ...
                    b = Wn.detect().os.isAndroid()
                        ...
                        : ((t = p),
                          (r = kv({ classes: [Mi.resolve("ios-container")] })),
                          (o = Ug()),
                          (i = Tl()),
                          (u = Wg(i)),
                          (a = $g()),
                ...
                var w = n.targetNode.ownerDocument.defaultView,
                    ...
                    T = function (n, e, t, r) {
                        ...
                        var o = S(n, e, t);
                        (b.setToolbarGroups(!0 === r ? o.readOnly : o.main),
                            C.setMode(!0 === r ? "readonly" : "design"),
                            C.fire(!0 === r ? Op() : Cp()),
                            b.updateMode(r));
                    },
                    S = function (n, e, t) {
                ...
                return (
                    C.on("init", function () {
                        b.init({
                            editor: {
                                ...
                                onTapContent: function (n) {
                                    var e = n.target();
                                    "img" === be.name(e)
                                        ? (C.selection.select(e.dom()),
                                          n.kill())
                                        : "a" === be.name(e) &&
                                          b
                                              .system()
                                              .getByDom(
                                                  fe.fromDom(C.editorContainer),
                                              )
                                              .each(function (n) {
                        ...
                        var t = function () {
                            ...
                            c = So({ backToMask: [n], backToReadOnly: [e] });
                        Tp(b, C);
                    }),
                    {
