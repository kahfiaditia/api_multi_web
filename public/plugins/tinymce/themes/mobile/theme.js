    ...
    var mobile = (function () {
        ...
        var detectBrowser = function (browsers, userAgent) {
            return detect$1(browsers, userAgent).map(function (browser) {
                var version = $_eyxxbpy7jkmcdz22.detect(
        ...
        var detect$2 = function (userAgent) {
            ...
            var browser = $_67arvyyajkmcdz2a
                .detectBrowser(browsers, userAgent)
                .fold($_78skb5y6jkmcdz1z.unknown, $_78skb5y6jkmcdz1z.nu);
            var os = $_67arvyyajkmcdz2a
                .detectOs(oses, userAgent)
                .fold($_a0tyf1y8jkmcdz23.unknown, $_a0tyf1y8jkmcdz23.nu);
        ...
        var tap = alloy.tap;
        var tapOrClick = $_bbqs7by3jkmcdz1u.detect().deviceType.isTouch()
            ? alloy.tap
            : click;
        ...
        var dispatchWith = function (component, target, event, properties) {
            ...
            component
                .getSystem()
                .triggerEvent(event, target, map(data, constant));
        };
        ...
        var isComment = function (element) {
            return (
                type(element) === $_fk8ajhyljkmcdz42.COMMENT ||
        ...
        var inBody = function (element) {
            var dom = $_56giwmykjkmcdz41.isText(element)
        ...
        var all = function (selector, scope) {
            ...
            return bypassSelector(base)
                ? []
                : map$1(base.querySelectorAll(selector), Element$$1.fromDom);
        };
        ...
        var ieContains = function (e1, e2) {
            return $_2ktx3yyujkmcdz57.documentPositionContainedBy(
                e1.dom(),
                e2.dom(),
            );
        };
        ...
        var appendAt = function (parent, element, index) {
            $_g95izfynjkmcdz46.child(parent, index).fold(
                function () {
                    append(parent, element);
                },
                function (v) {
        ...
        var detach = function (component) {
            var parent = $_g95izfynjkmcdz46
                .parent(component.element())
                .bind(function (p) {
                    return component
                        .getSystem()
                        .getByDom(p)
                        .fold(Option.none, Option.some);
                });
            doDetach(component);
        ...
        var mergeValues = function (values, base) {
            return Result.value(
                deepMerge.apply(undefined, [base].concat(values)),
            );
        };
        ...
        var consolidateArr = function (objects) {
            ...
            return partitions.errors.length > 0
                ? mergeErrors(partitions.errors)
                : Result.value(partitions.values);
        };
        var ResultCombine = {
        ...
        var formatObj = function (input) {
            return isObject(input) && keys(input).length > 100
                ? " removed due to size"
                : $_7zqdedzhjkmcdz8o.stringify(input, null, 2);
        };
        ...
        var missingKey = function (path, key) {
            return nu$3(path, function () {
                return (
                    'Choice schema did not contain choice key: "' + key + '"'
                );
            });
        };
            ...
            return field.fold(
                function (key, okey, presence, prop) {
                    var bundle = function (av) {
                        return prop
                            .extract(path.concat([key]), strength, av)
                            .map(function (res) {
                    ...
                    var bundleAsOption = function (optValue) {
                        return optValue.fold(
                            ...
                            function (ov) {
                                return prop
                                    .extract(path.concat([key]), strength, ov)
                                    .map(function (res) {
                                        return wrap$1(
                                            okey,
                                            strength(Option.some(res)),
                                        );
                                    });
                            },
                        );
                    ...
                    return (function () {
                        return presence.fold(
                            function () {
                                return strictAccess(path, obj, key).bind(
                                    bundle,
                                );
                            },
                            ...
                            function () {
                                return optionAccess(obj, key).bind(
                                    bundleAsOption,
                                );
                            },
                            function (fallbackThunk) {
                                return optionDefaultedAccess(
                                    obj,
                                    key,
                                    fallbackThunk,
                                ).bind(bundleAsOption);
                            ...
                            function (baseThunk) {
                                ...
                                return fallbackAccess(obj, key, constant({}))
                                    .map(function (v) {
        ...
        var setOf = function (validator, prop) {
            var validateKeys = function (path, keys$$1) {
                return arrOf(value$2(validator)).extract(
                    path,
                    identity,
                    keys$$1,
                );
        ...
        var isSource = function (component, simulatedEvent) {
            return $_cmehu7ytjkmcdz4w.eq(
                component.element(),
                simulatedEvent.event().target(),
            );
        };
            ...
            if (
                ...
                throw new Error(
                    "EventHandler defined by: " +
                        $_7zqdedzhjkmcdz8o.stringify(parts, null, 2) +
        ...
        var create = function (schema, name, active, apis, extra, state) {
            ...
            var schemaSchema = optionObjOf(name, [
        ...
        var doCreate = function (
            ...
            var me = deepMerge(wrappedExtra, wrappedApis, {
                ...
                handlers: function (info) {
                    return getConfig(info)
                        .bind(function (behaviourInfo) {
                            return readOptFrom$1(active, "events").map(
                                function (events) {
                                    return events(
                                        behaviourInfo.config,
                                        behaviourInfo.state,
        ...
        var transfer = function (source, destination, attrs) {
            if (
                !$_56giwmykjkmcdz41.isElement(source) ||
                !$_56giwmykjkmcdz41.isElement(destination)
            )
                return;
        ...
        var remove$2 = function (element, attr, id) {
            ...
            if (nu.length > 0)
                $_e13lb0zwjkmcdzbt.set(element, attr, nu.join(" "));
            else $_e13lb0zwjkmcdzbt.remove(element, attr);
            return false;
        };
        ...
        var add$2 = function (element, clazz) {
            ...
            else $_3s58p7zxjkmcdzc2.add(element, clazz);
        };
        var cleanClass = function (element) {
            var classList = $_3s58p7zxjkmcdzc2.supports(element)
                ? element.dom().classList
                : $_3s58p7zxjkmcdzc2.get(element);
        ...
        var remove$4 = function (element, clazz) {
            ...
            } else $_3s58p7zxjkmcdzc2.remove(element, clazz);
            cleanClass(element);
        };
        var toggle$1 = function (element, clazz) {
            return $_3s58p7zxjkmcdzc2.supports(element)
                ? element.dom().classList.toggle(clazz)
                : $_3s58p7zxjkmcdzc2.toggle(element, clazz);
        };
        ...
        var has$1 = function (element, clazz) {
            return (
                $_3s58p7zxjkmcdzc2.supports(element) &&
        ...
        var focusInside = function (element) {
            ...
            var inside = active(doc).filter(function (a) {
                return $_a3lm22102jkmcdzco.closest(
                    a,
                    curry($_cmehu7ytjkmcdz4w.eq, element),
                );
            });
        ...
        var search = function (element) {
            return active($_g95izfynjkmcdz46.owner(element)).filter(
                function (e) {
        ...
        var debugging = true;
        var eventsMonitored = [];
        var path$1 = ["alloy/data/Fields", "alloy/debugging/Debugging"];
        ...
        var monitorEvent = function (eventName, initialTarget, f) {
            var logger =
                debugging &&
                (eventsMonitored === "*" ||
                    contains(eventsMonitored, eventName))
                    ? (function () {
                          var sequence = [];
                          return {
        ...
        var toggle$2 = function (component, toggleConfig, toggleState) {
            $_4fuxwizujkmcdzbq.toggle(
                component.element(),
                toggleConfig.toggleClass(),
            );
            updateAriaState(component, toggleConfig);
        };
        var on = function (component, toggleConfig, toggleState) {
            $_4fuxwizujkmcdzbq.add(
                component.element(),
                toggleConfig.toggleClass(),
            );
            updateAriaState(component, toggleConfig);
        ...
        var orientation = function (onReceive) {
            return Receiving.config({
                channels: wrap$2($_9ruxz5109jkmcdzdd.orientationChanged(), {
                    onReceive: onReceive,
                }),
            });
        };
        ...
        var events$2 = function (optAction) {
            ...
            var pointerEvents = $_bbqs7by3jkmcdz1u.detect().deviceType.isTouch()
                ? [run(tap(), onClick)]
                : [run(click(), onClick), run(mousedown(), onMousedown)];
            return derive(
                flatten([
        ...
        var events$3 = function (focusConfig) {
            return derive([
                run(focus$1(), function (component, simulatedEvent) {
        ...
        var FocusSchema = [onHandler("onFocus"), defaulted$1("ignore", false)];
        ...
        var get$3 = function (element, property) {
            ...
            var v =
                r === "" && !$_4lv9rgyhjkmcdz3f.inBody(element)
                    ? getUnsafeProperty(dom, property)
                    : r;
            return v === null ? undefined : v;
        };
        var getUnsafeProperty = function (dom, property) {
            return $_enqf9b117jkmcdzjq.isSupported(dom)
        ...
        var remove$5 = function (element, property) {
            ...
            if (
                $_e13lb0zwjkmcdzbt.has(element, "style") &&
                trim($_e13lb0zwjkmcdzbt.get(element, "style")) === ""
            ) {
        ...
        var copy$1 = function (source, target) {
            ...
            if (
                $_enqf9b117jkmcdzjq.isSupported(sourceDom) &&
                $_enqf9b117jkmcdzjq.isSupported(targetDom)
            ) {
        ...
        var api = Dimension("height", function (element) {
            var dom = element.dom();
            return $_4lv9rgyhjkmcdz3f.inBody(element)
        ...
        var ancestors$1 = function (scope, selector, isRoot) {
            return $_ez61pt11ajkmcdzjz.ancestors(
                scope,
                function (e) {
        ...
        var ancestor$2 = function (scope, selector, isRoot) {
            return $_ckn3j7103jkmcdzcp.ancestor(
                scope,
                function (e) {
                    return $_wim17yyjkmcdz5d.is(e, selector);
                },
        ...
        var dehighlightAll = function (component, hConfig, hState) {
            var highlighted = $_7y8imv119jkmcdzjy.descendants(
                component.element(),
        ...
        var highlightBy = function (component, hConfig, hState, predicate) {
            var items = $_7y8imv119jkmcdzjy.descendants(
                component.element(),
                "." + hConfig.itemClass(),
            );
            var itemComps = cat(
        ...
        var getHighlighted = function (component, hConfig, hState) {
            return $_7zr14e11bjkmcdzk4
                .descendant(component.element(), "." + hConfig.highlightClass())
                .bind(function (e) {
        ...
        var getFirst = function (component, hConfig, hState) {
            return $_7zr14e11bjkmcdzk4
                .descendant(component.element(), "." + hConfig.itemClass())
                .bind(function (e) {
                    return component.getSystem().getByDom(e).toOption();
                });
        };
        ...
        var dom = function () {
            ...
            var set = function (component, focusee) {
                component
                    .getSystem()
                    .triggerFocus(focusee, component.element());
            };
            return {
                get: get,
                set: set,
        ...
        var typical = function (
            ...
            var toEvents = function (keyingConfig, keyingState) {
                ...
                var keyEvents = derive(
                    optFocusIn
                        .map(function (focusIn) {
                            return run(
                                focus$1(),
        ...
        var create$2 = function (cyclicField) {
            ...
            var findInitial = function (component, tabbingConfig) {
                var tabstops = $_7y8imv119jkmcdzjy.descendants(
                    component.element(),
            ...
            var findCurrent = function (component, tabbingConfig) {
                return tabbingConfig
                    .focusManager()
                    .get(component)
                    .bind(function (elem) {
                        return $_7zr14e11bjkmcdzk4.closest(
                            elem,
                            tabbingConfig.selector(),
                        );
                    });
            ...
            var go = function (
                ...
                return findCurrent(component, tabbingConfig).bind(
                    function (tabstop) {
                        var optStopIndex = findIndex(
                            tabstops,
                            curry($_cmehu7ytjkmcdz4w.eq, tabstop),
                        );
        ...
        var inside = function (target) {
            return (
                ($_56giwmykjkmcdz41.name(target) === "input" &&
                    $_e13lb0zwjkmcdzbt.get(target, "type") !== "radio") ||
                $_56giwmykjkmcdz41.name(target) === "textarea"
            );
        };
        ...
        var getDirection = function (element) {
            return $_9wr75b116jkmcdzjc.get(element, "direction") === "rtl"
                ? "rtl"
                : "ltr";
        };
        ...
        var locateIn = function (container, current, selector, filter$$1) {
            ...
            var candidates = $_7y8imv119jkmcdzjy.descendants(
                container,
                selector,
            );
        ...
        var cycleHorizontal = function (
            ...
            return withGrid(
                ...
                index,
                numCols,
                function (oldRow, oldColumn) {
                    var onLastRow = oldRow === numRows - 1;
                    var colsInRow = onLastRow
        ...
        var focusIn = function (component, gridConfig, gridState) {
            $_7zr14e11bjkmcdzk4
                .descendant(component.element(), gridConfig.selector())
                .each(function (first) {
        ...
        var getRules$2 = function (_component, _se, flowConfig, _flowState) {
            var westMovers = LEFT().concat(
                flowConfig.allowVertical() ? UP() : [],
            );
            var eastMovers = RIGHT().concat(
                flowConfig.allowVertical() ? DOWN() : [],
            );
            return [
                rule(
                    inSet(westMovers),
                    doMove$1(west(moveLeft$1, moveRight$1)),
                ),
                rule(
                    inSet(eastMovers),
                    doMove$1(east(moveLeft$1, moveRight$1)),
                ),
        ...
        var cycleHorizontal$1 = function (
            matrix,
            rowIndex,
            startCol,
            deltaCol,
        ...
        var focusIn$2 = function (component, matrixConfig) {
            var focused = matrixConfig
                .previousSelector()(component)
                .orThunk(function () {
                    var selectors = matrixConfig.selectors();
                    return $_7zr14e11bjkmcdzk4.descendant(
                        component.element(),
                        selectors.cell(),
                    );
                });
        ...
        var execute$4 = function (component, simulatedEvent, matrixConfig) {
            return $_5vk2eg101jkmcdzce
                .search(component.element())
                .bind(function (focused) {
                    return matrixConfig.execute()(
                        component,
                        simulatedEvent,
                        focused,
                    );
        ...
        var toMatrix = function (rows, matrixConfig) {
            return map$1(rows, function (row) {
                return $_7y8imv119jkmcdzjy.descendants(
                    row,
        ...
        var doMove$2 = function (ifCycle, ifMove) {
            return function (element, focused, matrixConfig) {
                ...
                return $_7zr14e11bjkmcdzk4
                    .closest(focused, matrixConfig.selectors().row())
                    .bind(function (inRow) {
                        var cellsInRow = $_7y8imv119jkmcdzjy.descendants(
                            inRow,
                            matrixConfig.selectors().cell(),
                        );
                        return findIndex$2(cellsInRow, focused).bind(
                            function (colIndex) {
                                var allRows = $_7y8imv119jkmcdzjy.descendants(
                                    element,
                                    matrixConfig.selectors().row(),
                                );
                                return findIndex$2(allRows, inRow).bind(
                                    function (rowIndex) {
                                        var matrix = toMatrix(
                                            allRows,
                                            matrixConfig,
        ...
        var focusIn$3 = function (component, menuConfig) {
            $_7zr14e11bjkmcdzk4
                .descendant(component.element(), menuConfig.selector())
                .each(function (first) {
                ...
                function () {
                    throw new Error(
                        "Unknown placeholder component: " +
                            ...
                            owner.getOr("none") +
                            "\nSpec: " +
                            $_7zqdedzhjkmcdz8o.stringify(compSpec, null, 2),
                    );
                },
                function (newSpec) {
        ...
        var combine = function (detail, data, partSpec, partValidated) {
            ...
            return deepMerge(
                ...
                { "debug.sketcher": wrap$2("part-" + data.name(), spec) },
            );
        };
            ...
            return bind(parts, function (part) {
                return part
                    ...
                    .map(function (data) {
                        return strictObjOf(
                            data.name(),
                            data.schema().concat([snapshot$1(original())]),
                        );
                    })
                    .toArray();
            });
        ...
        var makeApi = function (f) {
            return markAsSketchApi(function (component) {
                ...
                return f.apply(
                    undefined,
                    [spi].concat([component].concat(rest)),
                );
            }, f);
        };
        ...
        var read$2 = function (elem) {
            var id = $_56giwmykjkmcdz41.isElement(elem)
                ? $_e13lb0zwjkmcdzbt.get(elem, idAttr$1)
                : null;
        ...
        var single$1 = function (owner, schema, factory, spec) {
            ...
            return deepMerge(factory(detail, specWithUid), {
                "debug.sketcher": wrap$2(owner, spec),
            });
        };
        var composite = function (owner, schema, partTypes, factory, spec) {
            ...
            return deepMerge(
                factory(detail, components$$1, specWithUid, subs.externals()),
                { "debug.sketcher": wrap$2(owner, spec) },
            );
        };
        ...
        var factory = function (detail) {
            ...
            var optType = readOptFrom$1(detail.dom(), "attributes").bind(
                readOpt$1("type"),
            );
        ...
        var Button = single$2({
            ...
            configFields: [
                ...
                strict$1("dom"),
                defaulted$1("components", []),
                field$1("buttonBehaviours", [Focusing, Keying]),
                option("action"),
                option("role"),
        ...
        var fromHtml$2 = function (html) {
            ...
            var contents =
                children.length === 0
                    ? {}
                    : { innerHtml: $_8w4bo710fjkmcdzee.get(elem) };
            return deepMerge(
                {
        ...
        var dom$1 = function (rawHtml) {
            var html = supplant(rawHtml, {
                prefix: $_986n5110tjkmcdzha.prefix(),
            });
        ...
        var getToggleBehaviours = function (command) {
            return derive$2([
                Toggling.config({
                    toggleClass: $_986n5110tjkmcdzha.resolve(
        ...
        var findValueOfX = function (
            ...
            if (xValue < bounds.left) {
                ...
                var xOffset =
                    Math.min(bounds.right, Math.max(xValue, bounds.left)) -
                    bounds.left;
                var newValue = capValue(
                    (xOffset / bounds.width) * range + min,
                    min - 1,
                    max + 1,
                );
                var roundedValue = Math.round(newValue);
                return snapToGrid && newValue >= min && newValue <= max
                    ? snapValueOfX(bounds, newValue, min, max, step, snapStart)
                    : roundedValue;
            }
        };
            ...
            return optional({
                ...
                overrides: function (detail) {
                    var touchEvents = derive([
                        runActionExtra(touchstart(), action, [detail]),
                    ]);
        ...
        var SliderParts = [ledgePart, redgePart, thumbPart, spectrumPart];
        ...
        var onUnload = function (component, repConfig, repState) {
            repConfig
                .store()
                .manager()
                .onUnload(component, repConfig, repState);
        };
        ...
        var getValue = function (component, repConfig, repState) {
            return repConfig
                .store()
                .manager()
                .getValue(component, repConfig, repState);
        };
        ...
        var getValue$1 = function (component, repConfig, repState) {
            ...
            return readOptFrom$1(dataset$$1, key).fold(
                function () {
        ...
        var sketch$1 = function (detail, components$$1, spec, externals) {
            ...
            var getXOffset = function (slider, spectrumBounds, detail) {
                ...
                if (v < detail.min()) {
                    return getPart(slider, detail, "left-edge").fold(
                        function () {
                            return 0;
                        },
                        function (ledge) {
                    ...
                    return getPart(slider, detail, "right-edge").fold(
                        function () {
                    ...
                    return (
                        ((detail.value().get() - detail.min()) / range$$1) *
            ...
            var getXPos = function (slider) {
                ...
                var spectrumBounds = spectrum
                    .element()
                    .dom()
                    .getBoundingClientRect();
                var sliderBounds = slider
                    .element()
                    .dom()
                    .getBoundingClientRect();
            ...
            var changeValue = function (component, newValue) {
                ...
                if (
                    oldValue !== newValue ||
                    $_9wr75b116jkmcdzjc.getRaw(thumb.element(), "left").isNone()
                ) {
        ...
        var button = function (realm, clazz, makeItems) {
            return $_9m5cak10ujkmcdzhd.forToolbar(
                clazz,
                function () {
                    var items = makeItems();
        ...
        var makeSlider = function (spec$$1) {
            ...
            return Slider.sketch({
                ...
                components: [
                    ...
                    Slider.parts().spectrum({
                        ...
                        behaviours: derive$2([
                            Toggling.config({
                                toggleClass:
                                    $_986n5110tjkmcdzha.resolve("thumb-active"),
                            }),
                        ]),
                    }),
                ...
                sliderBehaviours: derive$2([
                    $_w9zo510sjkmcdzh5.orientation(Slider.refresh),
                ]),
            });
        };
        ...
        var sketch$3 = function (rawSpec) {
            ...
            return Slider.sketch({
                dom: {
                    tag: "div",
                    classes: [
                        $_986n5110tjkmcdzha.resolve(
                            "slider-" + spec$$1.category + "-size-container",
                        ),
        ...
        var getRawOrComputed = function (isRoot, rawStart) {
            var optStart = $_56giwmykjkmcdz41.isElement(rawStart)
                ? Option.some(rawStart)
                : $_g95izfynjkmcdz46.parent(rawStart);
            return optStart
                .map(function (start) {
                    var inline = $_ckn3j7103jkmcdzcp
                        .closest(
                            start,
                            function (elem) {
                                return $_9wr75b116jkmcdzjc
                                    .getRaw(elem, "font-size")
                                    .isSome();
                            },
                            isRoot,
                        )
                        .bind(function (elem) {
                            return $_9wr75b116jkmcdzjc.getRaw(
                                elem,
                                "font-size",
                            );
                        });
            ...
            function handle(deferred) {
                ...
                asap(function () {
                    var cb = me._state
                        ...
                        : deferred.onRejected;
                    if (cb === null) {
                        (me._state ? deferred.resolve : deferred.reject)(
                            me._value,
                        );
                        return;
                    }
            ...
            return new Promise(function (resolve, reject) {
                ...
                xhr.onerror = function () {
                    ...
                    var genericError = function () {
                        return new Error(
                            "Error " + _this.status + " downloading image",
                        );
                    };
        ...
        function blobToCanvas(blob) {
            return blobToImage(blob).then(function (image) {
                ...
                var context, canvas;
                canvas = $_2h939c139jkmcdzzk.create(
                    $_5z0w4s13ajkmcdzzl.getWidth(image),
                    $_5z0w4s13ajkmcdzzl.getHeight(image),
                );
        ...
        var applyInfo = function (editor, info) {
            info.url.filter(isNotEmpty).fold(
                function () {
        ...
        var DataField = single$2({
            ...
            configFields: [
                ...
                strict$1("dom"),
                strict$1("getInitialValue"),
                field$1("dataBehaviours", [Representing, Composing]),
            ],
        });
                    ...
                    Representing.config({
                        store: {
                            ...
                            setValue: function (input, data) {
                                var current = $_ga53yq13tjkmce02n.get(
                                    input.element(),
                                );
                                if (current !== data) {
                                    $_ga53yq13tjkmce02n.set(
                                        input.element(),
                                        data,
                                    );
                                }
        ...
        var hasNative = function (component) {
            return contains(
                nativeDisabled,
                $_56giwmykjkmcdz41.name(component.element()),
            );
        };
        ...
        var ariaIsDisabled = function (component) {
            return (
                $_e13lb0zwjkmcdzbt.get(component.element(), "aria-disabled") ===
                "true"
            );
        };
                        ...
                        Representing.config({
                            store: {
                                ...
                                getValue: function (form) {
                                    ...
                                    return map(
                                        optPs,
                                        function (optPThunk, pName) {
                                            return optPThunk()
                                                .bind(Composing.getCurrent)
        ...
        var complete = function (model) {
            if (model.points.length === 0) {
                ...
                var lastDirection =
                    model.points[model.points.length - 1].direction;
                return firstDirection === SWIPING_RIGHT &&
                    lastDirection === SWIPING_RIGHT
                    ? SWIPING_RIGHT
                    : firstDirection === SWIPING_LEFT &&
                        lastDirection === SWIPING_LEFT
                      ? SWIPING_LEFT
                      : SWIPING_NONE;
            }
        };
        ...
        var sketch$7 = function (rawSpec) {
            ...
            var navigationButton = function (
                ...
                return Button.sketch({
                    ...
                    buttonBehaviours: derive$2([
                        Disabling.config({
                            disableClass: $_986n5110tjkmcdzha.resolve(
                ...
                $_7zr14e11bjkmcdzk4
                    ...
                    .each(function (parent) {
                        $_9wr75b116jkmcdzjc.set(
                            parent,
                            "left",
                            -spec$$1.state.currentScreen.get() * message.width +
                                "px",
                        );
                    });
            };
            var navigate = function (dialog, direction) {
                var screens = $_7y8imv119jkmcdzjy.descendants(
                    dialog.element(),
                    "." +
                        $_986n5110tjkmcdzha.resolve("serialised-dialog-screen"),
                );
                $_7zr14e11bjkmcdzk4
                    .descendant(
                        dialog.element(),
            ...
            var focusInput = function (dialog) {
                var inputs = $_7y8imv119jkmcdzjy.descendants(
                    dialog.element(),
                    "input",
                );
                var optInput = Option.from(
            ...
            var memDots = record({
                ...
                behaviours: derive$2([
                    Highlighting.config({
                        highlightClass:
                            $_986n5110tjkmcdzha.resolve("dot-active"),
                    ...
                    config(wrapperAdhocEvents, [
                        ...
                        run(touchend(), function (wrapper) {
                            spec$$1.state.dialogSwipeState.on(function (state) {
                                ...
                                var direction =
                                    -1 * $_4hjoey144jkmce05a.complete(state);
                                navigate(dialog, direction);
                            });
                        }),
                    ]),
            ...
            return [
                {
                    ...
                    items: [
                        sketch$7({
                            ...
                            getInitialValue: function () {
                                return Option.some(
                                    $_2x0v8r13hjkmce000.getInfo(editor),
                                );
                            },
        ...
        var sketch$8 = function (realm, editor) {
            return $_9m5cak10ujkmcdzhd.forToolbarStateAction(
                editor,
                "link",
                "link",
                function () {
        ...
        var isRecursive = function (component, originator, target) {
            return (
                $_cmehu7ytjkmcdz4w.eq(originator, component.element()) &&
                !$_cmehu7ytjkmcdz4w.eq(originator, target)
            );
        };
        var events$8 = derive([
            can(focus$1(), function (component, simulatedEvent) {
        ...
        var duplicate = function (aspect, k, obj, behaviours) {
            return Result.error(
                "Mulitple behaviours have tried to change the _" +
                    ...
                    ". The guilty behaviours are: " +
                    $_7zqdedzhjkmcdz8o.stringify(
                        bind(behaviours, function (b) {
                            return b.modification().getOr({})[k] !== undefined
                                ? [b.name()]
                                : [];
                        }),
                        null,
                ...
                function (acc, c) {
                    ...
                    return acc.bind(function (accRest) {
                        var parts = mapToArray(obj, function (v, k) {
                            return accRest[k] !== undefined
                                ? duplicate(aspect, k, obj, chain)
                                : Result.value(wrap$2(k, v));
                        });
        ...
        var combine$1 = function (info, baseMod, behaviours, base) {
            ...
            each$1(behaviours, function (behaviour) {
                modsByBehaviour[behaviour.name()] = behaviour.exhibit(
                    info,
                    base,
                );
            });
            ...
            var modifications = mapToArray(
                usedAspect,
                function (values$$1, aspect) {
                    return readOptFrom$1(mergeTypes, aspect).fold(
                        function () {
                            return Result.error(
                                "Unknown field type: " + aspect,
                            );
                        },
                        function (merger) {
                    ...
                    if (aIndex === -1) {
                        throw new Error(
                            "The ordering for " +
                                ...
                                aKey +
                                ".\nOrder specified: " +
                                $_7zqdedzhjkmcdz8o.stringify(order, null, 2),
                        );
                    }
                    if (bIndex === -1) {
                        throw new Error(
        ...
        var getChildren = function (definition) {
            if (
                definition.domChildren().isSome() &&
                definition.defChildren().isSome()
            ) {
                throw new Error(
        ...
        var renderToDom = function (definition) {
            ...
            $_e13lb0zwjkmcdzbt.setAll(
                subject,
                definition.attributes().getOr({}),
            );
        ...
        var getDomDefinition = function (info, bList, bData) {
            ...
            var baseModification = {
                "alloy.base.modification": toModification(info),
            };
            var modification = combine$1(
                bData,
                baseModification,
                bList,
                definition,
        ...
        var build = function (spec) {
            ...
            var info = getOrDie$1(
                toInfo(deepMerge(spec, { behaviours: undefined })),
            );
            ...
            var config = function (behaviour) {
                if (behaviour === apiConfig()) {
                    ...
                    throw new Error(
                        "Invalid input: only API constant is allowed",
                    );
                }
                var b = bData;
        ...
        var buildFromSpec = function (userSpec) {
            ...
            var completeSpec = deepMerge(
                DefaultEvents,
                spec,
                wrap$2("components", components),
            );
        ...
        var onHover = function (item) {
            if (
                $_5vk2eg101jkmcdzce.search(item.element()).isNone() ||
                Focusing.isFocused(item)
            ) {
            ...
            return {
                ...
                behaviours: deepMerge(
                    derive$2([
                        detail
                            .toggling()
                            .fold(Toggling.revoke, function (tConfig) {
        ...
        var preserve$2 = function (f, container) {
            ...
            var refocus = $_5vk2eg101jkmcdzce
                .active(ownerDoc)
                .bind(function (focused) {
                    ...
                    return hasFocus(container)
                        ...
                        : $_ckn3j7103jkmcdzcp.descendant(container, hasFocus);
                });
        ...
        var append$2 = function (
            ...
            insert(
                component,
                replaceConfig,
                $_3k9kbyymjkmcdz44.append,
                appendee,
            );
        };
        var prepend$2 = function (
            component,
            replaceConfig,
            replaceState,
            prependee,
            ...
            insert(
                component,
                replaceConfig,
                $_3k9kbyymjkmcdz44.prepend,
                prependee,
            );
        };
        var remove$7 = function (
            component,
            replaceConfig,
            replaceState,
            removee,
        ...
        var make$3 = function (detail, rawUiSpec) {
            ...
            var updateMenuPath = function (container, state, path) {
                return Option.from(path[0])
                    .bind(state.lookupMenu)
                    .map(function (activeMenu) {
                        ...
                        $_bxl9vl14mjkmce0bf.remove(activeMenu.element(), [
                            detail.markers().backgroundMenu(),
                        ]);
                        setActiveMenu(container, activeMenu);
                        var others = getMenus(state, state.otherMenus(path));
                        each$1(others, function (o) {
                            $_bxl9vl14mjkmce0bf.remove(o.element(), [
                                detail.markers().backgroundMenu(),
                            ]);
                            if (!detail.stayInDom()) {
            ...
            var expandRight = function (container, item) {
                ...
                return layeredState.expand(value).bind(function (path) {
                    Option.from(path[0])
                        .bind(layeredState.lookupMenu)
                        .each(function (activeMenu) {
                            if (
                                !$_4lv9rgyhjkmcdz3f.inBody(activeMenu.element())
                            ) {
                                Replacing.append(
                                    container,
            ...
            var collapseMenuApi = function (container) {
                Highlighting.getHighlighted(container).each(
                    function (currentMenu) {
                        Highlighting.getHighlighted(currentMenu).each(
        ...
        var findRoute = function (component, transConfig, transState, route) {
            return readOptFrom$1(transConfig.routes(), route.start())
                .map(apply)
                .bind(function (sConfig) {
                    return readOptFrom$1(sConfig, route.destination()).map(
                        apply,
                    );
                });
        };
        ...
        var getCurrentRoute = function (comp, transConfig, transState) {
            var el = comp.element();
            return $_e13lb0zwjkmcdzbt.has(el, transConfig.destinationAttr())
                ? Option.some({
                      start: constant(
                          $_e13lb0zwjkmcdzbt.get(
                              comp.element(),
        ...
        var getState = function (comp, transConfig, transState) {
            var e = comp.element();
            return $_e13lb0zwjkmcdzbt.has(e, transConfig.stateAttr())
                ? Option.some(
                      $_e13lb0zwjkmcdzbt.get(e, transConfig.stateAttr()),
                  )
                : Option.none();
        };
        ...
        var events$9 = function (transConfig, transState) {
            return derive([
                run(transitionend(), function (component, simulatedEvent) {
                    ...
                    getCurrentRoute(component, transConfig, transState).each(
                        function (route) {
                            findRoute(
                                component,
                                transConfig,
        ...
        var convert$1 = function (formats, memMenuThunk) {
            ...
            var tmenu = tieredMenu.tieredData(
                "styles",
                menus,
                formats.expansions,
            );
        ...
        var makeItem = function (value, text$$1, selected, preview, isMenu) {
            return {
                ...
                dom: {
                    tag: "div",
                    classes: isMenu
                        ? [$_986n5110tjkmcdzha.resolve("styles-item-is-menu")]
                        : [],
                },
                toggling: {
                    toggleOnExecute: false,
                ...
                components: [
                    Button.sketch({
                        dom: {
                            tag: "div",
                            classes: [
                                $_986n5110tjkmcdzha.resolve("styles-collapser"),
                            ],
                        },
                            ...
                            config("adhoc-scrollable-menu", [
                                runOnAttached(
                                    function (component, simulatedEvent) {
                                        ...
                                        $_6mujxu159jkmce0h3.register(
                                            component.element(),
                                        );
                                    },
                                ),
                                runOnDetached(function (component) {
                                    $_9wr75b116jkmcdzjc.remove(
                                        component.element(),
                                        "overflow-y",
                                    );
                                    $_9wr75b116jkmcdzjc.remove(
            ...
            var memMenu = record(
                tieredMenu.sketch({
                    ...
                    onOpenSubmenu: function (container, item, submenu) {
                        var w = $_1q71b5130jkmcdzxd.get(container.element());
                        var menu = $_7zr14e11bjkmcdzk4
                            .ancestor(item.element(), '[role="menu"]')
                            .getOrDie("hacky");
                    ...
                    onCollapseMenu: function (container, item, menu) {
                        var submenu = $_7zr14e11bjkmcdzk4
                            .ancestor(item.element(), '[role="menu"]')
                            .getOrDie("hacky");
        ...
        var getFromExpandingItem = function (item) {
            ...
            var newMenus = deepMerge(
                rest.menus,
                wrap$2(item.title, rest.items),
            );
            var newExpansions = deepMerge(
                rest.expansions,
                wrap$2(item.title, item.title),
            );
            return {
                item: newItem,
                menus: newMenus,
        ...
        var register$1 = function (editor, settings) {
            ...
            var formats = readOptFrom$1(settings, "style_formats").getOr(
                DefaultStyleFormats,
            );
        ...
        var setup = function (realm, editor) {
            ...
            var stateCommandSketch = function (name) {
                return function () {
                    return $_9m5cak10ujkmcdzhd.forToolbarStateCommand(
                        editor,
                        name,
                    );
                };
            ...
            var styleFormats = $_cdph2m145jkmce05c.register(
                editor,
                editor.settings,
            );
            var styleFormatsMenu = function () {
                return $_cdph2m145jkmce05c.ui(
                    editor,
                    styleFormats,
                    function () {
            ...
            var styleselect = function () {
                return $_9m5cak10ujkmcdzhd.forToolbar(
                    ...
                    derive$2([
                        ...
                        Receiving.config({
                            channels: wrapAll$1([
                                $_w9zo510sjkmcdzh5.receive(
                                    $_9ruxz5109jkmcdzdd.orientationChanged(),
                                    Toggling.off,
                                ),
                                $_w9zo510sjkmcdzh5.receive(
                                    $_9ruxz5109jkmcdzdd.dropupDismissed(),
                                    Toggling.off,
                                ),
                            ]),
                        }),
        ...
        var capture$1 = function (element, event, handler) {
            return $_a9yiw315djkmce0hv.capture(
                element,
                event,
                filter$1,
                handler,
        ...
        var get$11 = function (outerWindow) {
            var isPortrait = outerWindow.matchMedia(
        ...
        var onChange = function (outerWindow, listeners) {
            ...
            var orientationHandle = $_fcbg3215cjkmce0hs.bind(
                win,
                "orientationchange",
                change,
            );
        ...
        var monitor$1 = function (editorApi) {
            ...
            var onTouchend = function () {
                return $_fcbg3215cjkmce0hs.bind(
                    editorApi.body(),
                    "touchend",
                    function (evt) {
        ...
        var initEvents = function (editorApi, toolstrip, alloy) {
            ...
            var isRanged = function (sel) {
                return (
                    !$_cmehu7ytjkmcdz4w.eq(sel.start(), sel.finish()) ||
            ...
            var hasRangeInUi = function () {
                return $_5vk2eg101jkmcdzce
                    ...
                    .exists(function (input) {
                        return (
                            input.dom().selectionStart !==
                            input.dom().selectionEnd
                        );
                    });
            };
            ...
            var listeners = [
                ...
                isAndroid6 === true
                    ...
                    : [
                          $_fcbg3215cjkmce0hs.bind(
                              Element$$1.fromDom(editorApi.win()),
                              "blur",
                              function () {
        ...
        var safeParse = function (element, attribute) {
            var parsed = parseInt(
                $_e13lb0zwjkmcdzbt.get(element, attribute),
                10,
            );
        ...
        var getEnd = function (element) {
            return $_56giwmykjkmcdz41.name(element) === "img"
                ? 1
                : $_ccalr815pjkmce0kr.getOption(element).fold(
                      function () {
        ...
        var after$2 = function (start, soffset, finish, foffset) {
            var r = makeRange(start, soffset, finish, foffset);
            var same =
                $_cmehu7ytjkmcdz4w.eq(start, finish) && soffset === foffset;
        ...
        var getRanges = function (win, selection) {
            return selection.match({
                ...
                relative: function (startSitu, finishSitu) {
                    return {
                        ltr: cached(function () {
                            return $_5iuqwd15wjkmce0ll.relativeToNative(
                                win,
                                startSitu,
                                finishSitu,
                            );
                        ...
                        rtl: cached(function () {
                            return Option.some(
                                $_5iuqwd15wjkmce0ll.relativeToNative(
                                    win,
                                    finishSitu,
                                    startSitu,
                                ),
                ...
                exact: function (start, soffset, finish, foffset) {
                    return {
                        ltr: cached(function () {
                            return $_5iuqwd15wjkmce0ll.exactToNative(
                                win,
                                start,
                                soffset,
                                finish,
                        ...
                        rtl: cached(function () {
                            return Option.some(
                                $_5iuqwd15wjkmce0ll.exactToNative(
                                    win,
                                    finish,
                                    foffset,
                                    start,
        ...
        var locateOffset = function (doc, textnode, x, y, rect) {
            ...
            var offset = $_48bsnd160jkmce0mg.searchForPoint(
                rectForOffset,
                x,
                y,
                rect.right,
        ...
        var locate$1 = function (doc, node, x, y) {
            ...
            var foundRect = findMap(rects, function (rect) {
                return $_48bsnd160jkmce0mg.inRect(rect, x, y)
                    ? Option.some(rect)
                    : Option.none();
            });
        ...
        var searchInChildren = function (doc, node, x, y) {
            ...
            return findMap(nodes, function (n) {
                r.selectNode(n.dom());
                return $_48bsnd160jkmce0mg.inRect(
        ...
        var locateNode = function (doc, node, x, y) {
            var locator = $_56giwmykjkmcdz41.isText(node)
                ? $_brobdv161jkmce0mh.locate
                : searchInChildren;
        ...
        var first$3 = function (element) {
            return $_ckn3j7103jkmcdzcp.descendant(
                element,
                $_7e6z1m15ojkmce0kn.isCursorPosition,
            );
        };
        ...
        var locateInElement = function (doc, node, x) {
            ...
            var f =
                collapseDirection === COLLAPSE_TO_LEFT
                    ? $_1p3wst163jkmce0mr.first
                    : $_1p3wst163jkmce0mr.last;
        ...
        var search$1 = function (doc, node, x) {
            var f =
                $_g95izfynjkmcdz46.children(node).length === 0
                    ? locateInEmpty
                    : locateInElement;
            return f(doc, node, x);
        };
        ...
        var searchFromPoint = function (doc, x, y) {
            return Element$$1.fromPoint(doc, x, y).bind(function (elem) {
                ...
                return $_g95izfynjkmcdz46.children(elem).length === 0
                    ? fallback()
        ...
        var fromPoint$1 = function (win, x, y) {
            ...
            return availableSearch(doc, x, y).map(function (rng) {
                return $_2wmky115rjkmce0kx.range(
        ...
        var withinContainer = function (win, ancestor, outerRange, selector) {
            ...
            var self = $_wim17yyjkmcdz5d.is(ancestor, selector)
                ? [ancestor]
                : [];
            var elements = self.concat(
                $_7y8imv119jkmcdzjy.descendants(ancestor, selector),
            );
        ...
        var find$3 = function (win, selection, selector) {
            ...
            return $_56giwmykjkmcdz41.isElement(ancestor)
        ...
        var beforeSpecial = function (element, offset) {
            ...
            if ("input" === name) return $_4ygl9f15sjkmce0l3.after(element);
            else if (!contains(["br", "img"], name))
                return $_4ygl9f15sjkmce0l3.on(element, offset);
            else
                return offset === 0
                    ? $_4ygl9f15sjkmce0l3.before(element)
                    : $_4ygl9f15sjkmce0l3.after(element);
        };
        var preprocessRelative = function (startSitu, finishSitu) {
            var start = startSitu.fold(
                $_4ygl9f15sjkmce0l3.before,
                beforeSpecial,
                $_4ygl9f15sjkmce0l3.after,
            );
        ...
        var doSetRange = function (win, start, soffset, finish, foffset) {
            var rng = $_5iuqwd15wjkmce0ll.exactToNative(
                win,
                start,
                soffset,
                finish,
        ...
        var setExact = function (win, start, soffset, finish, foffset) {
            var relative = $_bz3qlp165jkmce0mz.preprocessExact(
                start,
                soffset,
                finish,
                foffset,
        ...
        var setRelative = function (win, startSitu, finishSitu) {
            var relative = $_bz3qlp165jkmce0mz.preprocessRelative(
                startSitu,
                finishSitu,
            );
            setRangeFromRelative(win, relative);
        ...
        var doGetExact = function (selection) {
            ...
            return $_7nue1915ujkmce0lf.after(
                anchorNode,
        ...
        var get$13 = function (win) {
            return getExact(win).map(function (range) {
                return $_2wmky115rjkmce0kx.exact(
                    range.start(),
                    range.soffset(),
                    range.finish(),
                    range.foffset(),
        ...
        var replace = function (win, selection, elements) {
            var rng = $_3xb84k15xjkmce0lu.asLtrRange(win, selection);
            var fragment = $_62nibg15vjkmce0lg.fromElements(
                elements,
                win.document,
            );
        ...
        var getRectsFromRange = function (range$$1) {
            if (!range$$1.collapsed) {
                ...
                return $_g95izfynjkmcdz46
                    .parent(start_1)
                    .bind(function (parent) {
                        var selection = $_2wmky115rjkmce0kx.exact(
                            start_1,
                            range$$1.startOffset,
                            parent,
                            $_7e6z1m15ojkmce0kn.getEnd(parent),
                        );
                        var optRect = $_cruk5m15tjkmce0l9.getFirstRect(
                            range$$1.startContainer.ownerDocument.defaultView,
                            selection,
                        );
        ...
        var setup$1 = function (outerWindow, cWin) {
            ...
            var onResize = $_fcbg3215cjkmce0hs.bind(
                Element$$1.fromDom(outerWindow),
                "resize",
                function () {
        ...
        var getBodyFromFrame = function (frame) {
            return Option.some(
                Element$$1.fromDom(frame.dom().contentWindow.document.body),
            );
        };
        var getDocFromFrame = function (frame) {
            return Option.some(
                Element$$1.fromDom(frame.dom().contentWindow.document),
            );
        };
        ...
        var clobberStyles = function (container, editorBody) {
            ...
            each$1(
                ancestors,
                clobber(ancestorPosition + ancestorStyles + bgColor),
            );
        ...
        var tag = function () {
            ...
            var element = $_7zr14e11bjkmcdzk4
                .first('meta[name="viewport"]')
                .getOrThunk(nu);
        ...
        var create$5 = function (platform, mask) {
            ...
            var enter = function () {
                ...
                $_4fuxwizujkmcdzbq.add(
                    platform.container,
                    $_986n5110tjkmcdzha.resolve("fullscreen-maximized"),
                );
                $_4fuxwizujkmcdzbq.add(
                    platform.container,
                    $_986n5110tjkmcdzha.resolve("android-maximized"),
                );
                meta.maximize();
                $_4fuxwizujkmcdzbq.add(
                    platform.body,
                    $_986n5110tjkmcdzha.resolve("android-scroll-reload"),
                );
                androidApi.set(
                    $_c2x5xx15ljkmce0jv.setup(
                        platform.win,
                        $_3yc5p5167jkmce0nf
                            .getWin(platform.editor)
                            .getOrDie("no"),
                    ),
                );
                $_3yc5p5167jkmce0nf
                    .getActiveApi(platform.editor)
                    .each(function (editorApi) {
                        $_8758b9168jkmce0nw.clobberStyles(
                            platform.container,
                            editorApi.body(),
                        );
                        androidEvents.set(
                            $_ysv1a15hjkmce0in.initEvents(
                                editorApi,
                                platform.toolstrip,
                                platform.alloy,
                            ),
        ...
        var produce = function (raw) {
            ...
            var mask = build$1(
                $_5vdbs216ajkmce0oe.sketch(onTap, mobile.translate),
            );
        ...
        var factory$4 = function (detail, components$$1, spec, _externals) {
            ...
            return {
                ...
                behaviours: deepMerge(
                    derive$2(extra.behaviours),
                    get$5(detail.toolbarBehaviours()),
                ),
        ...
        var dataHorizontal =
            "data-" + $_986n5110tjkmcdzha.resolve("horizontal-scroll");
        ...
        var hasVerticalScroll = function (container) {
            return (
                container.dom().scrollTop > 0 || canScrollVertically(container)
            );
        };
        ...
        var hasScroll = function (container) {
            return $_e13lb0zwjkmcdzbt.get(container, dataHorizontal) === "true"
        ...
        function ScrollingToolbar() {
            var makeGroup = function (gSpec) {
                ...
                return {
                                ...
                                ? [
                                      runOnInit(
                                          function (component, simulatedEvent) {
                                              ...
                                              $_7addse16ijkmce0qh.markAsHorizontal(
                                                  component.element(),
                                              );
                                              $_6mujxu159jkmce0h3.register(
                                                  component.element(),
                    ...
                    markers: {
                        itemClass:
                            $_986n5110tjkmcdzha.resolve("toolbar-group-item"),
                    },
                    items: gSpec.items,
                };
            };
            var toolbar = build$1(
                Toolbar.sketch({
                    ...
                    toolbarBehaviours: derive$2([
                        Toggling.config({
                            toggleClass:
                                $_986n5110tjkmcdzha.resolve("context-toolbar"),
                            toggleOnExecute: false,
                            aria: { mode: "none" },
                        }),
            ...
            var wrapper = build$1(
                Container.sketch({
                    dom: {
                        classes: [$_986n5110tjkmcdzha.resolve("toolstrip")],
                    },
        ...
        var isGrowing = function (component, slideConfig, slideState) {
            var root = getAnimationRoot(component, slideConfig);
            return (
                $_4fuxwizujkmcdzbq.has(root, slideConfig.growingClass()) ===
                true
            );
        };
        var isShrinking = function (component, slideConfig, slideState) {
            var root = getAnimationRoot(component, slideConfig);
            return (
                $_4fuxwizujkmcdzbq.has(root, slideConfig.shrinkingClass()) ===
                true
            );
        };
        ...
        var events$10 = function (slideConfig, slideState) {
            return derive([
                run(transitionend(), function (component, simulatedEvent) {
                    var raw = simulatedEvent.event().raw();
                    if (
                        raw.propertyName === slideConfig.dimension().property()
                    ) {
                        disableTransitions(component, slideConfig);
                        if (slideState.isExpanded()) {
                            $_9wr75b116jkmcdzjc.remove(
            ...
            var dropup = build$1(
                Container.sketch({
                    ...
                    containerBehaviours: derive$2([
                        ...
                        Sliding.config({
                            closedClass:
                                $_986n5110tjkmcdzha.resolve("dropup-closed"),
                            openClass:
                                $_986n5110tjkmcdzha.resolve("dropup-open"),
                            shrinkingClass:
                                $_986n5110tjkmcdzha.resolve("dropup-shrinking"),
                            growingClass:
                                $_986n5110tjkmcdzha.resolve("dropup-growing"),
        ...
        var setup$2 = function (container, rawSettings) {
            ...
            var onKeydown = $_fcbg3215cjkmce0hs.bind(
                container,
                "keydown",
                function (event$$1) {
            ...
            var onWindowScroll = $_fcbg3215cjkmce0hs.bind(
                defaultView,
                "scroll",
                function (event$$1) {
                    var stopped = settings.broadcastEvent(
                        windowScroll(),
                        event$$1,
                    );
                    if (stopped) {
        ...
        var derive$3 = function (rawEvent, rawTarget) {
            var source = readOptFrom$1(rawEvent, "target")
        ...
        var triggerUntilStopped = function (
            lookup,
            eventType,
            rawEvent,
            logger,
        ...
        var closest$3 = function (target, transform, isRoot) {
            var delegate = $_ckn3j7103jkmcdzcp.closest(
                target,
                function (elem) {
                ...
                if (conflict === component) {
                    ...
                    throw new Error(
                        'The tagId "' +
                            ...
                            ($_4lv9rgyhjkmcdz3f.inBody(conflict.element())
                                ? " "
                                : " not ") +
                            "already in the DOM",
                    );
        ...
        var takeover = function (root) {
            var isAboveRoot = function (el) {
                return $_g95izfynjkmcdz46.parent(root.element()).fold(
                    function () {
                        return true;
                    },
                    function (parent) {
        ...
        var READ_ONLY_MODE_CLASS = constant(
            $_986n5110tjkmcdzha.resolve("readonly-mode"),
        );
        var EDIT_MODE_CLASS = constant(
            $_986n5110tjkmcdzha.resolve("edit-mode"),
        );
        function OuterContainer(spec) {
            var root = build$1(
                Container.sketch({
                    dom: {
                        classes: [
                            $_986n5110tjkmcdzha.resolve("outer-container"),
                        ].concat(spec.classes),
                    },
                    containerBehaviours: derive$2([
                        Swapping.config({
        ...
        function AndroidRealm(scrollIntoView) {
            var alloy = OuterContainer({
                classes: [$_986n5110tjkmcdzha.resolve("android-container")],
            });
        ...
        var stubborn = function (outerBody, cWin, page, frame) {
            ...
            var captureInput = $_fcbg3215cjkmce0hs.bind(
                page,
                "keydown",
                function (evt) {
                    if (
        ...
        function FakeSelection(win, frame) {
            ...
            $_4fuxwizujkmcdzbq.add(
                container,
                $_986n5110tjkmcdzha.resolve("unfocused-selections"),
            );
            $_3k9kbyymjkmcdz44.append(
                Element$$1.fromDom(doc.documentElement),
                container,
            );
            var onTouch = $_fcbg3215cjkmce0hs.bind(
                container,
                "touchstart",
                function (event) {
                    event.prevent();
        ...
        var findDevice = function (deviceWidth, deviceHeight) {
            ...
            return findMap(devices, function (device) {
                return deviceWidth <= device.width &&
        ...
        var softKeyboardLimits = function (outerWindow) {
            return $_44bf7a17gjkmce0zz.findDevice(
                outerWindow.screen.width,
                outerWindow.screen.height,
            );
        };
        ...
        var getGreenzone = function (socket, dropup) {
            var outerWindow = $_g95izfynjkmcdz46
                .owner(socket)
                .dom().defaultView;
            var viewportHeight =
                $_e8k9z2115jkmcdzja.get(socket) +
                $_e8k9z2115jkmcdzja.get(dropup);
        ...
        var yFixedData =
            "data-" + $_986n5110tjkmcdzha.resolve("position-y-fixed");
        var yFixedProperty =
            "data-" + $_986n5110tjkmcdzha.resolve("y-property");
        var yScrollingData = "data-" + $_986n5110tjkmcdzha.resolve("scrolling");
        var windowSizeData =
            "data-" + $_986n5110tjkmcdzha.resolve("last-window-height");
        ...
        var classify = function (element) {
            ...
            var classifier =
                $_e13lb0zwjkmcdzbt.get(element, yScrollingData) === "true"
                    ? classifyScrolling
                    : classifyFixed;
        ...
        var deriveViewportHeight = function (
            viewport,
            toolbarHeight,
            dropupHeight,
        ) {
        ...
        var takeover$1 = function (viewport, contentBody, toolbar, dropup) {
            ...
            var dropupSetup = takeoverDropup(
                dropup,
                toolbarHeight,
                viewportHeight,
            );
            ...
            var refresh = function () {
                if (isActive) {
                    ...
                    $_9wr75b116jkmcdzjc.set(
                        dropup,
                        "bottom",
                        -(newToolbarHeight + newHeight + dropupHeight_1) + "px",
                    );
                    $_d4u8ik17fjkmce0zq.updatePadding(
                        contentBody,
                        viewport,
                        dropup,
                    );
        ...
        var lastScroll =
            "data-" + $_986n5110tjkmcdzha.resolve("last-scroll-top");
            ...
            return Future.nu(function (callback) {
                ...
                var update = function (newScroll) {
                    ...
                    $_9wr75b116jkmcdzjc.set(
                        element,
                        "top",
                        getTop(element) + ANIMATION_STEP + "px",
                    );
                };
                var finish = function () {
        ...
        var moveOnlyScroll = function (element, destination) {
            return Future.nu(function (callback) {
                ...
                var update = function (newScroll, abort) {
                    var previous = $_41tvdk15mjkmce0k7.safeParse(
                        element,
                        lastScroll,
                    );
        ...
        var updateTop = function (element, amount) {
            var newTop =
                amount + $_ciqepo17ejkmce0z7.getYFixedData(element) + "px";
        ...
        var scrollIntoView = function (cWin, socket, dropup, top, bottom) {
            ...
            if (top > greenzone || bottom > greenzone) {
                ...
                $_f3o083179jkmce0yo
                    .moveOnlyScroll(socket, socket.dom().scrollTop + top)
                    .get(refreshCursor);
            } else {
            }
        };
        ...
        var register$2 = function (
            ...
            var scroller = BackgroundActivity(function (y) {
                return $_f3o083179jkmce0yo.moveWindowScroll(
                    toolstrip,
                    socket,
                    y,
                );
            ...
            var scrollThrottle = last$3(function () {
                scroller.idle(function () {
                    $_flvhu217jjkmce10d
                        .updatePositions(container, outerWindow.pageYOffset)
                        .get(function () {
            ...
            var onScroll = $_fcbg3215cjkmce0hs.bind(
                Element$$1.fromDom(outerWindow),
                "scroll",
                function () {
        ...
        var setup$3 = function (bag) {
            ...
            var structure = $_ciqepo17ejkmce0z7.takeover(
                socket,
                ceBody,
                toolstrip,
                dropup,
            );
            var keyboardModel = keyboardType(
                bag.outerBody(),
                cWin,
                $_4lv9rgyhjkmcdz3f.body(),
                contentElement,
                toolstrip,
                toolbar,
            );
            ...
            var scrollIntoView = function (top, bottom) {
                $_d4f8o417ijkmce109.scrollIntoView(
                    cWin,
                    socket,
                    dropup,
                    top,
            ...
            var destroy = function () {
                ...
                $_biig3a173jkmce0wn.input(
                    $_4lv9rgyhjkmcdz3f.body(),
                    $_5vk2eg101jkmcdzce.blur,
                );
            };
            return {
                toEditing: toEditing,
        ...
        var create$8 = function (platform, mask) {
            ...
            var enter = function () {
                ...
                $_3yc5p5167jkmce0nf
                    ...
                    .each(function (editorApi) {
                        priorState.set({
                            socketHeight: $_9wr75b116jkmcdzjc.getRaw(
                                platform.socket,
                                "height",
                            ),
                            iframeHeight: $_9wr75b116jkmcdzjc.getRaw(
                                editorApi.frame(),
                                "height",
                            ),
                        ...
                        scrollEvents.set({
                            exclusives: $_7addse16ijkmce0qh.exclusive(
                                doc,
                                "." + $_6mujxu159jkmce0h3.scrollable(),
                            ),
                        });
                        $_4fuxwizujkmcdzbq.add(
                            platform.container,
        ...
        var produce$1 = function (raw) {
            ...
            var mask = build$1(
                $_5vdbs216ajkmce0oe.sketch(onView, mobile.translate),
            );
            mobile.alloy.add(mask);
            var maskApi = {
                show: function () {
        ...
        function IosRealm(scrollIntoView) {
            var alloy = OuterContainer({
                classes: [$_986n5110tjkmcdzha.resolve("ios-container")],
            });
            var toolbar = ScrollingToolbar();
            var webapp = api$2();
            var switchToEdit = $_fv9axv16jjkmce0qq.makeEditSwitch(webapp);
        ...
        global$1.add("mobile", function (editor) {
            var renderUI = function (args) {
                ...
                if (isSkinDisabled(editor) === false) {
                    ...
                    global.DOM.styleSheetLoader.load(
                        cssUrls.ui,
                ...
                var realm = $_bbqs7by3jkmcdz1u.detect().os.isAndroid()
                ...
                var orientation = $_czczjg15bjkmce0hf.onChange(outerWindow, {
                    onChange: function () {
                        ...
                        alloy.broadcastOn(
                            [$_9ruxz5109jkmcdzdd.orientationChanged()],
                            {
                                width: $_czczjg15bjkmce0hf.getActualWidth(
                                    outerWindow,
                                ),
                            },
                        );
                ...
                var configureToolbar = function (
                    ...
                    var toolbars = {
                        readOnly: dynamic.backToMask.concat(
                            readOnlyGroups.get(),
                        ),
                        main: dynamic.backToMask.concat(mainGroups.get()),
                    };
                    if (readOnlyOnInit(editor)) {
                        toolbars.readOnly = dynamic.backToMask.concat(
                            readOnlyGroups.get(),
                        );
                        toolbars.main = dynamic.backToReadOnly.concat(
                            mainGroups.get(),
                        );
                    }
                    return toolbars;
                ...
                editor.on("init", function () {
                    realm.init({
                        editor: {
                            ...
                            onTapContent: function (evt) {
                                ...
                                if ($_56giwmykjkmcdz41.name(target) === "img") {
                                    ...
                                    $_56giwmykjkmcdz41.name(target) === "a"
                                ) {
                                    var component = realm
                                        .system()
                                        .getByDom(
                        ...
                        toolstrip: Element$$1.fromDom(
                            editor.editorContainer.querySelector(
                                "." + $_986n5110tjkmcdzha.resolve("toolstrip"),
                            ),
                        ),
                        toolbar: Element$$1.fromDom(
                            editor.editorContainer.querySelector(
                                "." + $_986n5110tjkmcdzha.resolve("toolbar"),
                            ),
                        ),
                        dropup: realm.dropup(),
                        alloy: realm.system(),
                    ...
                    var items = $_bm7kuw10ajkmcdzdh.detect(
                        editor.settings,
                        features,
                    );
                    var actionGroup = {
