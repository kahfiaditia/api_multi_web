(function () {
    var link = (function () {
        ...
        var assumeExternalTargets = function (editorSettings) {
            return typeof editorSettings.link_assume_external_targets ===
                "boolean"
        ...
        var toggleTargetRules = function (rel, isUnsafe) {
            ...
            newRel = isUnsafe
                ? addTargetRules(newRel)
                : removeTargetRules(newRel);
        ...
        var isImageFigure = function (node) {
            return (
                ...
                /\bimage\b/i.test(node.className)
            );
        };
        var link = function (editor, attachState) {
            return function (data) {
                editor.undoManager.transact(function () {
                    ...
                    if (
                        !$_6v02umfvjkmcdvey.hasRelList(editor.settings) &&
                        $_6v02umfvjkmcdvey.allowUnsafeLinkTarget(
                            editor.settings,
                        ) === false
                    ) {
        ...
        var showDialog = function (editor, linkList) {
            ...
            onlyText = $_68cwlgg0jkmcdvff.isOnlyTextSelected(
                selection.getContent(),
            );
            anchorElm = $_68cwlgg0jkmcdvff.getAnchorElement(editor);
            data.text = initialText = $_68cwlgg0jkmcdvff.getAnchorText(
                editor.selection,
                anchorElm,
            );
            ...
            if (anchorElm) {
                ...
                $_6v02umfvjkmcdvey.hasDefaultLinkTarget(editor.settings)
            ) {
                data.target = $_6v02umfvjkmcdvey.getDefaultLinkTarget(
                    editor.settings,
                );
            }
            ...
            if ($_6v02umfvjkmcdvey.shouldShowTargetList(editor.settings)) {
                if (
                    $_6v02umfvjkmcdvey.getTargetList(editor.settings) ===
                    undefined
                ) {
            ...
            if ($_6v02umfvjkmcdvey.hasRelList(editor.settings)) {
                relListCtrl = {
                    ...
                    label: "Rel",
                    values: buildListItems(
                        $_6v02umfvjkmcdvey.getRelList(editor.settings),
                        function (item) {
                            if (
                                $_6v02umfvjkmcdvey.allowUnsafeLinkTarget(
                                    editor.settings,
                                ...
                                item.value =
                                    $_68cwlgg0jkmcdvff.toggleTargetRules(
                                        item.value,
                                        data.target === "_blank",
                                    );
                            }
            ...
            if ($_6v02umfvjkmcdvey.hasLinkClassList(editor.settings)) {
                classListCtrl = {
                    ...
                    label: "Class",
                    values: buildListItems(
                        $_6v02umfvjkmcdvey.getLinkClassList(editor.settings),
                        function (item) {
                            if (item.value) {
            ...
            win = editor.windowManager.open({
                ...
                onSubmit: function (e) {
                    var assumeExternalTargets =
                        $_6v02umfvjkmcdvey.assumeExternalTargets(
                            editor.settings,
                        );
                    var insertLink = $_68cwlgg0jkmcdvff.link(
                        editor,
                        attachState,
                    );
        ...
        var leftClickedOnAHref = function (editor) {
            return function (elm) {
                var sel, rng, node;
                if (
                    $_6v02umfvjkmcdvey.hasContextToolbar(editor.settings) &&
                    !isContextMenuVisible(editor) &&
                    $_68cwlgg0jkmcdvff.isLink(elm)
                ) {
        ...
        var toggleActiveState = function (editor) {
            return function () {
                ...
                editor.on("nodechange", function (e) {
                    self.active(
                        !editor.readonly &&
                            !!$_68cwlgg0jkmcdvff.getAnchorElement(
                                editor,
                                e.element,
                            ),
                    );
        ...
        var setup = function (editor) {
            editor.addShortcut(
                "Meta+K",
                "",
                $_dtnf6hftjkmcdvev.openDialog(editor),
            );
        };
        ...
        var setupContextToolbars = function (editor) {
            if (editor.addContextToolbar) {
                editor.addContextToolbar(
                    $_dtnf6hftjkmcdvev.leftClickedOnAHref(editor),
