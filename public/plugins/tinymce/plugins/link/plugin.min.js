!(function () {
    ...
    var t = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        ...
        a = function (t) {
            return (
                "boolean" == typeof t.link_context_toolbar &&
        ...
        s = function (t, e) {
            ...
            return (r = e ? ((n = a((n = r))).length ? n.concat(i) : i) : a(r))
                .length
        ...
        f = function (t, e) {
            return (
                ...
                m(e)
                    ? t.dom.select("a[href]", e)[0]
                    : t.dom.getParent(e, "a[href]")
            );
        },
        d = function (t) {
                    ...
                    body: [
                        {
                            ...
                            onchange: function (t) {
                                var e = t.meta || {};
                                (i &&
                                    i.value(a.convertURL(this.value(), "href")),
        ...
        $ = function (t, e) {
            if (e) {
                var n =
                    (i = e).getAttribute("data-mce-href") ||
                    i.getAttribute("href");
                if (/^#/.test(n)) {
                    var o = t.$(n);
        ...
        X = function (r) {
            return function (t) {
                ...
                return !!(
                    a(r.settings) &&
                    (!(i = r.plugins.contextmenu) ||
                        !i.isContextMenuVisible()) &&
                    h(t) &&
                    3 ===
                        (o = (n = (e = r.selection).getRng()).startContainer)
                            .nodeType &&
                    e.isCollapsed() &&
                    0 < n.startOffset &&
