    ...
    var codesample = (function () {
                        ...
                        for (var j = 0; j < patterns.length; ++j) {
                            ...
                            for (var i = 0; i < strarr.length; i++) {
                                ...
                                if (match) {
                                    ...
                                    var from =
                                        match.index - 1 + lookbehindLength;
            ...
            Prism.hooks.add("after-highlight", function (env) {
                ...
                for (var i = 0, t = void 0; (t = env.tokenStack[i]); i++) {
                    env.highlightedCode = env.highlightedCode.replace(
                        "{{{PHP" + (i + 1) + "}}}",
                        Prism.highlight(t, env.grammar, "php").replace(
                            /\$/g,
                            "$$$$",
                        ),
                    );
        ...
        var $_kizlnaajkmcduib = {
            open: function (editor) {
                ...
                var currentLanguage =
                    $_ekmkszahjkmcdujo.getCurrentLanguage(editor);
                ...
                editor.windowManager.open({
                    ...
                    onSubmit: function (e) {
                        $_6vo0q2adjkmcduie.insertCodeSample(
                            editor,
                            e.data.language,
                            e.data.code,
                        );
        ...
        var register = function (editor) {
            editor.addCommand("codesample", function () {
                ...
                if (
                    ...
                    $_btvhviagjkmcdujm.isCodeSample(node)
                ) {
        ...
        var setup = function (editor) {
            ...
            editor.on("PreProcess", function (e) {
                $("pre[contenteditable=false]", e.node)
                    .filter(
                        $_btvhviagjkmcdujm.trimArg(
                            $_btvhviagjkmcdujm.isCodeSample,
                        ),
                    )
