        ...
        c = (function () {
            var c = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
                S = (u.Prism = {
                    ...
                    highlightElement: function (e, t, a) {
                        for (var n, i, r = e; r && !c.test(r.className); )
                            r = r.parentNode;
                        (r &&
                            ((n = (r.className.match(c) || [, ""])[1]),
                            (i = S.languages[n])),
                            (e.className =
                                e.className
                                    .replace(c, "")
                        ...
                        if (s && i)
                            if (
                                (S.hooks.run("before-highlight", o),
                                t && u.Worker)
                            ) {
            ...
            if (
                ((o.stringify = function (t, a, e) {
                    ...
                    if (
                        ("comment" === n.type &&
                            (n.attributes.spellcheck = "true"),
                        t.alias)
                    ) {
                        var i =
                            "Array" === S.util.type(t.alias)
                                ? t.alias
                                : [t.alias];
    ...
    var g = {
            isCodeSample: function (e) {
                return (
                    e &&
                    "PRE" === e.nodeName &&
                    -1 !== e.className.indexOf("language-")
                );
            },
            trimArg: function (a) {
                return function (e, t) {
        ...
        w = function (e, t, a, n) {
            ...
            (e.inline && a.get()) ||
                ...
                !1 !== r &&
                    ...
                    e.getDoc().getElementsByTagName("head")[0].appendChild(i)));
        },
        x = function (e) {
