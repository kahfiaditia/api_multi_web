(function () {
    var fullpage = (function () {
        ...
        var htmlToData = function (editor, head) {
            ...
            if (elm) {
                data.langcode =
                    getAttr(elm, "lang") || getAttr(elm, "xml:lang");
            }
            data.stylesheets = [];
        ...
        var open = function (editor, headState) {
            ...
            editor.windowManager.open({
                ...
                onSubmit: function (e) {
                    var headHtml = $_5iey4vc3jkmcduub.dataToHtml(
                        editor,
                        global$1.extend(data, e.data),
                        headState.get(),
                    );
        ...
        var handleSetContent = function (editor, headState, footState, evt) {
            ...
            content = $_1tsu03c9jkmcduuq.protectHtml(
                editor.settings.protect,
                evt.content,
            );
            ...
            if (
                evt.source_view &&
                $_9uqi0uc7jkmcduuh.shouldHideInSourceView(editor)
            ) {
                return;
            }
            ...
            if (startPos !== -1) {
                ...
                evt.content = global$1.trim(
                    content.substring(startPos + 1, endPos),
                );
            ...
            var currentStyleSheetsMap = {};
            global$1.each(
                headElm.getElementsByTagName("link"),
                function (stylesheet) {
                    if (
        ...
        var handleGetContent = function (editor, head, foot, evt) {
            if (
                ...
                evt.content = $_1tsu03c9jkmcduuq.unprotectHtml(
                    global$1.trim(head) +
                        "\n" +
