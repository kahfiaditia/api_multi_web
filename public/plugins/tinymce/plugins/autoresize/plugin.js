    ...
    var autoresize = (function () {
        ...
        var setup = function (editor, oldSize) {
            editor.on("init", function () {
                ...
                var dom = editor.dom;
                overflowPadding =
                    $_2j3qei93jkmcdue9.getAutoResizeOverflowPadding(editor);
                bottomMargin =
                    $_2j3qei93jkmcdue9.getAutoResizeBottomMargin(editor);
            ...
            editor.on(
                "nodechange setcontent keyup FullscreenStateChanged",
                function (e) {
                    resize(editor, oldSize);
                },
            );
