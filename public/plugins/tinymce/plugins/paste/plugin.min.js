!(function () {
    ...
    function M(e) {
        ...
        function t(t, n, r) {
            ...
            (a !== s &&
                (a < s ? i && (i = i.parent.parent) : ((o = i), (i = null))),
                i && i.name === n
                    ? i.append(t)
                    : ((o = o || i),
                      (i = new k(n, 1)),
    ...
    var A = {
        ...
        J = function (o, s, l) {
            ...
            function t(e) {
                ...
                if (e)
                    for (t = 0; t < e.length; t++)
                        if (
                            ((n = e[t]),
                            /^image\/(jpeg|png|gif|bmp)$/.test(n.type))
                        ) {
                            var i = n.getAsFile ? n.getAsFile() : n;
                            (((r = new window.FileReader()).onload = Z.bind(
                                null,
                                o,
                                l,
                                r,
            ...
            if (o.settings.paste_data_images && e)
                return t(e.items) || t(e.files);
        },
        Q = function (e) {
            return (
                ...
                c.on("paste", function (e) {
                    ...
                    ((m = !1),
                        ...
                        -1 !== navigator.userAgent.indexOf("Android") &&
                            ...
                            ? f.remove()
                            : q(i) ||
                                !J(c, e, f.getLastRng() || c.selection.getRng())
                              ? (s || e.preventDefault(),
                                !v.ie ||
                                    (s && !e.ieFake) ||
                                    X(i, "text/html") ||
                    ...
                    return (function (n) {
                        ...
                        for (
                            e = b.grep(te(n).childNodes, function (e) {
                                ...
                                r =
                                    (a = n.dom.select("div[id=mcepastebin]", t))
                                        .length - 1;
                            0 <= r;
                            r--
                        )
                            ((i = n.dom.create("div")),
                                t.insertBefore(i, a[r]),
                                o(i, a[r]));
        ...
        ce = function (e, t, n, r) {
            ue(e.clipboardData, t.html, t.text)
                ? (e.preventDefault(), r())
                : n(t.html, r);
        },
        fe = function (s) {
