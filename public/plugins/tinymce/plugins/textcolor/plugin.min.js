        ...
        n = function (t, o) {
            ...
            return (
                t.dom.getParents(t.selection.getStart(), function (t) {
                    ...
                    (e =
                        t.style[
                            "forecolor" === o ? "color" : "background-color"
                        ]) && (r = e);
                }),
                r
            );
                ...
                (F.DOM.getParent(t.target, ".mce-custom-color-btn") &&
                    ...
                    y(r).call(
                        ...
                        function (t) {
                            ...
                            for (
                                e = i.map(
                                    n.rows[n.rows.length - 1].childNodes,
                                    function (t) {
                                        return t.firstChild;
                                    },
                                ),
                                    r = 0;
                                r < e.length &&
                                (o = e[r]).getAttribute("data-mce-color");
                                r++
                            );
                            if (r === c)
                                for (r = 0; r < c - 1; r++)
                                    k(
                                        e[r],
                                        e[r + 1].getAttribute("data-mce-color"),
                                    );
                            (k(o, t), l(t));
                        },
                        o,
                    ...
                    (e = t.target.getAttribute("data-mce-color"))
                        ? (this.lastId &&
                              F.DOM.get(this.lastId).setAttribute(
                                  "aria-selected",
                                  "false",
                              ),
