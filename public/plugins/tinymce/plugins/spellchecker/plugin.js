(function () {
    var spellchecker = (function () {
        ...
        function isContentEditableFalse(node) {
            return (
                node && node.nodeType === 1 && node.contentEditable === "false"
            );
        }
        var DomTextMatcher = function (node, editor) {
            ...
            function stepThroughMatches(node, matches, replaceFn) {
                ...
                out: while (true) {
                    ...
                    if (curNode.nodeType === 3) {
                        if (
                            !endNode &&
                            curNode.length + atIndex >= matchLocation.end
                        ) {
                            endNode = curNode;
                        ...
                        if (
                            !startNode &&
                            curNode.length + atIndex > matchLocation.start
                        ) {
                            startNode = curNode;
            ...
            function unwrap(match) {
                var i;
                var elements = getWrappersByIndex(
                    match ? indexOf(match) : null,
                );
                i = elements.length;
                while (i--) {
        ...
        var defaultSpellcheckCallback = function (
            ...
            return function (method, text, doneCallback, errorCallback) {
                ...
                global$3.send({
                    url: new global$2(pluginUrl).toAbsolute(
                        $_d3gbtwkbjkmcdvvb.getRpcUrl(editor),
                    ),
                    type: "post",
        ...
        var sendRpcCall = function (
            ...
            var userSpellcheckCallback =
                $_d3gbtwkbjkmcdvvb.getSpellcheckerCallback(editor);
            var spellCheckCallback = userSpellcheckCallback
                ? userSpellcheckCallback
                : defaultSpellcheckCallback(
                      editor,
                      pluginUrl,
                      currentLanguageState,
                  );
        ...
        var markErrors = function (
            ...
            getTextMatcher(editor, textMatcherState)
                .find($_d3gbtwkbjkmcdvvb.getSpellcheckerWordcharPattern(editor))
        ...
        var get = function (
            ...
            var getWordCharPattern = function () {
                return $_d3gbtwkbjkmcdvvb.getSpellcheckerWordcharPattern(
                    editor,
                );
            };
            var markErrors = function (data) {
                $_3gzed2kcjkmcdvvd.markErrors(
                    editor,
                    startedState,
                    textMatcherState,
                    lastSuggestionsState,
        ...
        var getItems = function (editor) {
            return global$1.map(
                $_d3gbtwkbjkmcdvvb.getLanguages(editor).split(","),
                function (langPair) {
        ...
        var register$1 = function (
            ...
            var languageMenuItems = buildMenuItems(
                "Language",
                getItems(editor),
            );
        ...
        var showSuggestions = function (
            ...
            var items = [],
                suggestions = lastSuggestionsState.get().suggestions[word];
            global$1.each(suggestions, function (suggestion) {
                items.push({
                    ...
                    onclick: function () {
                        ...
                        $_3gzed2kcjkmcdvvd.checkIfFinished(
                            editor,
                            startedState,
                            textMatcherState,
                        );
            ...
            var hasDictionarySupport =
                lastSuggestionsState.get().hasDictionarySupport;
            if (hasDictionarySupport) {
                items.push({
                    text: "Add to Dictionary",
                    onclick: function () {
                        $_3gzed2kcjkmcdvvd.addToDictionary(
                            editor,
                            pluginUrl,
                            startedState,
                            textMatcherState,
        ...
        var setup = function (
            ...
            editor.on("click", function (e) {
                ...
                if (target.className === "mce-spellchecker-word") {
                    e.preventDefault();
                    var spans = $_3gzed2kcjkmcdvvd.findSpansByIndex(
                        editor,
                        $_3gzed2kcjkmcdvvd.getElmIndex(target),
                    );
                    if (spans.length > 0) {
                        var rng = editor.dom.createRng();
        ...
        global.add("spellchecker", function (editor, pluginUrl) {
            if ($_20ys1ck8jkmcdvut.hasProPlugin(editor) === false) {
                ...
                var currentLanguageState = Cell(
                    $_d3gbtwkbjkmcdvvb.getLanguage(editor),
                );
                var textMatcherState = Cell(null);
                var lastSuggestionsState = Cell(null);
                $_d2te3ckjjkmcdvvs.register(
                    editor,
                    pluginUrl,
                    startedState,
                    textMatcherState,
