!(function () {
    ...
    var x,
        o = function (c, r) {
            ...
            function d(e) {
                var t = l(s(e)),
                    n = r.dom.createRng();
                return (
                    n.setStartBefore(t[0]),
                    n.setEndAfter(t[t.length - 1]),
                    n
                );
            }
            return (
                                ...
                                (function (e, t, n) {
                                    ...
                                    (function (o) {
                                        ...
                                        return function (e) {
                                            ...
                                            return (
                                                (r = o.parentNode).insertBefore(
                                                    t,
                                                    o,
                                                ),
                                                r.insertBefore(u, o),
                                                r.removeChild(o),
                                                (r = i.parentNode).insertBefore(
                                                    p,
                                                    i,
                                                ),
                                                r.insertBefore(n, i),
        ...
        S = function (e, t, n) {
            if ((N(e, n).reset(), n.set(null), t.get()))
                return (t.set(!1), r(e), !0);
        },
        w = function (e) {
        ...
        b = function (t, e, n, r, o) {
            ...
            if (
                ...
                return (
                    t.notificationManager.open({ text: a, type: "info" }),
                    void e.set(!1)
                );
            }
        ...
        T = {
            ...
            findSpansByIndex: function (e, t) {
                var n,
                    r = [];
                if (
                    (n = g.toArray(e.getBody().getElementsByTagName("span")))
                        .length
                )
