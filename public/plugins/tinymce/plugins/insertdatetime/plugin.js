    ...
    var insertdatetime = (function () {
        ...
        var register = function (editor) {
            editor.addCommand("mceInsertDate", function () {
                $_gb83b6fijkmcdvdw.insertDateTime(
                    editor,
                    $_geya0zfhjkmcdvdv.getDateFormat(editor),
                );
            });
            editor.addCommand("mceInsertTime", function () {
                $_gb83b6fijkmcdvdw.insertDateTime(
                    editor,
                    $_geya0zfhjkmcdvdv.getTimeFormat(editor),
                );
            });
        };
            ...
            editor.addButton("insertdatetime", {
                ...
                onclick: function () {
                    ...
                    $_gb83b6fijkmcdvdw.insertDateTime(
                        ...
                        lastFormat
                            ? lastFormat
                            : $_geya0zfhjkmcdvdv.getDefaultDateTime(editor),
                    );
                },
            });
