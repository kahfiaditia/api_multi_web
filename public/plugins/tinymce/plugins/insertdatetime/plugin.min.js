            ...
            return (
                ...
                (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t =
                    (t = (t = (t = t.replace("%D", "%m/%d/%Y")).replace(
                        ...
                        "%y",
                        "" + n.getYear(),
                    )).replace("%m", p(n.getMonth() + 1, 2))).replace(
                    "%d",
                    p(n.getDate(), 2),
                )).replace("%H", "" + p(n.getHours(), 2))).replace(
                    "%M",
                    "" + p(n.getMinutes(), 2),
                )).replace("%S", "" + p(n.getSeconds(), 2))).replace(
                    "%I",
                    "" + (((n.getHours() + 11) % 12) + 1),
                )).replace("%p", n.getHours() < 12 ? "AM" : "PM")).replace(
                    "%B",
                    "" + e.translate(d[n.getMonth()]),
                )).replace("%b", "" + e.translate(s[n.getMonth()]))).replace(
                    "%A",
                    "" + e.translate(l[n.getDay()]),
                )).replace("%a", "" + e.translate(c[n.getDay()]))).replace(
                    "%%",
                    "%",
                ))
            );
