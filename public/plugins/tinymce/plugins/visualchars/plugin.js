(function () {
    var visualchars = (function () {
        ...
        var isComment = function (element) {
            return (
                type(element) === $_5rg4s0t7jkmcdy4g.COMMENT ||
        ...
        var wrapCharWithSpan = function (value) {
            return (
                ...
                $_5gypflsyjkmcdy3d.charMap[value] +
                '">' +
                value +
                "</span>"
            );
        ...
        var isMatch = function (n) {
            return (
                $_56e4lwt6jkmcdy4f.isText(n) &&
                $_56e4lwt6jkmcdy4f.value(n) !== undefined &&
                $_5gypflsyjkmcdy3d.regExp.test($_56e4lwt6jkmcdy4f.value(n))
            );
        };
        ...
        var replaceWithSpans = function (html) {
            return html.replace(
                $_5gypflsyjkmcdy3d.regExpGlobal,
                $_12tebnt8jkmcdy4i.wrapCharWithSpan,
            );
        };
        ...
        var show = function (editor, rootElm) {
            var node, div;
            var nodeList = $_9rt6vkszjkmcdy3e.filterDescendants(
                Element$$1.fromDom(rootElm),
                $_9rt6vkszjkmcdy3e.isMatch,
            );
            each(nodeList, function (n) {
                var withSpans = $_9rt6vkszjkmcdy3e.replaceWithSpans(
                    $_56e4lwt6jkmcdy4f.value(n),
                );
        ...
        var toggle = function (editor) {
            ...
            var parentNode = $_9rt6vkszjkmcdy3e.findParentElm(
