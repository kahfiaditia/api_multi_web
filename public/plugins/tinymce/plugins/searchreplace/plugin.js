(function () {
    var searchreplace = (function () {
            ...
            function stepThroughMatches(node, matches, replaceFn) {
                ...
                out: while (true) {
                    ...
                    if (curNode.nodeType === 3) {
                        if (
                            !endNode &&
                            curNode.length + atIndex >= matchLocation[1]
                        ) {
                            endNode = curNode;
                        ...
                        if (
                            !startNode &&
                            curNode.length + atIndex > matchLocation[0]
                        ) {
                            startNode = curNode;
        ...
        var markAllMatches = function (editor, currentIndexState, regex) {
            ...
            return $_9t0itgk1jkmcdvtp.findAndReplaceDOMText(
                regex,
                node,
                marker,
                false,
        ...
        var find = function (
            ...
            if (count) {
                ...
                currentIndexState.set(
                    moveSelection(editor, currentIndexState, true),
                );
            }
            return count;
        };
        ...
        var hasNext = function (editor, currentIndexState) {
            return (
                findSpansByIndex(editor, currentIndexState.get() + 1).length > 0
            );
        };
        ...
        var get = function (editor, currentIndexState) {
            ...
            var replace = function (text, forward, all) {
                return $_evd66vjzjkmcdvtj.replace(
                    editor,
                    currentIndexState,
                    text,
                    forward,
        ...
        var register$1 = function (editor, currentIndexState) {
            ...
            editor.shortcuts.add(
                "Meta+F",
                "",
                showDialog(editor, currentIndexState),
            );
        };
