    ...
    var u = {
                            ...
                            (function (e, t, n) {
                                ...
                                (function (e) {
                                    ...
                                    return function (e) {
                                        ...
                                        var h = m(
                                            i.data.substring(0, e.endNodeIndex),
                                            o,
                                        );
                                        return (
                                            (r = a.parentNode).insertBefore(
                                                t,
                                                a,
                                            ),
                                            r.insertBefore(l, a),
        ...
        o = function (e, t) {
            var n,
                r = [];
            if (
                (n = p.toArray(e.getBody().getElementsByTagName("span"))).length
            )
            ...
            replace: function (e, t, n, r, a) {
                ...
                for (
                    r = !1 !== r,
                        d = e.getBody(),
                        o = p.grep(
                            p.toArray(d.getElementsByTagName("span")),
                            N,
                        ),
                        i = 0;
                    i < o.length;
                    ...
                    if (((c = l = parseInt(f, 10)), a || c === t.get())) {
                        ...
                        l > t.get() &&
                            o[i].setAttribute("data-mce-index", l - 1);
                }
                return (
                    t.set(u),
                ...
                onSubmit: function (e) {
                    ...
                    return (
                        ...
                        (r = s.find("#find").value()).length
                            ...
                            : (T.done(i, o, !1),
                              void s.statusbar.items().slice(1).disabled(!0))
                    );
                },
                buttons: [
                    {
