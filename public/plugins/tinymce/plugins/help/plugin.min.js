!(function () {
    ...
    var e,
        ...
        y = {
            ...
            none: d,
            from: function (e) {
                return null === e || e === undefined ? p : h(e);
            },
        },
        g =
            ((o = "function"),
        ...
        k =
            (a = Array.prototype.indexOf) === undefined
                ? function (e, t) {
                      return x(e, t);
                  }
                : function (e, t) {
        ...
        w =
            ...
            tinymce.util.Tools.resolve("tinymce.util.I18n")),
        A = tinymce.util.Tools.resolve("tinymce.Env"),
        C = A.mac ? "\u2318" : "Ctrl",
        S = A.mac ? "Ctrl + Alt" : "Shift + Alt",
        O = {
            shortcuts: [
                { shortcut: C + " + B", action: "Bold" },
                { shortcut: C + " + I", action: "Italic" },
                { shortcut: C + " + U", action: "Underline" },
                { shortcut: C + " + A", action: "Select all" },
                {
                    shortcut: C + " + Y or " + C + " + Shift + Z",
                    action: "Redo",
                },
                { shortcut: C + " + Z", action: "Undo" },
                { shortcut: S + " + 1", action: "Header 1" },
                { shortcut: S + " + 2", action: "Header 2" },
                { shortcut: S + " + 3", action: "Header 3" },
                { shortcut: S + " + 4", action: "Header 4" },
                { shortcut: S + " + 5", action: "Header 5" },
                { shortcut: S + " + 6", action: "Header 6" },
                { shortcut: S + " + 7", action: "Paragraph" },
                { shortcut: S + " + 8", action: "Div" },
                { shortcut: S + " + 9", action: "Address" },
        ...
        P = function () {
            var e = b(O.shortcuts, function (e) {
                return (
        ...
        H = c(function (e, o) {
            return e.replace(/\$\{([^{}]*)\}/g, function (e, t) {
                var n,
                    r = o[t];
                return "string" == (n = typeof r) || "number" === n
                    ? r.toString()
                    : e;
            });
        ...
        F = function (t, n) {
            return (function (e, t) {
                ...
                function () {
                    ...
                    return "function" == typeof e ? H(e()) : n;
                },
                function (e) {
                    return H({
                        name: e.name,
                ...
                o =
                    ...
                    e.settings.forced_plugins === undefined
                        ...
                        : (function (e, t) {
                              ...
                              r,
                              ((n = c(v, e.settings.forced_plugins)),
                              function () {
                                  for (
                                      var e = [], t = 0;
                                      t < arguments.length;
        ...
        j = function () {
            var e,
                ...
                n =
                    ...
                    "</a>";
            return [
                { type: "label", html: w.translate(["You are using {0}", n]) },
                { type: "spacer", flex: 1 },
                {
                    text: "Close",
                    onclick: function () {
        ...
        N = function (e, t) {
            (e.addButton("help", { icon: "help", onclick: L(e, t) }),
                e.addMenuItem("help", {
                    text: "Help",
                    icon: "help",
                    context: "help",
