    ...
    var help = (function () {
        ...
        var getPluginKeys = function (editor) {
            ...
            return editor.settings.forced_plugins === undefined
                ...
                : filter(
                      keys$$1,
                      not(curry(contains, editor.settings.forced_plugins)),
                  );
        };
        ...
        var makeRow = function () {
            var version = getVersion(
                global$3.majorVersion,
                global$3.minorVersion,
            );
            var changeLogLink =
        ...
        var register = function (editor, pluginUrl) {
            editor.addCommand(
                "mceHelp",
                $_414lq7bfjkmcdun3.open(editor, pluginUrl),
            );
        };
