!(function () {
    ...
    var e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        ...
        c = function (r, e) {
            var i = v.extend({}, e);
            if (!i.source1 && (v.extend(i, j(w(r), i.embed)), !i.source1))
                return "";
            (i.source2 || (i.source2 = ""),
                i.poster || (i.poster = ""),
        ...
        B = function (i) {
            ...
            if (
                ...
                var s = J(function (e) {
                    (e(a),
                        (t = a.toJSON()),
                        a.find("#embed").value(A(t.embed, t)));
                });
                n.push(s);
            }
            ...
            (0 < c.length &&
                l.push({ title: "Advanced", type: "form", items: c }),
        ...
        Z = function (e, t, r) {
            ...
            (c = t.firstChild && t.firstChild.value) &&
                (r.attr("data-mce-html", escape(Q(e, c))),
                (r.firstChild = null));
        },
        ee = function (e) {
            for (; (e = e.parent); )
            ...
            (d.on("preInit", function () {
                ...
                (v.each(
                    ...
                    d.serializer.addAttributeFilter(
                        ...
                        function (e, t) {
                            for (
                                var r, i, a, o, n, c, s, u, l = e.length;
                                l--;
