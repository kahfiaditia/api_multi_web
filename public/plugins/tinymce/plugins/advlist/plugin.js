    ...
    var advlist = (function () {
        ...
        var register = function (editor) {
            editor.addCommand("ApplyUnorderedListStyle", function (ui, value) {
                $_95my7l8fjkmcduce.applyListFormat(
                    editor,
                    "UL",
            ...
            return function (e) {
                ...
                editor.on("NodeChange", function (e) {
                    var tableCellIndex = findIndex(
                        e.parents,
                        $_e03fgd8ijkmcduci.isTableCellNode,
                    );
                    var parents =
                        tableCellIndex !== -1
                            ? e.parents.slice(0, tableCellIndex)
                            : e.parents;
                    var lists = global$1.grep(
                        parents,
                        $_e03fgd8ijkmcduci.isListNode(editor),
                    );
                    ctrl.active(
        ...
        var updateSelection = function (editor) {
            return function (e) {
                var listStyleType =
                    $_e03fgd8ijkmcduci.getSelectedStyleType(editor);
                e.control.items().each(function (ctrl) {
                    ctrl.active(ctrl.settings.data === listStyleType);
                });
            };
        };
        var addSplitButton = function (
            editor,
            id,
            tooltip,
            cmd,
        ...
        var register$1 = function (editor) {
            addControl(
                ...
                "InsertOrderedList",
                "OL",
                $_6wfe958hjkmcduch.getNumberStyles(editor),
            );
            addControl(
                editor,
                "bullist",
                ...
                "InsertUnorderedList",
                "UL",
                $_6wfe958hjkmcduch.getBulletStyles(editor),
            );
        };
