    ...
    var toc = (function () {
        ...
        var readHeaders = function (editor) {
            ...
            var selector = generateSelector(
                $_6170g7sajkmcdy1q.getTocDepth(editor),
            );
        ...
        var generateTocHtml = function (editor) {
            ...
            return (
                '<div class="' +
                editor.dom.encode($_6170g7sajkmcdy1q.getTocClass(editor)) +
        ...
        var generateTocContentHtml = function (editor) {
            ...
            html += generateTitle(
                $_6170g7sajkmcdy1q.getTocHeader(editor),
        ...
        var isEmptyOrOffscren = function (editor, nodes) {
            return (
                !nodes.length ||
                editor.dom.getParents(nodes[0], ".mce-offscreen-selection")
                    .length > 0
            );
        };
        ...
        var setup = function (editor) {
            var $ = editor.$,
                tocClass = $_6170g7sajkmcdy1q.getTocClass(editor);
        ...
        var toggleState = function (editor) {
            return function (e) {
                ...
                editor.on("LoadContent SetContent change", function () {
                    ctrl.disabled(
                        editor.readonly ||
                            !$_31vpts6jkmcdy1n.hasHeaders(editor),
                    );
                });
            };
        };
        var isToc = function (editor) {
            return function (elm) {
                return (
                    ...
                    editor.dom.is(
                        elm,
                        "." + $_6170g7sajkmcdy1q.getTocClass(editor),
                    ) &&
