!(function () {
    ...
    var e,
        ...
        R = function (i) {
            for (var e = [], t = 1; t < arguments.length; t++)
                e[t - 1] = arguments[t];
            for (
                var u = new Array(arguments.length - 1), n = 1;
                n < arguments.length;
                n++
            )
                u[n - 1] = arguments[n];
        ...
        ge = {
            ...
            one: function (e, t) {
                ...
                return me(n)
                    ? S.none()
                    : S.from(n.querySelector(e)).map(le.fromDom);
            },
        },
        he = function (e, t) {
            for (
        ...
        ve = function (e, t) {
            return (function (e, t) {
                for (
                    var n = t !== undefined && null !== t ? t : pe, r = 0;
        ...
        Ae = {
            unknown: function () {
                return Oe({ current: undefined, version: Ne.unknown() });
            },
            nu: Oe,
            edge: C("Edge"),
            chrome: C("Chrome"),
        ...
        _e = {
            unknown: function () {
                return We({ current: undefined, version: Ne.unknown() });
            },
            nu: We,
            windows: C(ke),
            ios: C("iOS"),
        ...
        Ve = [
            ...
            { name: "Linux", search: He("linux"), versionRegexes: [] },
            { name: "Solaris", search: He("sunos"), versionRegexes: [] },
            { name: "FreeBSD", search: He("freebsd"), versionRegexes: [] },
        ],
        Ge = { browsers: C(Ue), oses: C(Ve) },
        Ye = function (e) {
            var t,
                n,
                r,
    ...
    var Nt,
        ...
        It = function (e, r) {
            var o = function (e) {
                for (var t = 0; t < e.childNodes.length; t++) {
                    if (r(le.fromDom(e.childNodes[t])))
                        return S.some(le.fromDom(e.childNodes[t]));
        ...
        Bt = {
            ...
            sibling: function (t, n) {
                var e = t.dom();
                return e.parentNode
                    ? Pt(le.fromDom(e.parentNode), function (e) {
                          return !$e.eq(t, e) && n(e);
                      })
                    : S.none();
            },
        ...
        _t = function (e, t, n) {
            ...
            return r(t)
                ...
                : E(e, mt.name(t))
                  ? S.some(t)
                  : Wt.ancestor(t, e.join(","), function (e) {
            ...
            return A(t, function (e) {
                var t = e,
                    ...
                    r = A(zt.cells(e), function (e) {
                        var t = bt.has(e, "rowspan")
                                ? parseInt(bt.get(e, "rowspan"), 10)
                                : 1,
                            n = bt.has(e, "colspan")
                                ? parseInt(bt.get(e, "colspan"), 10)
                                : 1;
        ...
        en = {
            ...
            preserve: function (e, t) {
                var n = bt.get(e, "style"),
                    r = t(e);
                return (
                    (n === undefined ? bt.remove : bt.set)(e, "style", n),
                    r
                );
            },
            setAll: function (e, t) {
                    ...
                    for (
                        ...
                        for (var f = !1, s = 0; s < a; s++)
                            l < n.minRow() ||
                                ...
                                s < n.minCol() ||
                                s > n.maxCol() ||
                                (Yt.getAt(t, l, s).filter(r).isNone()
                                    ? ((o = f),
                                      (i = e[l].element()),
                                      (u = le.fromTag("td")),
                                      rn.append(u, le.fromTag("br")),
                                      (o ? rn.append : rn.prepend)(i, u))
                                    : (f = !0));
                })(m, g, h, d),
                (o = e),
                (f = h),
                (s = P(ut.firstLayer(o, "tr"), function (e) {
                    return 0 === e.dom().childElementCount;
                })),
                k(s, an.remove),
                (f.minCol() !== f.maxCol() && f.minRow() !== f.maxRow()) ||
                    k(ut.firstLayer(o, "th,td"), function (e) {
                    ...
                    var r,
                        ...
                        a =
                            0 < u.length
                                ...
                                : n;
                    return (
                        rn.append(a, le.fromTag("br")),
                        en.copy(e.element(), n),
                        en.remove(n, "height"),
                        1 !== e.colspan() && en.remove(e.element(), "width"),
                        c(e.element(), n),
                        n
                    );
                },
        ...
        On = function (e) {
            return { row: Dn(e), cell: Sn, replace: Nn, gap: Sn };
        },
        An = function (e, t) {
            var n = (t || document).createElement("div");
    ...
    function Pn() {
        return {
            ...
            down: C({ selector: St.descendants, predicate: Rt.descendants }),
            styles: C({
                get: en.get,
                getRaw: en.getRaw,
                set: en.set,
            ...
            remove: C({ unwrap: an.unwrap, remove: an.remove }),
            create: C({
                nu: le.fromTag,
                clone: function (e) {
            ...
            property: C({
                ...
                isBoundary: function (e) {
                    return (
                        !!mt.isElement(e) &&
                        ("body" === mt.name(e) || E(kn, mt.name(e)))
                    );
                },
                isEmptyTag: function (e) {
                    return (
                        !!mt.isElement(e) &&
                        E(["br", "img", "hr", "input"], mt.name(e))
                    );
                },
            }),
            eq: $e.eq,
    ...
    var In = X("left", "right"),
        ...
        tr = function (e, t) {
            for (
                var n = !0, r = R(Zn, t), o = t.startRow();
                o <= t.finishRow();
                o++
            )
                for (var i = t.startCol(); i <= t.finishCol(); i++)
                    n = n && Yt.getAt(e, o, i).exists(r);
        ...
        hr = function (a, c, r) {
            ...
            return $e.eq(a, c)
                ? S.some(gr({ boxes: S.some([a]), start: a, finish: c }))
                : mr(a).bind(function (u) {
                      return mr(c).bind(function (i) {
                          ...
                          if ($e.contains(u, i)) {
                              var e =
                                  0 <
                                  (t = St.ancestors(c, "td,th", l(u))).length
                                      ? t[t.length - 1]
                                      : c;
                              return S.some(
                                  gr({
                          ...
                          return Qn.ancestors(a, c)
                              .shared()
                              .bind(function (e) {
                                  return Wt.closest(e, "table", r).bind(
                                      function (e) {
                                          var t = St.ancestors(
                                                  c,
                                                  "td,th",
            ...
            M(i, function (e) {
                ...
                return lr(e, t, n).bind(function (e) {
                    return (
                        (t = e),
                        (n = r),
                        Wt.ancestor(t, "table").bind(function (e) {
            ...
            return Er.cata(
                ...
                function (t, e) {
                    return 0 === t.length
                        ...
                        : xr(
                              n,
                              Tr.firstSelectedSelector(),
                              Tr.lastSelectedSelector(),
                          ).bind(function (e) {
                              return 1 < t.length
                                  ? S.some({ bounds: C(e), cells: C(t) })
                                  : S.none();
                          });
                },
                S.none,
        ...
        kr = function (e, t) {
            ...
            return 0 < n.length &&
                j(n, function (e) {
                    return (
                        (bt.has(e, "rowspan") &&
                            1 < parseInt(bt.get(e, "rowspan"), 10)) ||
                        (bt.has(e, "colspan") &&
                            1 < parseInt(bt.get(e, "colspan"), 10))
                    );
                })
                ? S.some(n)
                : S.none();
                            ...
                            (n.preventDefault(),
                                ...
                                zt
                                    ...
                                    n.content = A(e, function (e) {
                                        return (
                                            (t = e),
                                            a.selection.serializer.serialize(
                                                t.dom(),
                                                {},
                                            )
                                        );
    ...
    var Lr = _r("height", function (e) {
        ...
        Gr = function (e) {
            return Ur.browser.isIE() || Ur.browser.isEdge()
                ? ((n = Vr((t = e), "padding-top", 0)),
                  (r = Vr(t, "padding-bottom", 0)),
                  (o = Vr(t, "border-top-width", 0)),
                  (i = Vr(t, "border-bottom-width", 0)),
                  (u = t.dom().getBoundingClientRect().height),
                  "border-box" === en.get(t, "box-sizing")
                      ? u
                      : u - n - r - (o + i))
                : Vr(e, "height", qr(e));
            var t, n, r, o, i, u;
        ...
        $r = function (e, t, n, r) {
            ...
            return (
                ...
                ("" !== s &&
                    (f.length < s.length || f.substr(d, d + s.length) !== s)) ||
                "table" === mt.name(t)
                    ? m
                    : ((o = t),
                      (i = m),
        ...
        Qr = function (e) {
            var t,
                n =
                    ((t = e),
                    en.getRaw(t, "height").getOrThunk(function () {
                        return Gr(t) + "px";
                    }));
        ...
        ro = function (n, r) {
            no.getGenericWidth(n).each(function (e) {
                var t = e.width() / 2;
                (no.setGenericWidth(n, t, e.unit()),
                    no.setGenericWidth(r, t, e.unit()));
            });
        },
        oo = function (e, t) {
        ...
        io = function (e) {
            var t = e.dom();
            return t === t.window && e instanceof Window
                ? e
                : mt.isDocument(e)
        ...
        lo = function (e) {
            ...
            return o === n
                ? ao(o.offsetLeft, o.offsetTop)
                : oo(e, i)
                  ? ((t = n.getBoundingClientRect()), ao(t.left, t.top))
                  : ao(0, 0);
        },
        fo = function (e) {
        ...
        xo = { delta: u, edge: ho, positions: R(wo, po, vo) },
        Co = {
            height: yo,
            rtl: {
                delta: function (e, t) {
    ...
    var To,
        ...
        Ao = function (e) {
            return Eo(Oo, e, { validate: T, label: "function" });
        },
        ko = function (e) {
            var t = bt.has(e, "colspan")
                    ? parseInt(bt.get(e, "colspan"), 10)
                    : 1,
                n = bt.has(e, "rowspan")
                    ? parseInt(bt.get(e, "rowspan"), 10)
        ...
        Io = function (r, e) {
            ...
            var n = Do(S.none()),
                ...
                u = function (e) {
                    var t = i(e);
                    return (
                        n.get().isNone() && n.set(S.some(t)),
                        (a = S.some({ item: e, replacement: t })),
                        t
                    );
                },
                a = S.none();
                ...
                r =
                    ...
                    (t = F(e, function (e) {
                        ...
                        return j(t, function (e) {
                            return (
                                i(e) ||
                                (mt.isText(e) && 0 === vn.get(e).trim().length)
                            );
                        })
                            ? []
                            : t.concat(n(e));
            ...
            var i = [],
                ...
                t = function (e, t) {
                    ...
                    0 < e.length
                        ...
                        : ((n = t), Wt.child(o, n).each(an.remove));
                },
                n = [],
                r = [],
                a = [];
        ...
        ui = function (e) {
            return A(e, function (e) {
                ...
                return (
                    k(e.cells(), function (e) {
                        var t = gn(e.element());
                        (oi(t, "colspan", e.colspan(), 1),
                            oi(t, "rowspan", e.rowspan(), 1),
                            rn.append(n, t));
                    }),
                    n
                );
        ...
        mi = function (e, t, n, r, o) {
            ...
            return (
                ...
                bt.setAll(i, { "data-column": e, role: "presentation" }),
                i
            );
        },
        gi = function (e, t, n, r, o) {
            ...
            return (
                ...
                bt.setAll(i, { "data-row": e, role: "presentation" }),
                i
            );
        },
        hi = function (e) {
        ...
        pi = { resolve: hi("ephox-snooker").resolve },
        vi = function (e, t) {
            var n = bt.get(e, t);
        ...
        yi = function (e, t, n) {
            ...
            return (
                0 < r.length ? bt.set(e, t, r.join(" ")) : bt.remove(e, t),
                !1
            );
        },
        xi = function (e) {
        ...
        Ai = {
            ...
            remove: function (e, t) {
                var n;
                (Ei(e) ? e.dom().classList.remove(t) : Ni(e, t),
                    0 === (Ei((n = e)) ? n.dom().classList : Si(n)).length &&
                        bt.remove(n, "class"));
            },
            toggle: function (e, t) {
        ...
        Yi = function (t, e) {
            ...
            return 0 < r.length
                ? S.some(
                      Xo(
                          { cells: r },
                          { generators: e.generators, clipboard: e.clipboard },
                      ),
                  )
                : S.none();
        },
        ...
        nu = function (e, t, n) {
            if (e.row() >= t.length || e.column() > Zo.cellLength(t[0]))
                return Qi.error(
        ...
        iu = function (e, t, n, r) {
            ...
            for (var o = t.startRow(); o <= t.finishRow(); o++)
                for (var i = t.startCol(); i <= t.finishCol(); i++)
                    Zo.mutateCell(e[o], i, ae.elementnew(r(), !1));
            return e;
        },
        uu = function (e, t, n, r) {
            for (var o = !0, i = 0; i < e.length; i++)
                for (var u = 0; u < Zo.cellLength(e[0]); u++) {
                    ...
                    !0 === a && !1 === o
                        ? Zo.mutateCell(e[i], u, ae.elementnew(r(), !0))
                        : !0 === a && (o = !1);
                }
            return e;
        },
                        ...
                        for (var v = m; v < h; v++) {
                            ((i = t),
                                ...
                                1 < i.length &&
                                    1 < Zo.cellLength(s) &&
                                    ((0 < a &&
                                        f(Zo.getCellElement(s, a - 1))) ||
                                        (a < s.length - 1 &&
                                            f(Zo.getCellElement(s, a + 1))) ||
                                        (0 < u &&
                                            f(
                                                Zo.getCellElement(i[u - 1], a),
                                            )) ||
                                        (u < i.length - 1 &&
                                            f(
                                                Zo.getCellElement(i[u + 1], a),
            ...
            var t = n.slice(0, r),
                ...
                a = Zo.mapCells(n[e], function (e, t) {
                    return 0 < r &&
                        r < n.length &&
                        o(
                            Zo.getCellElement(n[r - 1], t),
                            Zo.getCellElement(n[r], t),
                        )
                        ? Zo.getCell(n[r], t)
                        : ae.elementnew(i(e.element(), o), !0);
                });
        ...
        su = function (e, n, r, o, i) {
            return A(e, function (e) {
                var t =
                    0 < n &&
                    n < Zo.cellLength(e) &&
                    o(Zo.getCellElement(e, n - 1), Zo.getCellElement(e, n))
                        ? Zo.getCell(e, n)
                        : ae.elementnew(i(Zo.getCellElement(e, r), o), !0);
        ...
        du = function (e, r, o, i, u) {
            ...
            return A(e, function (e, t) {
                var n =
                    t === r
                        ? ae.elementnew(u(Zo.getCellElement(e, o), i), !0)
                        : Zo.getCell(e, o);
        ...
        vu = function (e, t, n, r) {
            return (
                Zo.getCellElement(e[t], n) !== undefined &&
                0 < t &&
                r(Zo.getCellElement(e[t - 1], n), Zo.getCellElement(e[t], n))
            );
        },
        bu = function (e, t, n) {
            return (
                0 < t && n(Zo.getCellElement(e, t - 1), Zo.getCellElement(e, t))
            );
        },
        wu = function (n, r, o, e) {
        ...
        Iu = function (e, t, n, r, o) {
            ...
            return A(i, function (e, t) {
                return e.filter(m(Ou.hasColspan)).fold(
                    function () {
                        var e = li(u, t);
                        return r(e);
                    },
        ...
        Mu = function (e, t, n, r) {
            ...
            return A(o, function (e, t) {
                return e.filter(m(Ou.hasRowspan)).fold(
                    function () {
                        var e = li(i, t);
                        return r(e);
                    },
        ...
        oa = {
            ...
            insertColumnsAfter: zi(
                function (e, t, n, r) {
                    var o = t[t.length - 1].column(),
                        i =
                            t[t.length - 1].column() +
                            t[t.length - 1].colspan(),
                        u = ta(t),
                        a = B(
                            u,
                            function (e, t) {
            ...
            pasteCells: zi(
                function (e, n, t, r) {
                    ...
                    return cu(l, e, c, n.generators(), t).fold(
                        function () {
        ...
        va = { "border-collapse": "collapse", width: "100%" },
        ba = { border: "1" },
        wa = function (e) {
        ...
        qa = function (e, t) {
            ...
            ((i["border-style"] = o.borderStyle),
                ...
                (i.width = o.width ? la(o.width) : ""),
                (i.height = o.height ? la(o.height) : ""),
                r
                    .find("#style")
                    .value(
                        n.serializeStyle(n.parseStyle(n.serializeStyle(i))),
                    ));
        },
        Fa = function (e, t) {
            var n = e.dom,
        ...
        ja = {
            ...
            buildListItems: function (e, r, t) {
                var o = function (e, n) {
                    return (
                        (n = n || []),
                        Ia.each(e, function (e) {
                            var t = { text: e.text || e.title };
                            (e.menu
                                ? (t.menu = o(e.menu))
                                : ((t.value = e.value), r && r(t)),
                                n.push(t));
                        }),
                        n
                    );
        ...
        za = function (r, o, e) {
            ...
            (wa(r) && ja.syncAdvancedStyleFields(r, e),
                        ...
                        (a(e, "scope", i.scope),
                            1 === o.length
                                ...
                                : ((t = e),
                                  ...
                                  (t.style.cssText += ";" + n)),
                            a(e, "class", i["class"]),
                            c(e, "width", la(i.width)),
                            c(e, "height", la(i.height)),
                            i.type &&
                                e.nodeName.toLowerCase() !== i.type &&
                                (e = u.rename(e, i.type)),
                            1 === o.length && (Wa(r, e), _a(r, e)),
                            i.align && Ba(r, e, i.align),
                            i.valign && Ma(r, e, i.valign));
                    }),
                        r.focus());
                }));
        },
            ...
            if (
                ...
                (1 < o.length
                    ...
                    : ((u = e),
                      ...
                      (c = {
                          width:
                              a.getStyle(u, "width") || a.getAttrib(u, "width"),
                          height:
                              a.getStyle(u, "height") ||
                              a.getAttrib(u, "height"),
                      ...
                      Ia.each("left center right".split(" "), function (e) {
                          i.formatter.matchNode(u, "align" + e) &&
                              (c.align = e);
                      }),
                      Ia.each("top middle bottom".split(" "), function (e) {
                          i.formatter.matchNode(u, "valign" + e) &&
                              (c.valign = e);
                      }),
                      wa(i) && Ia.extend(c, ja.extractAdvancedStyles(a, u)),
                      (n = c)),
                    0 < Ra(t).length &&
                        (r = {
                            name: "class",
        ...
        f.undoManager.transact(function () {
            (Ia.each(s, function (e) {
                ...
                (g(e, "scope", h.scope),
                    ...
                    h.align !== d.align && (Wa(f, e), Ba(f, e, h.align)));
            }),
                f.focus());
        });
    }
    var Va = function (t) {
            ...
            ((e = s.getParent(t.selection.getStart(), "table")),
                ...
                Ia.each(e.rows, function (t) {
                    Ia.each(t.cells, function (e) {
                        if (s.getAttrib(e, "data-mce-selected") || e === n)
                            return (d.push(t), !1);
                    });
                }),
                (r = d[0]) &&
                    (1 < d.length
                        ...
                        : ((c = r),
                          ...
                          Ia.each("left center right".split(" "), function (e) {
                              a.formatter.matchNode(c, "align" + e) &&
                                  (f.align = e);
                          }),
                          ya(a) && Ia.extend(f, ja.extractAdvancedStyles(l, c)),
                          (i = f)),
                    0 < Sa(t).length &&
                        (o = {
                            name: "class",
        ...
        Xa = function (e, t, n, r, o) {
            ...
            for (var a = [], c = 0; c < e; c++) {
                for (var l = le.fromTag("tr"), f = 0; f < t; f++) {
                    var s =
                        c < n || f < r ? le.fromTag("th") : le.fromTag("td");
                    (f < r && bt.set(s, "scope", "row"),
                        c < n && bt.set(s, "scope", "col"),
                        rn.append(s, le.fromTag("br")),
                        o.percentages && en.set(s, "width", 100 / t + "%"),
                        rn.append(l, s));
                }
                a.push(l);
            }
        ...
        Qa = function (o, e, t) {
            var n,
                r,
                i = o.getParam("table_default_styles", va, "object"),
                u = {
                    styles: i,
                    attributes:
                        ((r = o),
                        r.getParam("table_default_attributes", ba, "object")),
                    percentages:
                        ((n = i.width),
                        v(n) && -1 !== n.indexOf("%") && !Na(o)),
                },
                a = Xa(t, e, 0, 0, u);
            ...
            return (
                o.insertContent(c),
                Wt.descendant(ia(o), 'table[data-mce-id="__mce"]')
                    .map(function (e) {
                        var t, n, r;
                        return (
                            Na(o) && en.set(e, "width", en.get(e, "width")),
                            bt.remove(e, "data-mce-id"),
                            (t = o),
                            k(St.descendants(e, "tr"), function (e) {
                                (Da(t, e.dom()),
                                    k(St.descendants(e, "th,td"), function (e) {
                                        Ea(t, e.dom());
                                    }));
                            }),
                            (n = o),
                            (r = e),
                            Wt.descendant(r, "td,th").each(R($a, n)),
                            e.dom()
                        );
                    })
                    .getOr(null)
    ...
    function Za(e, t, n, r) {
        if ("TD" === t.tagName || "TH" === t.tagName) e.setStyle(t, n, r);
            ...
            for (var o = 0; o < t.children.length; o++)
                Za(e, t.children[o], n, r);
    }
    var ec = function (e, t, n) {
            var r,
                o,
                i = e.dom;
            (xa(e) && ja.syncAdvancedStyleFields(e, n),
                ...
                e.undoManager.transact(function () {
                    (t || (t = Qa(e, o.cols || 1, o.rows || 1)),
                        (function (e, t, n) {
                            ...
                            if (
                                ((i["class"] = n["class"]),
                                (u.height = la(n.height)),
                                o.getAttrib(t, "width") && !Ca(e)
                                    ? (i.width = (r = n.width)
                                          ? r.replace(/px$/, "")
                                          : "")
                                    : (u.width = la(n.width)),
                                Ca(e)
                                    ? ((u["border-width"] = la(n.border)),
                                      (u["border-spacing"] = la(n.cellspacing)),
                                      Ia.extend(i, {
                        ...
                        (r = i.select("caption", t)[0]) &&
                            !o.caption &&
                            i.remove(r),
                        !r &&
                            o.caption &&
                            (((r = i.create("caption")).innerHTML = Ga.ie
                                ? "\xa0"
                                : '<br data-mce-bogus="1"/>'),
                            t.insertBefore(r, t.firstChild)),
                        Wa(e, t),
                        o.align && Ba(e, t, o.align),
                        e.focus(),
                        e.addVisual());
                }));
        },
            ...
            (!0 === e
                ? (n = d.getParent(t.selection.getStart(), "table")) &&
                  ...
                  (f = {
                      ...
                      height:
                          l.getStyle(c, "height") || l.getAttrib(c, "height"),
                      cellspacing:
                          l.getStyle(c, "border-spacing") ||
                          l.getAttrib(c, "cellspacing"),
                      cellpadding:
                  ...
                  xa(a) && Ia.extend(f, ja.extractAdvancedStyles(l, c)),
                  (m = f))
                : ((r = { label: "Cols", name: "cols" }),
                  (o = { label: "Rows", name: "rows" })),
                0 < Ta(t).length &&
                    (m["class"] &&
                        (m["class"] = m["class"].replace(
        ...
        rc = function (a, t, c, l, n) {
            var r = ca(a),
                ...
                d = function (e) {
                    return { width: ua(e.dom()), height: ua(e.dom()) };
                },
                o = function (t) {
                    var n = f();
                    s(n).each(function (i) {
                        ...
                        t(i, e).each(function (e) {
                            ...
                            ((t = a),
                                ...
                                (n.width === o.width &&
                                    n.height === o.height) ||
                                    (Oa(t, r.dom(), n.width, n.height),
                                    Aa(t, r.dom(), o.width, o.height)),
                                a.selection.setRng(e),
                                a.focus(),
                                c.clear(i),
                                fa(i));
        ...
        oc = function (e) {
            ...
            return { parent: C(t), view: C(e), origin: C(ao(0, 0)) };
        },
        ic = function (e, t) {
            return { parent: C(t), view: C(e), origin: C(ao(0, 0)) };
        };
    ...
    var ac = {
        ...
        lc = { resolve: hi("ephox-dragster").resolve },
        fc = function (m, g) {
            return function (e) {
                if (m(e)) {
                    var t,
        ...
        vc = cc.mode({
            ...
            sink: function (e, t) {
                var n,
                    ...
                    i =
                        ((n = t),
                        (r = Xo({ layerClass: lc.resolve("blocker") }, n)),
                        (o = le.fromTag("div")),
                        bt.set(o, "role", "presentation"),
                        en.setAll(o, {
                            position: "fixed",
                            left: "0px",
                            top: "0px",
                        ...
                        Ai.add(o, lc.resolve("blocker")),
                        Ai.add(o, r.layerClass),
                        {
                            element: function () {
                                return o;
                            },
    ...
    function Cc() {
        var n,
            r = ac.create({ drag: uc(["xDelta", "yDelta", "target"]) }),
            o = S.none(),
            e = {
                mutate: function (e, t) {
                    n.trigger.drag(e, t);
                },
                events: (n = ac.create({ drag: uc(["xDelta", "yDelta"]) }))
                    .registry,
            };
        return (
        ...
        var r = Co.height,
            t = (function (o, t, i) {
                ...
                var a = function (e, t) {
                    return (
                        Ou.getInt(e, t) -
                        parseInt(bt.get(e, "data-initial-" + t), 10)
                    );
                };
                    ...
                    n.get().each(function (r) {
                        u.each(function (n) {
                            (e(r, "data-row").each(function (e) {
                                var t = a(r, "top");
                                (bt.remove(r, "data-initial-top"),
                                    d.trigger.adjustHeight(
                                        n,
                                        t,
                                        parseInt(e, 10),
                                    ));
                ...
                var c = function (e, t) {
                        (d.trigger.startAdjust(),
                            ...
                            bt.set(
                                e,
                                "data-initial-" + t,
                                parseInt(en.get(e, t), 10),
                            ),
                            Ai.add(e, Sc),
                            en.set(e, "opacity", "0.2"),
                            r.go(o.parent()));
                    },
                    l = pc.bind(o.parent(), "mousedown", function (e) {
                        (Li.isRowBar(e.target()) && c(e.target(), "top"),
                            Li.isColBar(e.target()) && c(e.target(), "left"));
                    }),
                    f = function (e) {
                        return $e.eq(e, o.view());
                    },
                    s = pc.bind(o.view(), "mouseover", function (e) {
                        "table" === mt.name(e.target()) ||
                        Rc.closest(e.target(), "table", f)
                            ? (u =
                                  "table" === mt.name(e.target())
                                      ? S.some(e.target())
                                      : Wt.ancestor(
    ...
    var Nc = function (e, t) {
        ...
        Ec = function (u) {
            ...
            return (
                u.on("init", function () {
                    ...
                    if (
                        ((l = S.some(n)),
                        ("table" === (e = u.getParam("object_resizing", !0)) ||
                            e) &&
                ...
                u.on("ObjectResizeStart", function (e) {
                    ...
                    s(n) &&
                        ...
                        (t = n),
                        (c =
                            u.dom.getStyle(t, "width") ||
                            u.dom.getAttrib(t, "width")));
                }),
        ...
        Mc = function (t, e) {
            return Bc(t, e).fold(
                ...
                function (e) {
                    return e.index() + 1 < e.all().length
                        ? Pc(t, e.all()[e.index() + 1])
                        : Ic(t);
                },
            );
        },
        ...
        Yc = {
            ...
            isWithin: function (e, t) {
                return (
                    t.compareBoundaryPoints(e.END_TO_START, e) < 1 &&
                    -1 < t.compareBoundaryPoints(e.START_TO_END, e)
                );
            },
            toString: function (e) {
                return e.toString();
        ...
        tl = function (t, e, n, r) {
            ...
            return Jo(i, function (e) {
                return (
                    o.selectNode(e.dom()),
                    Qc(o.getBoundingClientRect(), n, r)
                        ? nl(t, e, n, r)
                        : S.none()
                );
            });
        ...
        ll = document.caretPositionFromPoint
            ? function (n, e, t) {
                  return S.from(n.dom().caretPositionFromPoint(e, t)).bind(
                      function (e) {
                          if (null === e.offsetNode) return S.none();
                          var t = n.dom().createRange();
                          return (
                              t.setStart(e.offsetNode, e.offset),
                              t.collapse(),
                              S.some(t)
                          );
                      },
            ...
            return $c.diagnose(s, e).match({
                ...
                rtl: function (e, t, n, r) {
                    ...
                    if (l.setBaseAndExtent)
                        l.setBaseAndExtent(e.dom(), t, n.dom(), r);
                    else if (l.extend)
                        try {
                            ((i = e),
                                (u = t),
        ...
        yl = function (e) {
            ...
            return Hc(t, e.anchorOffset, n, e.focusOffset)
                ? S.some(
                      jc.range(
                          le.fromDom(e.anchorNode),
                          e.anchorOffset,
                          le.fromDom(e.focusNode),
                          e.focusOffset,
                      ),
                  )
                : (function (e) {
        ...
        Tl = function (e) {
            var o = jc.getWin(e).dom(),
                ...
                n = gl(e);
            return $c.diagnose(o, n).match({ ltr: t, rtl: t });
        },
        Nl = function (e, t) {
        ...
        Bl = function (e, t) {
            var n,
                r = St.descendants(t, "tr");
            return ((n = r),
            0 === n.length ? S.none() : S.some(n[n.length - 1])).bind(
                function (e) {
            ...
            if (t.keyCode === Al.TAB) {
                ...
                if (e.collapsed) {
                    ...
                    zt.cell(a, u).each(function (e) {
                        (t.preventDefault(),
                            (t.shiftKey ? Pl : kl)(n, u, e, r, o).each(
                                function (e) {
        ...
        jl = ql(40),
        zl = {
            ltr: { isBackward: ql(37), isForward: ql(39) },
            rtl: { isBackward: ql(39), isForward: ql(37) },
            isUp: Fl,
            isDown: jl,
    ...
    var Kl = function (n, e, r, t, o) {
            return $e.eq(r, t)
                ? S.none()
                : pr(r, t, e).bind(function (e) {
                      var t = e.boxes().getOr([]);
                      return 0 < t.length
                          ? (o(n, t, e.start(), e.finish()),
                            S.some(Ll.response(S.some(Ul(r, 0, r, yn(r))), !0)))
                          : S.none();
                  });
        },
        Jl = {
            sync: function (n, r, e, t, o, i, u) {
                return $e.eq(e, o) && t === i
                    ? S.none()
                    : Wt.closest(e, "td,th", r).bind(function (t) {
        ...
        nf = function (e, t) {
            return mt.isElement(t)
                ? ef(e, t).map(Zl)
                : mt.isText(t)
                  ? e.getRangedRect(t, 0, t, yn(t)).map(Zl)
                  : S.none();
        },
        rf = X("item", "mode"),
        of = function (e, t, n, r) {
        ...
        cf = [
            { current: of, next: uf, fallback: S.none() },
            { current: uf, next: af, fallback: S.some(of) },
            { current: af, next: af, fallback: S.some(uf) },
        ],
        ...
        ff = { backtrack: of, sidestep: uf, advance: af, go: lf },
        sf = {
            left: function () {
                return {
                    sibling: function (e, t) {
        ...
        bf = {
            ...
            seekRight: vf,
            walkers: function () {
                return { left: sf.left, right: sf.right };
            },
            ...
            adjuster: function (e, t, n, r, o) {
                ...
                return Math.abs(n.top() - r.top()) < 1
                    ...
                    : n.bottom() < o.top()
                      ? xf.retry(i)
                      : n.bottom() === o.top()
                        ? xf.retry(Ql.moveUp(o, 1))
                        : Cf(e, t, o)
                          ? xf.retry(Ql.translate(i, 5, 0))
                          : xf.none();
            },
            move: Ql.moveUp,
            gather: yf.before,
            ...
            return 0 === u
                ...
                : ((c = n),
                  ...
                  c
                      ...
                      ? ((t = i),
                        (a = u - 1),
                        Tf(n, (e = r), o, e.move(t, 5), a))
                      : n
                            .situsFromPoint(i.left(), r.point(i))
                            .bind(function (e) {
                                return e.start().fold(
                                    S.none,
                                    function (t, e) {
        ...
        Pf =
            ...
            X("parent", "children", "element", "index")),
        If = function (e, t) {
            return W(e, R($e.eq, t));
        },
        Bf = function (r) {
        ...
        Wf = function (e, t, n) {
            return t(e, n).bind(function (e) {
                return mt.isText(e) && 0 === vn.get(e).trim().length
                    ? Wf(e, t, n)
                    : S.some(e);
            });
        },
            ...
            return 0 === c
                ...
                : Uf(r, o, i, u, a).bind(function (e) {
                      ...
                      return Af.cata(
                          ...
                          function (e) {
                              return $e.eq(i, e) && 0 === u
                                  ? zf(r, i, u, Ql.moveUp, a)
                                  : jf(r, o, e, 0, a, c - 1);
                          },
                          function (e) {
                              return $e.eq(i, e) && u === yn(e)
                                  ? zf(r, i, u, Ql.moveDown, a)
                                  : jf(r, o, e, yn(e), a, c - 1);
                          },
                      );
                  });
        ...
        Hf = function (e, t, n) {
            return Ff.browser.isChrome() ||
                Ff.browser.isSafari() ||
                Ff.browser.isFirefox() ||
                Ff.browser.isEdge()
                ? t.otherRetry(e, n)
                : Ff.browser.isIE()
                  ? t.ieRetry(e, n)
        ...
        Vf = function (t, n, r) {
            ...
            o.getSelection().bind(function (r) {
                return Lf(i, r.finish(), r.foffset(), u).fold(
                    function () {
                ...
                return jf(t, n, e.element(), e.offset(), r, 20).map(
                    t.fromSitus,
                );
            });
            var o, i, u;
                    ...
                    return (
                        ...
                        Gf(u, function (e) {
                            ...
                            ? Vf(r, o, i).bind(function (t) {
                                  return Wt.closest(t.finish(), "td,th", o).map(
                                      function (e) {
                                          return {
                                              start: C(n),
                                              finish: C(e),
            ...
            keyboard: function (e, c, l, f) {
                ...
                return {
                    keydown: function (e, t, n, r, o, i) {
                        var u = e.raw().which,
                            a = !0 === e.raw().shiftKey;
                        return vr(c, f.selectedSelector()).fold(
                            function () {
                                return zl.isDown(u) && a
                                    ? R(
                                          Jf,
                                          s,
                                          c,
                                    ...
                                    : zl.isUp(u) && a
                                      ...
                                      : zl.isDown(u)
                                        ? R(Kf, s, l, es.down, r, t, Qf)
                                        : zl.isUp(u)
                                          ? R(Kf, s, l, es.up, r, t, $f)
                                          : S.none;
                            },
                            function (t) {
                                var e = function (e) {
                                    return function () {
                                        return Jo(e, function (e) {
                                            ...
                                            function () {
                                                return wr(
                                                    c,
                                                    f.firstSelectedSelector(),
                                                    f.lastSelectedSelector(),
                                                ).map(function (e) {
                                                    var t =
                                                        zl.isDown(u) ||
                                                        i.isForward(u)
        ...
        us = {
            byClass: function (o) {
                ...
                return {
                    ...
                    selectRange: function (e, t, n, r) {
                        (u(e),
                            k(t, i),
                            Ai.add(n, o.firstSelected()),
                            Ai.add(r, o.lastSelected()));
                    },
            ...
            byAttr: function (o) {
                var n = function (e) {
                        (bt.remove(e, o.selected()),
                            bt.remove(e, o.firstSelected()),
                            bt.remove(e, o.lastSelected()));
                    },
                    i = function (e) {
                ...
                return {
                    ...
                    selectRange: function (e, t, n, r) {
                        (u(e),
                            k(t, i),
                            bt.set(n, o.firstSelected(), "1"),
                            bt.set(r, o.lastSelected(), "1"));
                    },
                    selectedSelector: o.selectedSelector,
                    firstSelectedSelector: o.firstSelectedSelector,
                    lastSelectedSelector: o.lastSelectedSelector,
        ...
        as = function (e) {
            return (
                !1 === Ai.has(le.fromDom(e.target), "ephox-snooker-resizer-bar")
            );
        };
    function cs(h, p) {
        var v = ee(
            ...
            h.on("init", function (e) {
                var r = h.getWin(),
                    ...
                    u = function (e) {
                        ...
                        (a
                            .keydown(t, o, n.startOffset, i, n.endOffset, u)
                            .each(function (e) {
                                c(t, e);
                            }),
                            p().each(function (e) {
    ...
    var ls = Ia.each,
        ...
        ss = function (t) {
            var e,
                n =
                    "" === (e = t.getParam("table_toolbar", pa)) || !1 === e
                        ? []
                        : v(e)
                          ? e.split(/[ ,]/)
                          : b(e)
        ...
        ds = function (o, n) {
            ...
            o.on("init", function () {
                o.on("nodechange", function (e) {
                    var t = S.from(
                        o.dom.getParent(o.selection.getStart(), "th,td"),
                    );
                    (r = t.bind(function (e) {
                        var t = le.fromDom(e);
            ...
            var s = function (e, t, n, r) {
                    ...
                    for (
                        l.nextSibling.innerHTML = t + 1 + " x " + (n + 1),
                            f && (t = 9 - t),
                            i = 0;
                        i < 10;
                        i++
                              ...
                              menu: [
                                  {
                                      ...
                                      onmousemove: function (e) {
                                          ...
                                          "A" === r.tagName.toUpperCase() &&
                                              ((t = parseInt(
                                                  r.getAttribute("data-mce-x"),
                                                  10,
                                              )),
                                              (n = parseInt(
                                                  r.getAttribute("data-mce-y"),
                                                  10,
                                              )),
                                              (this.isRtl() ||
                                                  "tl-tr" ===
    ...
    i.add("table", function (t) {
        var n,
            ...
            i =
                ((n = t),
                {
                    get: function () {
                        var e = ia(n);
                        return yr(e, Tr.selectedSelector()).fold(
                            function () {
                                return n.selection.getStart() === undefined
                                    ? Er.none()
                                    : Er.single(n.selection);
                            },
                            function (e) {
        ...
        return (
            ...
            t.on("PreInit", function () {
                (t.serializer.addTempAttr(Tr.firstSelected()),
                    t.serializer.addTempAttr(Tr.lastSelected()));
            }),
