!(function () {
    ...
    var e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        ...
        u = function (e, t) {
            return (
                !!o(t) && !(!e.isBlock(t.nextSibling) || o(t.previousSibling))
            );
        },
        m = function (e, t, n) {
            var o = e.isEmpty(t);
            return (
                !(
                    n && 0 < e.select("span[data-mce-type=bookmark]", t).length
                ) && o
            );
        },
        g = function (e, t) {
                ...
                ((t = o = r[e ? "startContainer" : "endContainer"]),
                    ...
                    t &&
                        (1 === t.nodeType &&
                            ((n = (function (e) {
                                for (
                                    var t = e.parentNode.firstChild, n = 0;
                                    t;
                ...
                for (; (o = t.firstChild); ) {
                    ...
                    (i ||
                        ...
                        f(o, s)
                            ...
                            : n
                              ? (r || ((r = P.create(n)), a.appendChild(r)),
                                r.appendChild(o))
                              : a.appendChild(o));
                }
            return (
            ...
            for (
                r = t[n ? "startContainer" : "endContainer"],
                    ...
                    1 === r.nodeType &&
                        (r =
                            r.childNodes[
                                Math.min(i, r.childNodes.length - 1)
                            ] || r),
                    ...
                    ("DT" === t.nodeName
                        ...
                        : (n = t.previousSibling) && h(n)
                          ...
                          : n && "LI" === n.nodeName && h(n.lastChild)
                            ? (n.lastChild.appendChild(t),
                              ce(t.lastChild, n.lastChild),
                              1)
                            : (n = t.nextSibling) && h(n)
