(function () {
    var autosave = (function () {
        ...
        var getAutoSaveInterval = function (editor) {
            return $_ed5ijr9djkmcduev.parse(
        ...
        var hasDraft = function (editor) {
            var time =
                parseInt(
                    global$1.getItem(
                        $_c041qd9cjkmcdueu.getAutoSavePrefix(editor) + "time",
                    ),
                    10,
                ) || 0;
            if (
                new Date().getTime() - time >
                $_c041qd9cjkmcdueu.getAutoSaveRetention(editor)
            ) {
        ...
        global$3._beforeUnloadHandler = function () {
            ...
            global$2.each(global$3.get(), function (editor) {
                ...
                if (
                    !msg &&
                    editor.isDirty() &&
                    $_c041qd9cjkmcdueu.shouldAskBeforeUnload(editor)
                ) {
