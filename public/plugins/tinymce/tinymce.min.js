...
!(function () {
    ...
    var fe,
        ...
        Re = {
            ...
            contentEditable:
                !f ||
                m ||
                534 <= parseInt(ce.match(/AppleWebKit\/(\d*)/)[1], 10),
            transparentSrc:
        ...
        qe = function (e, t) {
            ...
            return (
                ...
                !(o.stopImmediatePropagation = function () {
                    ((o.isImmediatePropagationStopped = Ue),
                        o.stopPropagation());
                }) ==
                    ((r = o).isDefaultPrevented === Ue ||
                        r.isDefaultPrevented === Fe) &&
        ...
        if (Te && !r) {
            if ((o = xt.exec(e)))
                if ((a = o[1])) {
                    ...
                    if (o[2])
                        return (ot.apply(n, t.getElementsByTagName(e)), n);
        ...
        function (e) {
            ...
            return s !== Ee && 9 === s.nodeType && s.documentElement
                ? ((Se = (Ee = s).documentElement),
                  ...
                  (me.getElementsByClassName = Ct.test(
    ...
    (Tt.attr = function (e, t) {
        ...
        var n = ge.attrHandle[t.toLowerCase()],
            r =
                n && et.call(ge.attrHandle, t.toLowerCase())
                    ? n(e, t, !Te)
                    : undefined;
        return r !== undefined
            ? r
                ...
                contains: At(function (t) {
                    return (
                        ...
                        function (e) {
                            return (
                                -1 <
                                (e.textContent || e.innerText || pe(e)).indexOf(
                                    t,
                                )
                            );
                        }
        ...
        return (
            ...
            At(function (e, t, n, r) {
                ...
                if (e) {
                    ...
                    ((d = Ft(d === t ? d.splice(c, d.length) : d)),
    ...
    var Sn = function (n) {
        ...
        Lr = {
            ...
            one: function (e, t) {
                ...
                return Pr(n)
                    ? A.none()
                    : A.from(n.querySelector(e)).map(er.fromDom);
            },
        },
        Ir = function (e, t) {
            return e.dom() === t.dom();
    ...
    var Ei = function (t, n) {
        ...
        Ii = function (e, t, n) {
            ...
            return (
                0 < r.length ? hr.set(e, t, r.join(" ")) : hr.remove(e, t),
                !1
            );
        },
        Mi = function (e) {
    ...
    var Yi,
            ...
            e.on("init", function () {
                e.serializer.addNodeFilter("span", function (e) {
                    F(e, function (t) {
                        var e;
                        ((e = t),
                        A.from(e.attributes.map[ia()]).bind(n.lookup)).each(
                            function (e) {
        ...
        Ta = function (e) {
            return (
                Sa(e) && (e = e.parentNode),
                Ea(e) && e.hasAttribute("data-mce-caret")
            );
        },
        ka = function (e) {
        ...
        ja = function (e) {
            return (
                !Ha(e) &&
                (Ua(e) ? !za(e.parentNode) : Va(e) || Fa(e) || qa(e) || $a(e))
            );
        },
        $a = function (e) {
            return (
                !1 ===
                    ((t = e),
                    Do.isElement(t) &&
                        "true" === t.getAttribute("unselectable")) && Ma(e)
            );
            var t;
        },
        Wa = function (e, t) {
        ...
        Qa = function (e, t) {
            return (
                e.top > t.bottom ||
                (!(e.bottom < t.top) && Ga(t.bottom - e.top, e, t))
            );
        },
        Za = function (e) {
        ...
        cu = ya.negate(
            Do.matchStyleValues("white-space", "pre pre-line pre-wrap"),
        ),
        lu = Do.isText,
        fu = Do.isBr,
        du = pi.nodeIndex,
    ...
    function wu(t, n, e) {
        ...
        return {
            ...
            toRange: function () {
                var e;
                return (
                    (e = gu(t.ownerDocument)).setStart(t, n),
                    e.setEnd(t, n),
                    e
                );
            },
    ...
    (((Yi = wu || (wu = {})).fromRangeStart = function (e) {
        ...
        (Yi.isAbove = function (e, t) {
            return ru(
                [ee(t.getClientRects()), te(e.getClientRects())],
                Ja,
            ).getOr(!1);
        }),
        (Yi.isBelow = function (e, t) {
            return ru(
                [te(t.getClientRects()), ee(e.getClientRects())],
                Qa,
            ).getOr(!1);
        }),
    ...
    var Nu,
        ...
        qu = function (e, t, n) {
            var r = n.getNode(),
                ...
                i = n.getRng();
            if (Lu(r) || "IMG" === o)
                return { name: o, index: Fu(n.dom, o, r) };
            var a,
                u,
                s,
                c,
    ...
    var Es,
        ...
        Rs = function (e, t, n, r) {
            for (
                ...
                ((s = l),
                (c = f),
                (o = t === Nu.Forwards ? s.next(c) : s.prev(c)));
            ...
            z(
                ...
                function (e, r) {
                    return e.fold(
                        ...
                        function (e) {
                            var t = Math.sqrt(
                                    Math.abs(e.x - u) + Math.abs(e.y - s),
                                ),
                                n = Math.sqrt(
                                    Math.abs(r.x - u) + Math.abs(r.y - s),
                                );
            ...
            return {
                show: function (t, e) {
                    ...
                    if (
                        (l(),
                        (o = e),
                        Do.isElement(o) && /^(TD|TH)$/i.test(o.tagName))
                    )
                        return null;
                    if (!u(e))
                        return (
                    ...
                    return (
                        ...
                        c.get().each(function (e) {
                            t &&
                                pn(e.caret).addClass("mce-visual-caret-before");
                        }),
                        f(),
        ...
        qc = function (e, t, n) {
            ...
            if (((o = n.startContainer), (i = n.startOffset), Ta(o))) {
                if (
                    ...
                    return zc(r);
                if ("after" === a && ((r = o.previousSibling), Nc(r)))
                    return Vc(r);
            }
        ...
        el = function (e, t, n) {
            return e
                ? !Zc(t, n) &&
                      ((r = t),
                      !(!Su.isTextPosition(r) && Do.isBr(r.getNode()))) &&
                      Qc(t) &&
                      Jc(n)
                : !Zc(n, t) && Jc(t) && Qc(n);
            var r;
                  ...
                  ? ja(u)
                      ? A.some(
                            e
                                ? Su.before(u)
                                : ((a = u),
                                  Do.isBr(a) ? Su.before(a) : Su.after(a)),
                        )
                      : ((r = t),
                        (o = u),
        ...
        kl = function (t, e, n, r) {
            ...
            if (
                (o && e[0].wrapper && (o = yl(i, o, "ul,ol").reverse()[0] || o),
                !o)
            )
                for (
                    o = n;
        ...
        _l = function (e, t, n, r) {
            ...
            return (
                ...
                (bl(i.parentNode) || bl(i)) &&
                    3 ===
                        (i = (i = bl(i) ? i : i.parentNode).nextSibling || i)
                            .nodeType &&
                    (a = 0),
                (bl(u.parentNode) || bl(u)) &&
                    3 ===
                        (u =
                            (u = bl(u) ? u : u.parentNode).previousSibling || u)
                            .nodeType &&
                    (s = u.length),
                n[0].inline &&
                    (t.collapsed &&
    ...
    var nf = function (a) {
        ...
        wf = {
            isInlineTarget: function (e, t) {
                var n = bf(e, "inline_boundaries_selector").getOr(
                    "a[href],code",
                );
        ...
        Sf = function (i, a, u) {
            return ru(
                [rl.firstPositionIn(u), rl.lastPositionIn(u)],
                function (e, t) {
                        ...
                        : ((t = u),
                          ...
                          $c(!(n = s), (r = c)).fold(function () {
                              ...
                              : s && Do.isContentEditableFalse(e.getNode())
                                ? td(u, s, c, e)
                                : !1 === s &&
                                    Do.isContentEditableFalse(e.getNode(!0))
                                  ? td(u, s, c, e)
                                  : s && Xc(c)
                ...
                Do.isElement(a) && a.getAttribute("data-mce-caret") === u
                    ? ((t = e),
                      ...
                      t && Do.isContentEditableFalse(n.nextSibling)
                          ...
                          : !1 === t &&
                              Do.isContentEditableFalse(n.previousSibling)
        ...
        ad = function (e) {
            return ja(e.nextSibling)
                ? A.some(
                      ((t = e.nextSibling),
                      Do.isText(t) ? Su(t, 0) : Su.before(t)),
                  )
                : e.nextSibling
        ...
        cd = function (e, t, n) {
            return ((r = e), (o = t), (i = n), r ? sd(o, i) : ud(o, i)).map(
                b(od, n),
            );
            var r, o, i;
        },
            ...
            return e
                ? (function (e) {
                      if (bd(e.previousSibling))
                          return (
                              Cd(e.previousSibling) ||
                                  e.previousSibling.appendData(wa),
                              e.previousSibling
                          );
        ...
        Pd = function (e, t, n) {
            ...
            return Od(e, t, r).bind(function (e) {
                return rl.prevPosition(e, r).isNone()
                    ? A.some(_d.start(e))
                    : A.none();
            });
        },
        Ld = function (e, t, n) {
            var r = wf.normalizeForwards(n);
            return Od(e, t, r).bind(function (e) {
                return rl.nextPosition(e, r).isNone()
                    ? A.some(_d.end(e))
                    : A.none();
            });
        },
                        ...
                        em(a) &&
                            ...
                            (function (e, t) {
                                if (
                                    ...
                                    Su.isTextPosition(n) &&
                                        ...
                                        (Zd(
                                            e,
                                            os.removeAndReposition(t.get(), n),
                                        ),
                                        t.set(null));
                                }
                            })(a, u),
                            (function (n, r, o, e) {
                                if (r.selection.isCollapsed()) {
                                    var t = U(e, n);
                                    F(t, function (e) {
                                        var t = Su.fromRangeStart(
                                            r.selection.getRng(),
                                        );
                                        Wd(n, r.getBody(), t).bind(
                                            function (e) {
                                                return nm(r, o, e);
                                            },
                                        );
                        ...
                        ? wf
                              ...
                              .map(function (e) {
                                  return (
                                      ...
                                      !!ru(
                                          [
                                              rl.firstPositionIn(o),
                                              rl.lastPositionIn(o),
                                          ],
                                          function (e, t) {
                                              var n = wf.normalizePosition(
                                                      !0,
                                                      e,
                                                  ),
                                                  r = wf.normalizePosition(
                                                      !1,
                                                      t,
                                                  );
                                              return rl
                ...
                return Bf(e)
                    ...
                    : ((t = a),
                      ...
                      rl.navigate(r, t.getBody(), i).bind(function (e) {
                          return Lm(n, er.fromDom(e.getNode())).map(
                              function (e) {
                                  return !1 === Fr.eq(e, o);
                              },
                          );
    ...
    var qg,
        ...
        tp = function (e, t) {
            return "selectionchange" === t
                ? e.getDoc()
                : !e.inline &&
                    /^mouse|touch|click|contextmenu|drop|dragover|dragend/.test(
                        t,
                    )
                  ? e.getDoc().documentElement
                  : e.settings.event_root
                    ? (e.eventRoot ||
                          (e.eventRoot = ep.select(e.settings.event_root)[0]),
                      e.eventRoot)
                    : e.getBody();
        },
        np = function (e, t, n) {
            ...
            unbindAllNativeEvents: function () {
                ...
                if (t.delegates) {
                    for (e in t.delegates)
                        t.dom.unbind(tp(t, e), e, t.delegates[e]);
                    delete t.delegates;
                }
                (!t.inline &&
                    n &&
        ...
        var a = {},
            ...
            u = function (e) {
                    ...
                    e in cp
                        ...
                        : /^[0-9]{2,}$/.test(e)
                          ...
                          : ((r.charCode = e.charCodeAt(0)),
                            (r.keyCode =
                                sp[e] || e.toUpperCase().charCodeAt(0)));
                }),
                (t = [r.keyCode]),
                cp))
                    r[n] ? t.push(n) : (r[n] = !1);
                return (
                    (r.id = t.join(",")),
                    r.access &&
                        ((r.alt = !0), Re.mac ? (r.ctrl = !0) : (r.shift = !0)),
                    r.meta &&
                        (Re.mac
                            ? (r.meta = !0)
                            : ((r.ctrl = !0), (r.meta = !1))),
                ...
                }),
                {
                    ...
                    removeByUri: function (t) {
                        n = jt.filter(n, function (e) {
                            return (
                                e.blobUri() !== t ||
                                (ue.revokeObjectURL(e.blobUri()), !1)
                            );
                        });
                    },
                    destroy: function () {
            ...
            ((t = pi.DOM),
                ...
                (r = function (e) {
                    ...
                    if (p.element && !p.dragging && 10 < m) {
                        if (
                            h
                                .fire("dragstart", { target: p.element })
                                .isDefaultPrevented()
                        )
                            return;
    ...
    var Ah = function (o, i, a, e, u, t) {
        ...
        zh = function (e, t, n) {
            var r,
                ...
                f = kh(
                    ((o = e),
                    jt.filter(jt.toArray(o.getElementsByTagName("*")), Nc)),
                ),
                ...
                v = function (e, t, n, r) {
                    return (
                        ...
                        g
                            ...
                            .isDefaultPrevented()
                            ? null
                            : (r && g.selection.scrollIntoView(t, -1 === e),
                              o.show(n, t))
                    );
                },
                b = function (e, t) {
                                  ...
                                  ? ((l = f = n.cloneNode(!0)),
                                    (s = g.fire("ObjectSelected", {
                                        ...
                                        : ((r = na(
                                          ...
                                          r[0].focus(),
                                          (o =
                                              g.selection.getSel()).removeAllRanges(),
                                          o.addRange(e),
                                          F(
                                              Ki(
                                                  er.fromDom(g.getBody()),
                    ...
                    ((function () {
                        ...
                        ((r = !1),
                            ...
                            g.on("AfterSetSelectionRange", function (e) {
                                ...
                                (y(n) ||
                                    "mcepastebin" ===
                                        n.startContainer.parentNode.id ||
                                    C(),
        ...
        return {
            parse: function (e) {
                ...
                for (
                    ...
                    if (
                        (R < t.index && q(O(e.substr(R, t.index - R))),
                        (n = t[6]))
                    )
                ...
                for (
                    R < e.length && q(O(e.substr(R))), o = D.length - 1;
                    0 <= o;
                    o--
                )
    ...
    var Qh = Jh,
        ...
        vv = function (e) {
            ...
            return (
                dv(t, hv(e)),
                F(Ki(t, "*[data-mce-bogus]"), Ri.unwrap),
                fv(t)
            );
        },
        bv = function (n) {
                    ...
                    for (a in c)
                        if (c.hasOwnProperty(a)) {
                            ...
                            if (
                                ...
                                !Ev(
                                    u,
                                    vl.normalizeStyleValue(
                                        e,
                                        vl.replaceVars(c[a], i),
                                        a,
                                    ),
                                )
                            )
            ...
            r.collapsed ||
                ...
                Kv(
                    Wv(Wv(n, t), function (e) {
                        return (
                            t(e.previousSibling) &&
                            -1 !== jt.indexOf(n, e.previousSibling)
                        );
                    }),
                    function (e) {
                        var t, n;
    ...
    var Xv = function (e, t) {
        ...
        nb = function (e, n, r, o, i) {
            ...
            if (
                ...
                !(
                    ...
                    Jv(l, f.block) ||
                    (f.selector
                        ? Do.isElement(l) && c.is(l, f.selector)
                        : void 0) ||
            ...
            return "none" !== n.remove
                ? ((d = e),
                  ...
                  (g.selector && g.inline && !Jv(g.inline, m)) ||
                      v.remove(m, 1),
                  !0)
                : void 0;
        },
                ...
                o = function (e) {
                    var n,
                        ...
                        u =
                            ...
                            (i = f),
                            Gv(
                                vl.getParents(n.dom, t.parentNode).reverse(),
                                function (e) {
                                    var t;
                                    a ||
                                        "_start" === e.id ||
                        ...
                        Gv(e, function (e) {
                            (g(e),
                                Do.isElement(e) &&
                                    ...
                                    e.parentNode &&
                                    "underline" ===
                                        vl.getTextDecoration(u, e.parentNode) &&
                                    nb(
                                        s,
                                        {
                                            deep: !1,
            ...
            t.styles &&
                ...
                cb(
                    ...
                    fb(
                        e,
                        "backgroundColor",
                        vl.replaceVars(t.styles.backgroundColor, n),
                    ),
                );
        },
        vb = function (e, t, n, r) {
                        ...
                        Dl(s, e, function (e) {
                            var a,
                                u = function (e) {
                                    ...
                                    if (b.wrapper && Rv.matchNode(g, e, p, h))
                                        a = 0;
                                    else {
                                        if (
                                            m &&
                            ...
                            Nb(r, function (t) {
                                return a.formatter.matchNode(
                                    ...
                                    ? (u[n] ||
                                      ...
                                      (o[n] = e),
                                      !1)
                                    : !Rv.matchesUnInheritedFormatSelector(
                                          a,
                                          t,
                                          n,
                                      ) && void 0;
        ...
        Ab = function (e, t) {
            ...
            return e && e.length
                ? ((o = e[0]),
                  (n = g(o)),
                  (r = kb.create("div")).appendChild(
                      p(n, e.slice(1), o.siblings),
                  ),
                  r)
                : "";
        },
        ...
        Wb = (function () {
            ...
            return (
                ...
                (a.prototype.empty = function () {
                    var e, t, n;
                    if (this.firstChild) {
                        for (e = [], n = this.firstChild; n; n = $b(n, this))
                            e.push(n);
                        for (t = e.length; t--; )
                            (n = e[t]).parent =
                                n.firstChild =
            ...
            e = {
                ...
                addAttributeFilter: function (e, n) {
                    ey(ty(e), function (e) {
                        ...
                        for (t = 0; t < _.length; t++)
                            if (_[t].name === e)
                                return void _[t].callbacks.push(n);
                ...
                parse: function (e, a) {
                    ...
                    var g = k.getNonEmptyElements(),
                        ...
                        w = /^[ \t\r\n]+$/;
                    f =
                        b.hasOwnProperty(a.context) ||
                        b.hasOwnProperty(T.root_name);
                    var N = function (e, t) {
                            var n,
                                r = new Wb(e, t);
                            return (
                                e in A &&
                                    ((n = R[e]) ? n.push(r) : (R[e] = [r])),
                                r
                            );
                        },
                        E = function (e) {
    ...
    var ly = cy,
            ...
            var R = function (e) {
                ...
                O = function (e) {
                    ...
                    ((t = e.screenX - d),
                        ...
                        (t = _.scrollWidth - x) + (n = _.scrollHeight - w) !=
                ...
                P = function () {
                    ...
                    (e("width", y),
                        ...
                        T !== S &&
                            (N.unbind(T, "mousemove", O),
                            N.unbind(T, "mouseup", P)),
                        N.remove(s),
                        N.remove(c),
                        o(u),
                        Gg(a, u, y, C),
                        ...
                        B(e) && !n.isDefaultPrevented()
                            ? E(l, function (n, e) {
                                  ...
                                  ((t = N.get("mceResizeHandle" + e)) &&
                                      ...
                                      N.setStyles(t, {
                                          left:
                                              r * n[0] + g - t.offsetWidth / 2,
                                          top:
                                              o * n[1] + p - t.offsetHeight / 2,
                                      }));
                              })
                            : L(),
                ...
                try {
                    ...
                    r = (function (e, n, t) {
                        ...
                        if (
                            ...
                            0 <
                                (i = (i = Yt.toArray(o.getClientRects())).sort(
                                    function (e, t) {
                                        return (
                                            (e = Math.abs(
                                                Math.max(
        ...
        Oy = function (e, t) {
            ...
            return 0 < o.length
                ? By(e, o)
                : ((n = e),
                  0 < (r = t).length && r[0].collapsed ? Ry() : Dy(n, r[0]));
        },
        Py = function (e, t) {
            var n,
                r = e.selection.getRng(),
                    ...
                    getSelectedBlocks: function (e, t) {
                        return (function (e, t, n, r) {
                            ...
                            if (
                                ((i = e.getRoot()),
                                (n = e.getParent(
                                    n || My(i, t, t.collapsed),
                                    e.isBlock,
                                )),
                                (r = e.getParent(
                                    r || Fy(i, t, t.collapsed),
                                    e.isBlock,
                                )),
                                n && n !== i && a.push(n),
                                n && r && n !== r)
                              ...
                              : S()
                                ...
                                : S(!0)
                                  ...
                                  : ((t = ((b = N),
                                    ...
                                    y.setEnd(
                                        b.endContainer,
                                        NC(!1, b.endContainer, b.endOffset),
                                    ),
        ...
        KC = function (r) {
            r.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() &&
                    ((t = r),
                    (n = e),
                    nC([{ keyCode: Hh.SPACEBAR, action: tC(WC, t) }], n).each(
                        function (e) {
                            n.preventDefault();
                        },
                    ));
        ...
        ox = function (t, e) {
            ...
            (f.inline || (t.getElement().style.visibility = t.orgVisibility),
                ...
                f.browser_spellcheck ||
                    f.gecko_spellcheck ||
                    ((m.body.spellcheck = !1),
                    nx.setAttrib(n, "spellcheck", "false")),
                (t.quirks = QC(t)),
                t.fire("PostRender"),
    ...
    var Sx = function (e, t, n) {
        ...
        Tx = function (e, t) {
            (t(e),
                e.firstChild && Tx(e.firstChild, t),
                e.next && Tx(e.next, t));
        },
        kx = function (e, t, n) {
        ...
        zx = function (e, t, n) {
            ...
            ((r = l),
                ...
                l.setDirty(!1),
                (l.plugins = {}),
                (l.documentBaseURI = new Ex(t.document_base_url, {
                    base_uri: d,
                })),
                (l.baseURI = d),
                (l.contentCSS = []),
    ...
    Ix(
        (zx.prototype = {
            ...
            getElement: function () {
                return (
                    this.targetElm || (this.targetElm = Lx.get(this.id)),
                    this.targetElm
                );
            },
            getWin: function () {
    ...
    var Vx,
        ...
        Jx = function (e, t) {
            (e.focusedEditor === t.editor && (e.focusedEditor = null),
                e.activeEditor ||
                    (Kx.unbind(document, "focusin", Vx), (Vx = null)));
        },
        Qx = function (e) {
                                    ...
                                    if (t.types)
                                        return (
                                            ow(t.types, function (e) {
                                                n = n.concat(
                                                    nw.select(e.selector),
                                                );
                                            }),
                                            n
                                        );
                                    if (t.selector)
                                        return nw.select(t.selector);
                    ...
                    if (!k(e))
                        return (
                            ...
                            D(r.get(n.id))
                                ? null
                                : (dw(n) &&
                                      r.fire("RemoveEditor", { editor: n }),
                                  0 === cw.length &&
                                      nw.unbind(window, "beforeunload", qx),
                                  n.remove(),
                                  fw(0 < cw.length),
                                  n)
                        );
            ...
            execCommand: function (e, t, n) {
                ...
                switch (e) {
                    case "mceAddEditor":
                        return (
                            this.get(n) ||
                                new zx(n, this.settings, this).render(),
                            !0
                        );
    ...
    _w.extend = hw = function (n) {
        ...
        n.Defaults &&
            o.Defaults &&
            (n.Defaults = Aw({}, o.Defaults, n.Defaults)),
        n))
