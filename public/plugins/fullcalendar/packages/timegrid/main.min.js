            ...
            return (
                ...
                (i.prototype.processOptions = function () {
                    ...
                    ((i = t.createDuration(i)),
                        ...
                        null === (e = t.wholeDivideDurations(i, n)) &&
                            ((n = i), (e = 1)),
                        (this.slotDuration = i),
                        (this.snapDuration = n),
                        (this.snapsPerSlot = e),
                ...
                (i.prototype.renderSlatRowHtml = function (e) {
                    for (
                        ...
                        ((r = o.add(d, c)),
                            (i =
                                null !==
                                t.wholeDivideDurations(h, this.labelInterval)),
                            (n =
    ...
    var y = (function (e) {
        function r(r, i) {
            ...
            return (
                ...
                (n.slicer = new S()),
                (n.timeGrid = i),
                r.calendar.registerInteractiveComponent(n, {
                    el: n.timeGrid.el,
                }),
                n
            );
        ...
        return (
            ...
            (r.prototype.render = function (e) {
                var t = e.dateProfile,
                    r = e.dayTable,
                    i = (this.dayRanges = this.buildDayRanges(
                        r,
                        t,
                        this.dateEnv,
                    ));
                this.timeGrid.receiveProps(
                    o(
                        {},
                        this.slicer.sliceProps(e, t, null, this.timeGrid, i),
                        { dateProfile: t, cells: r.cells[0] },
                    ),
                );
            }),
        ...
        C = (function (e) {
            function i(i, n, o, s) {
                ...
                return (
                    ...
                    a.dayGrid &&
                        (a.simpleDayGrid = new r.SimpleDayGrid(
                            a.context,
                            a.dayGrid,
                        )),
                    a
