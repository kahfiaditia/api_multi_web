...
!(function (e, t) {
    ...
    var s = (function (e) {
        ...
        a = (function (e) {
            function n(n, r, a, o) {
                var l = e.call(this, n, r, a, o) || this;
                ((l.computeDateVars = t.memoize(i)),
                    (l.eventStoreToSegs = t.memoize(l._eventStoreToSegs)));
                var d = (l.eventRenderer = new s(l));
                ...
                for (
                    var c = 0,
                        p = (l.theme.getClass("listView") || "").split(" ");
                    c < p.length;
                    c++
                ) {
                    var h = p[c];
                    h && l.el.classList.add(h);
                }
                return (
            ...
            return (
                ...
                (n.prototype.eventRangeToSegs = function (e, n) {
                    var r,
                        ...
                        a,
                        i = this.dateEnv,
                        o = this.nextDayThreshold,
                        l = e.range,
                        d = e.def.allDay,
                        c = [];
                    for (r = 0; r < n.length; r++)
                        if (
                            (s = t.intersectRanges(l, n[r])) &&
                            ((a = {
                                component: this,
                                eventRange: e,
                                start: s.start,
                                ...
                                isStart:
                                    e.isStart &&
                                    s.start.valueOf() === l.start.valueOf(),
                                isEnd:
                                    e.isEnd &&
                                    s.end.valueOf() === l.end.valueOf(),
                                dayIndex: r,
                            }),
                            c.push(a),
                            !a.isEnd &&
                                !d &&
                                r + 1 < n.length &&
                                l.end < i.add(n[r + 1].start, o))
                        ) {
                            ((a.end = l.end), (a.isEnd = !0));
                            break;
                        }
                    return c;
                }),
                ...
                (n.prototype.renderSegList = function (e) {
                    ...
                    for (n = 0; n < a.length; n++)
                        if ((r = a[n]))
                            for (
                                o.appendChild(
                                    this.buildDayHeaderRow(this.dayDates[n]),
                                ),
                ...
                (n.prototype.groupSegsByDay = function (e) {
                    ...
                    for (t = 0; t < e.length; t++)
                        (r[(n = e[t]).dayIndex] || (r[n.dayIndex] = [])).push(
                            n,
                        );
                    return r;
                }),
