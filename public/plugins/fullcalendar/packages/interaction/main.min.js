...
!(function (e, t) {
    ...
    var d = (function () {
        ...
        u = (function (e) {
            function n(n, r) {
                return (
                    e.call(this, new t.ElementScrollController(n), r) || this
                );
            }
            return (
                r(n, e),
    ...
    function S(e, n) {
        return (
            (!e && !n) ||
            (Boolean(e) === Boolean(n) &&
                t.isDateSpansEqual(e.dateSpan, n.dateSpan))
        );
    }
    var y = (function (e) {
            function n(n) {
                ...
                ((r.handlePointerDown = function (e) {
                    var t = r.dragging;
                    t.setIgnoreMove(
                        !r.component.isValidDateDownEl(t.pointer.downEl),
                    );
                }),
            ...
            function n(n) {
                ...
                ((r.dragSelection = null),
                    ...
                    (r.handlePointerUp = function (e) {
                        r.dragSelection &&
                            (r.component.calendar.triggerDateSelect(
                                r.dragSelection,
                                e,
                            ),
                            (r.dragSelection = null));
        ...
        function n(r) {
            ...
            ((o.subjectSeg = null),
                ...
                (o.handlePointerDown = function (e) {
                    ...
                    ((o.relevantEvents = t.getRelevantEvents(
                        s.state.eventStore,
                        d,
                    )),
                        (a.minDistance = e.isTouch
                            ? 0
                            : i.opt("eventDragMinDistance")),
                        (a.delay =
                    ...
                    var g =
                        i.isValidSegDownEl(n) &&
                        !t.elementClosest(n, ".fc-resizer");
                    (a.setIgnoreMove(!g),
                        (o.isDragging =
                            g &&
                            e.subjectEl.classList.contains("fc-draggable")));
                }),
                        ...
                        if (e) {
                            ...
                            (u.opt("editable") && u.opt("droppable"))
                                ? (s = (function (e, n, r) {
                                      ...
                                      i,
                                      e,
                                      l.pluginSystem.hooks
                                          .eventDragMutationMassagers,
                                  )) &&
                                  ((c = t.applyMutationToEventStore(
                                      r,
                                      l.eventUiBases,
                                      s,
                                      l,
                            ...
                            if (l === n) {
                                ...
                                (n.publiclyTrigger("eventLeave", [
                                    ...
                                    n.dispatch({
                                        ...
                                        instances:
                                            o.mutatedRelevantEvents.instances,
                                    }),
                                    l.dispatch({
                                        type: "MERGE_EVENTS",
            ...
            var s = (o.hitDragging = new m(
                o.dragging,
                t.interactionSettingsStore,
            ));
            return (
                    ...
                    ((r.dragging.minDistance = t.opt("eventDragMinDistance")),
                        r.dragging.setIgnoreMove(
                            !r.component.isValidSegDownEl(e.origEvent.target) ||
                                (e.isTouch &&
                                    r.component.props.eventSelection !==
                ...
                (r.handleHitUpdate = function (e, n, o) {
                    ...
                    (e &&
                        (d = (function (e, n, r, o, a) {
                            ...
                            if (r) {
                                if (l.add(o.start, d) < o.end)
                                    return ((g.startDelta = d), g);
                            } else if (l.add(o.end, d) > o.start)
                                return ((g.endDelta = d), g);
                            return null;
                        })(
                            s,
                            e,
    ...
    var C = (function () {
            function e(e, n) {
                ...
                ((i.touchScrollAllowed = !1),
                    null != n.itemSelector &&
                        (i.pointer.selector = n.itemSelector),
