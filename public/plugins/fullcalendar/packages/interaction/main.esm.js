...
var PointerDragging = /** @class */ (function () {
    function PointerDragging(containerEl) {
        ...
        this.handleScroll = function (ev) {
            if (!_this.shouldIgnoreMove) {
                var pageX =
                    window.pageXOffset - _this.prevScrollX + _this.prevPageX;
                var pageY =
                    window.pageYOffset - _this.prevScrollY + _this.prevPageY;
...
var WindowScrollGeomCache = /** @class */ (function (_super) {
    ...
    function WindowScrollGeomCache(doesListening) {
        return (
            _super.call(this, new WindowScrollController(), doesListening) ||
            this
        );
    }
            ...
            if (hit) {
                ...
                if (
                    ...
                    if (mutation) {
                        ...
                        if (
                            !receivingComponent.isInteractionValid(interaction)
                        ) {
                            isInvalid = true;
                            mutation = null;
...
var EventDragging$1 = /** @class */ (function (_super) {
                ...
                calendar.publiclyTrigger("eventResize", [
                    {
                        el: _this.draggingSeg.el,
                        startDelta:
                            _this.validMutation.startDelta || createDuration(0),
                        endDelta:
                            _this.validMutation.endDelta || createDuration(0),
                        prevEvent: eventApi,
                        event: new EventApi( // the data AFTER the mutation
                            calendar,
                            mutatedRelevantEvents.defs[eventDef.defId],
    ...
    EventDragging.prototype.querySeg = function (ev) {
        return getElSeg(
            elementClosest(ev.subjectEl, this.component.fgSegSelector),
        );
    };
    return EventDragging;
})(Interaction);
    ...
    function ExternalElementDragging(dragging, suppliedDragMeta) {
        ...
        this.handleHitUpdate = function (hit, isFinal, ev) {
            ...
            if (hit) {
                ...
                if (
                    _this.canDropElOnCalendar(ev.subjectEl, receivingCalendar)
                ) {
