...
!(function (e, t) {
    ...
    function r(e, n, r) {
        ...
        return (
            "string" == typeof r ? (i.innerHTML = r) : null != r && s(i, r),
            i
        );
    }
    function i(e) {
                ...
                for (
                    var l = 0,
                        c = be(
                            ...
                            t,
                            n.dateEnv,
                            n.pluginSystem.hooks.recurringTypes,
                        );
                    l < c.length;
                    l++
                ) {
            ...
            return (
                (e.prototype.format = function (e, t) {
                    return t.cmdFormatter(
                        this.cmdStr,
                        st(e, null, t, this.separator),
                    );
                }),
                (e.prototype.formatRange = function (e, t, n) {
                    return n.cmdFormatter(
                        this.cmdStr,
                        st(e, t, n, this.separator),
                    );
                }),
                e
            );
        ...
        ct = (function () {
            ...
            return (
                ...
                (e.prototype.setAllDay = function (e, t) {
                    ...
                    (null == r &&
                        (r = this._calendar.opt("allDayMaintainDuration")),
    ...
    function Et(e, t, n, r, i) {
        ...
        return (
            ...
            t.allDay &&
                (u.range = { start: B(u.range.start), end: B(u.range.end) }),
            ...
            !(
                ...
                !(function (e, t, n, r) {
                    ...
                    for (var p in s) {
                        ...
                        for (var E in ("function" != typeof m && (m = null),
                        d)) {
                            var S = d[E];
                            if (Fe(v, S.range)) {
    ...
    function Ht(e, t, n) {
        ...
        return {
            startEditable:
                null != r.startEditable ? r.startEditable : r.editable,
            durationEditable:
            ...
            return (
                (e.prototype.splitProps = function (e) {
                    var t = this,
                        ...
                        l = {};
                    for (var c in ((this.eventUiBuilders = Re(
                        n,
                        function (e, n) {
        ...
        tn = (function (e) {
            ...
            return (
                ...
                (t.prototype.on = function (e, t) {
                    return (
                        nn(this._handlers || (this._handlers = {}), e, t),
                        this
                    );
                }),
                (t.prototype.one = function (e, t) {
                    return (
                        nn(this._oneHandlers || (this._oneHandlers = {}), e, t),
                        this
                    );
                }),
    ...
    var on = (function () {
        ...
        ln = (function (e) {
            function t(t, n) {
                var i =
                    e.call(this, r("div", { className: "fc-scroller" })) ||
                    this;
                return (
                    (i.overflowX = t),
                    (i.overflowY = n),
                ...
                if (!this.addedHash[e.id]) {
                    ...
                    this.hooks =
                        ...
                        (o = e),
                        {
                            ...
                            viewContainerModifiers:
                                i.viewContainerModifiers.concat(
                                    o.viewContainerModifiers,
                                ),
                            eventDropTransformers:
                                i.eventDropTransformers.concat(
                            ...
                            componentInteractions:
                                i.componentInteractions.concat(
        ...
        recurringTypes: [
            {
                parse: function (e, t, n) {
                    ...
                    if (s) {
                        ...
                        return (
                            "duration" in t &&
                                ((l = J(t.duration)), delete t.duration),
                            !l &&
                                a.startTime &&
                                a.endTime &&
                                ((r = a.endTime),
                ...
                return (
                    r.duration
                        ...
                        : (n = this.options.dayCount)
                          ? ((a = "day"),
                            (s = this.buildRangeFromDayCount(e, t, n)))
                ...
                return (
                    c ||
                        ((i = this.options.dateIncrement)
                            ? ((o = J(i)),
                              (c = te(o) < te(n) ? ne(o, !Q(i)).unit : r))
                            : (c = r)),
                    ee(n) <= 1 &&
                        this.isHiddenDay(a) &&
                        (a = B((a = this.skipHiddenDays(a, t)))),
                    d(),
                    this.trimHiddenDays(u) ||
            ...
            var r = (function (e, t) {
                ...
                i = (function (e, t, n, r, i) {
                    ...
                    switch (t.type) {
                        ...
                        case "SET_DATE":
                            (e.activeRange &&
                                Ze(e.currentRange, t.dateMarker)) ||
    ...
    var pr = (function (e) {
            function t(t, n) {
                ...
                return (
                    ...
                    (i._updateTitle = qt(i.updateTitle, null, [
                        i._renderLayout,
                    ])),
                    (i._updateActiveButton = qt(i.updateActiveButton, null, [
                        i._renderLayout,
                    ])),
                    (i._updateToday = qt(i.updateToday, null, [
                        i._renderLayout,
                    ])),
                    ...
                    for (
                        var o = {
                            ...
                            s = this.buildViewPropTransformers(
                                this.calendar.pluginSystem.hooks
                                    .viewPropsTransformers,
                            );
                        a < s.length;
                        a++
    ...
    var Dr = (function () {
        function e(e, t) {
            ...
            ((this.parseRawLocales = Ye(On)),
                ...
                (this.buildEventUiSingleBase = Ye(
        ...
        return (
            ...
            (e.prototype.renderComponent = function (e) {
                ...
                var a = (this.renderableEventStore =
                    ...
                    l = (this.eventUiBases = this.buildEventUiBases(
                        a.defs,
                        s,
                        u,
                    ));
            ...
            (e.prototype.handleOptions = function (e) {
                ...
                ((this.defaultAllDayEventDuration = J(
                    e.defaultAllDayEventDuration,
                )),
                    (this.defaultTimedEventDuration = J(
    ...
    function wr(e) {
        return new (this.pluginSystem.hooks.themeClasses[e.themeSystem] || br)(
            e,
        );
    }
    function Rr(e) {
    ...
    var Mr = (function (e) {
        ...
        return (
            ...
            (t.prototype.computeEventStartResizable = function (e, t) {
                return (
                    t.durationEditable && this.opt("eventResizableFromStart")
                );
            }),
            ...
            (t.prototype.startNowIndicator = function (e) {
                ...
                this.opt("nowIndicator") &&
                    ...
                    (r =
                        o
                            .add(o.startOf(this.initialNowDate, t), J(1, t))
            ...
            (t.prototype.queryScroll = function () {
                var e = {};
                return (
                    this.props.dateProfile && Se(e, this.queryDateScroll()),
                    e
                );
            }),
            ...
            return (
                ...
                (e.prototype.renderSegs = function (e, t) {
                    ...
                    (i &&
                        ...
                        (this.segsByType[e] = r),
                        "bgEvent" === e &&
                            this.context.view.triggerRenderedSegs(r, !1),
                ...
                (e.prototype.renderSegHtml = function (e, t) {
                    ...
                    return (
                        "highlight" !== e &&
                            ...
                            (n = {
                                "background-color":
                                    t.eventRange.ui.backgroundColor,
                            }),
                        "highlight" !== e &&
                            (r = r.concat(t.eventRange.ui.classNames)),
                        "businessHours" === e
                            ? r.push("fc-bgevent")
            ...
            (u =
                "function" == typeof f.columnHeaderHtml
                    ...
                    : "function" == typeof f.columnHeaderText
                      ...
                      : Ot(c.format(e, i))),
            n
                ? (h = h.concat(Qt(e, t, o, !0)))
                : h.push("fc-" + P[e.getUTCDay()]),
            '<th class="' +
                h.join(" ") +
                '"' +
                (p && n
            ...
            return (
                ...
                (t.prototype.render = function (e) {
                    ...
                    for (
                        ...
                        var s = a[o];
                        r.push(
                            Lr(s, e.dateProfile, n, t.length, i, this.context),
                        );
                    }
        ...
        Ar = (function () {
            ...
            return (
                ...
                (e.prototype.sliceRange = function (e) {
                    ...
                    if (n)
                        for (
                            var i = n.firstIndex, o = n.lastIndex, a = i;
                            a <= o;
            ...
            return (
                ...
                (e.prototype.sliceNowDate = function (e, t) {
                    ...
                    return this._sliceDateSpan.apply(
                        this,
                        [
                            { range: { start: e, end: H(e, 1) }, allDay: !1 },
                            {},
                            t,
                        ].concat(n),
                    );
                ...
                (e.prototype._sliceBusinessHours = function (e, t, n, r) {
                    ...
                    return e
                        ? this._sliceEventStore.apply(
                              this,
                              [
                                  _e(e, Wr(t, Boolean(n)), r.calendar),
                                  {},
                                  t,
                                  n,
                                  r,
    ...
    ((e.Calendar = Dr),
        ...
        (e.compensateScroll = function (e, t) {
            (t.left && y(e, { borderLeftWidth: 1, marginLeft: t.left - 1 }),
                t.right &&
                    y(e, { borderRightWidth: 1, marginRight: t.right - 1 }));
        }),
        ...
        (e.preventSelection = function (e) {
            (e.classList.add("fc-unselectable"),
                e.addEventListener("selectstart", k));
        }),
