...
!(function (d) {
    ...
    var a = function (t, i) {
        ...
        (this.$tableScrollWrapper.attr("data-pattern", this.options.pattern),
            ...
            (this.$focusBtn = null),
            (this.displayAllTrigger =
                "display-all-" + this.id + ".responsive-table"),
    ...
    ((a.DEFAULTS = {
        ...
        addDisplayAllBtn: !0,
        addFocusBtn: !0,
        focusBtnIcon: "fas fa-crosshairs",
        ...
        (a.prototype.displayAll = function (t, i) {
            (this.$displayAllBtn &&
                this.$displayAllBtn.toggleClass("btn-primary", t),
                this.$table.toggleClass("display-all", t),
                this.$tableClone &&
                    this.$tableClone.toggleClass("display-all", t),
        ...
        (a.prototype.updateStickyTableHeader = function () {
            var t,
                ...
                n =
                    a +
                    d(this.options.mainContainer).height() -
                    d(document).height(),
                l = 0;
            ...
            if (
                ...
                if (
                    (i.$stickyTableHeader.scrollLeft(
                        i.$tableScrollWrapper.scrollLeft(),
                    ),
                    (e = l - 1),
                    this.options.mainContainer === window && s < a - o
                        ...
                        : this.options.mainContainer !== window && s < -o
                          ? ((e -= -o - s),
                            i.$stickyTableHeader.addClass("border-radius-fix"))
                          : i.$stickyTableHeader.removeClass(
                                "border-radius-fix",
                            ),
                    t)
                )
                        ...
                        a
                            ...
                            .change(function () {
                                ...
                                (n.$table.hasClass("display-all") &&
                                    ...
                                    n.$tableClone &&
                                        n.$tableClone.removeClass(
                                            "display-all",
                                        ),
                                    n.$displayAllBtn.removeClass(
                                        "btn-primary",
                                    )),
                                    i.each(function () {
                                        var t = d(this);
            ...
            if (!t.data("setup")) {
                ...
                t.find("th, td").each(function () {
                    var t = d(this),
                        i = "",
                        e = t.prop("colSpan");
                    (t.attr("data-org-colspan", e),
                        1 < e && t.addClass("spn-cell"));
                    for (var o = l; o < l + e; o++) {
                        i = i + " " + n.idPrefix + s[o];
                        var a = n.$table
                            .find("#" + n.idPrefix + s[o])
