    ...
    Plugin.prototype = {
        ...
        initTemplate: function () {
            ...
            this.template =
                ...
                "</button>" +
                '<button class="dtp-btn-ok btn btn-info mr-1">' +
                this.params.okText +
                "</button>" +
                '<button class="dtp-btn-cancel btn btn-danger">' +
            ...
            for (var i = 0; i < 12; i++) {
                ...
                var fill =
                    this.currentDate.format(hFormat) == i
                        ...
                        : "transparent";
                var color =
                    this.currentDate.format(hFormat) == i ? "#fff" : "#335276";
        ...
        initMinutes: function () {
            ...
            for (var i = 0; i < 60; i++) {
                if (i % 5 === 0) {
                    ...
                    var color =
                        this.currentDate.format("m") == i ? "#fff" : "#335276";
