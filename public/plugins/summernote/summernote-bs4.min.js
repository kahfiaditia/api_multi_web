...
!(function (a) {
    ...
    var q = function (b, c, d, e) {
        ...
        J = {
            ...
            button: function (a, b) {
                return r.create(
                    '<button type="button" class="note-btn btn btn-secondary btn-sm" tabindex="-1">',
                    function (a, b) {
                        b &&
                            b.tooltip &&
                        ...
                        switch (i.action) {
                            ...
                            case R.resultAction.SumSpanCount:
                                if ("right" === c) {
                                    ...
                                    (k++,
                                        i.baseCell.setAttribute("colSpan", k));
                                } else
                                    a(i.baseCell).before(
                                        "<td" + j + ">" + o.blank + "</td>",
                                    );
        ...
        U = function (b) {
            ...
            for (
                var t = (this.beforeCommand = function () {
                    ...
                    u = (this.afterCommand = function (a) {
                        (s.recordUndo(),
                            a || b.triggerEvent("change", f.html()));
                    }),
                    v = [
                        "bold",
                        "italic",
            ...
            ((this.fontSize = function (b) {
                ...
                if (c && c.isCollapsed()) {
                    ...
                    (t(),
                        a(n.styleNodes(c)).css({ "font-size": b + "px" }),
                        u());
            }),
        ...
        Z = function (b) {
            ...
            ((this.resizeTo = function (a) {
                (f.css("height", a.h),
                    g.css("height", a.h),
                    g.data("cmeditor") &&
                        g.data("cmeditor").setsize(null, a.h));
            }),
                                        ...
                                        d.dropdown({
                                            items: [
                                                ...
                                                '  <div class="note-palette-title">' +
                                                    ...
                                                    "</div>",
                                                "  <div>",
                                                '    <button type="button" class="note-color-reset btn btn-secondary" data-event="backColor" data-value="inherit">',
                                                g.color.transparent,
                                                "    </button>",
                                                "  </div>",
                                                ...
                                                '  <div class="note-palette-title">' +
                                                    ...
                                                    "</div>",
                                                "  <div>",
                                                '    <button type="button" class="note-color-reset btn btn-secondary" data-event="removeFormat" data-value="foreColor">',
