...
!(function (e, t) {
    ...
    m.prototype = {
        ...
        removeValidator: function (e) {
            return (
                this.validators[e] ||
                    o.warn('Validator "' + e + '" is not defined.'),
    ...
    ((y.Form = {
        ...
        (y.Field = {
            ...
            _insertErrorWrapper: function () {
                ...
                var i = this.$element;
                return (
                    this.options.multiple && (i = i.parent()),
        ...
        _submit: function (t) {
            if (!1 !== this._trigger("submit")) {
                ...
                this.$element.trigger(
                    e.extend(e.Event("submit"), { parsley: !0 }),
                );
            }
        },
        validate: function (t) {
                    ...
                    (t.$element
                        ...
                        .each(function (e, i) {
                            ...
                            ("ParsleyField" !== n.__class__ &&
                                ...
                                ("undefined" ==
                                    typeof t.fieldsMappedById[
                                        n.__class__ + "-" + n.__id__
                                    ] &&
                                    ((t.fieldsMappedById[
                                        n.__class__ + "-" + n.__id__
                                    ] = n),
            ...
            validateString: function (t, i, n, r) {
                ...
                ((i = O.asyncValidators[l].url || i),
                    i.indexOf("{value}") > -1
                        ...
                        : (o[r.$element.attr("name") || r.$element.attr("id")] =
                              t));
                var u = e.extend(
                    !0,
                    n.options || {},
                    O.asyncValidators[l].options,
                );
                ((s = e.extend(!0, {}, { url: i, data: o, type: "GET" }, u)),
                    r.trigger("field:ajaxoptions", r, s),
                    (a = e.param(s)),
                    "undefined" == typeof O._remoteCache &&
                        (O._remoteCache = {}));
