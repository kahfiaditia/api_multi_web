                    ...
                    (n = function (t) {
                        ...
                        var r,
                            ...
                            p =
                                ...
                                (l.win.DocumentTouch &&
                                    l.doc instanceof DocumentTouch),
                            d = "",
                            g = " ",
                            x = String,
                            v = "split",
                        ...
                        ((e.svg = !(e.vml = "VML" == e.type)),
                                    ...
                                    : "array" == e
                                      ...
                                      : ("null" == e && null === t) ||
                                        ...
                                        ("array" == e &&
                                            Array.isArray &&
                                            Array.isArray(t)) ||
                                        M.call(t).slice(8, -1).toLowerCase() ==
                                            e;
                            }),
                            (e.angle = function (t, r, i, n, a, s) {
                                ...
                                return (
                                    e.angle(t, r, a, s) - e.angle(i, n, a, s)
                                );
                            }),
                            (e.rad = function (t) {
                                return ((t % 360) * S) / 180;
                            ...
                            (e.deg = function (t) {
                                return (
                                    Math.round((((180 * t) / S) % 360) * 1e3) /
                                    1e3
                                );
                            }),
                            (e.snapTo = function (t, r, i) {
                                if (
                                    ((i = e.is(i, "finite") ? i : 10),
                                    e.is(t, T))
                                ) {
                        ...
                        function xt(t, r, i) {
                            ...
                            for (
                                ...
                                var g = e.findDotsAtSegment.apply(
                                    e,
                                    t.concat(d / l),
                                );
                                ...
                                Ot = function (e) {
                                    for (
                                        ...
                                        (l.win.opera && g.removeChild(f),
                                            ...
                                            (c = r.el.paper.getElementByPoint(
                                                i,
                                                n,
                                            )),
                                            (f.style.display = x),
                        ...
                        ((Yt.drag = function (r, i, n, a, s, o) {
                            function h(h) {
                                ...
                                ((this._drag.x = u + d),
                                    ...
                                    r &&
                                        t.on("raphael.drag.move." + this.id, r),
                        ...
                        ((i.getElementByPoint = function (t, e) {
                            ...
                            for (
                                ;
                                c.parentNode && c != u.parentNode && !c.raphael;
                            ...
                            (Yt.clone = function () {
                                ...
                                var t = this.paper[this.type]().attr(
                                    this.attr(),
                                );
                                return (
                        ...
                        ((Yt.animateWith = function (t, r, i, n, a, s) {
                            ...
                            var o =
                                i instanceof ne ? i : e.animation(i, n, a, s);
                            ...
                            (Yt.status = function (t, e) {
                                var r,
                                    ...
                                    a = 0;
                                if (null != e)
                                    return (ae(t, this, -1, k(e, 1)), this);
                                for (r = Kt.length; a < r; a++)
                                    if (
                                        (i = Kt[a]).el.id == this.id &&
                                        (!t || i.anim == t)
                                    ) {
                        ...
                        for (var ce in ((ue.push = function () {
                            for (
                                var t, e, r = 0, i = arguments.length;
                                r < i;
                                r++
                            )
                                !(t = arguments[r]) ||
                                    (t.constructor != Yt.constructor &&
                                        t.constructor != he) ||
                                    ((this[(e = this.items.length)] =
                                        this.items[e] =
                                            t),
                                    this.length++);
                            return this;
                        ...
                        return (
                            ...
                            (i.print = function (t, r, i, a, s, o, l, h) {
                                ...
                                var u,
                                    ...
                                    g = d;
                                if (
                                    (e.is(a, "string") && (a = this.getFont(a)),
                                    a)
                                ) {
                        ...
                        if (!t || t.vml) {
                            ...
                            ((A.prototype = T),
                                ...
                                (T.getBBox = function () {
                                    ...
                                    if (
                                        this.paper &&
                                        this.paper._viewBoxShift
                                    ) {
                                        var e = {},
                                            r =
                                                1 /
                                                this.paper._viewBoxShift.scale;
                                        return (
                                            (e.x =
                                                t.x -
                                                this.paper._viewBoxShift.dx),
                                            (e.x *= r),
                                            (e.y =
                                                t.y -
                                                this.paper._viewBoxShift.dy),
                                            (e.y *= r),
                                            (e.width = t.width * r),
                                            (e.height = t.height * r),
                                            (e.x2 = e.x + e.width),
                        ...
                        if (!t || t.svg) {
                            ...
                            var x = function (i, n) {
                                ...
                                k = function (i, a) {
                                    ...
                                    for (var d in ((l.style.visibility =
                                        "hidden"),
                                    a))
                                        if (a[e](d)) {
                                ...
                                C = function (t) {
                                    return t.parentNode &&
                                        "a" ===
                                            t.parentNode.tagName.toLowerCase()
                                        ? t.parentNode
                                        : t;
                                },
                                S = function (e, r) {
                            ...
                            ((S.prototype = A),
                                ...
                                (A.remove = function () {
                                    ...
                                    if (!this.removed && e.parentNode) {
                                        var r = this.paper;
                                        for (var i in (r.__set__ &&
                                            r.__set__.exclude(this),
                                ...
                                (t._engine.setViewBox = function (
                                    ...
                                    for (
                                        ...
                                        ((o =
                                            "stroke-width" in c.attrs
                                                ? c.attrs["stroke-width"]
                                                : 1),
        ...
        function (t, e, r) {
            ...
            ((s = "hasOwnProperty"),
                ...
                (g =
                    ...
                    function (t) {
                        return (
                            t instanceof Array || "[object Array]" == p.call(t)
                        );
                    }),
                ((x = function (t, e) {
                    var r,
                    ...
                    for (u.sort(h); u[l] < 0; )
                        if (((r = p[u[l++]]), d.push(r.apply(e, s)), a))
                            return ((a = i), d);
                    for (v = 0; v < y; v++)
                        if ("zIndex" in (r = o[v]))
                            if (r.zIndex == u[l]) {
                    ...
                    for (
                        ...
                        !(function (t) {
                            for (
                                ...
                                n =
                                    ((n = n.n).hasOwnProperty(i[a]) &&
                                        n[i[a]]) ||
                                    (n[i[a]] = { n: {} });
                            for (
                                n.f = n.f || [], a = 0, s = n.f.length;
                                a < s;
                                a++
                            )
                                if (n.f[a] == e) {
