!(function (t, e, s, i) {
    function o(e, o) {
        ((this.w = t(s)),
            ...
            (o = o || a).rootClass !== i &&
                "dd" !== o.rootClass &&
                ((o.listClass = o.listClass
                    ? o.listClass
                    : o.rootClass + "-list"),
                (o.itemClass = o.itemClass
                    ? o.itemClass
                    : o.rootClass + "-item"),
                (o.dragClass = o.dragClass
                    ? o.dragClass
                    : o.rootClass + "-dragel"),
                (o.handleClass = o.handleClass
                    ? o.handleClass
                    : o.rootClass + "-handle"),
                (o.collapsedClass = o.collapsedClass
                    ? o.collapsedClass
                    : o.rootClass + "-collapsed"),
                (o.placeClass = o.placeClass
                    ? o.placeClass
                    : o.rootClass + "-placeholder"),
                (o.noDragClass = o.noDragClass
                    ? o.noDragClass
                    : o.rootClass + "-nodrag"),
                (o.noChildrenClass = o.noChildrenClass
                    ? o.noChildrenClass
                    : o.rootClass + "-nochildren"),
                (o.emptyClass = o.emptyClass
                    ? o.emptyClass
                    : o.rootClass + "-empty")),
    ...
    ((o.prototype = {
        init: function () {
            ...
            (t.each(i, function (e, i) {
                var o = t(i),
                    n = o.parent();
                (s.setParent(o),
                    n.hasClass(s.options.collapsedClass) &&
                        s.collapseItem(n.parent()));
            }),
                ...
                s.el.on("click", "button", function (e) {
                    if (!s.dragEl) {
                        ...
                        ("collapse" === o && s.collapseItem(n),
                            "expand" === o && s.expandItem(n));
                    }
                }));
            var o = function (e) {
                    var i = t(e.target);
            ...
            (n &&
                (s.el[0].addEventListener("touchstart", o, !1),
            ...
            s.el.bind("destroy-nestable", function () {
                (n &&
                    (s.el[0].removeEventListener("touchstart", o, !1),
        ...
        add: function (e) {
            ...
            (e.parent_id !== i &&
                ((o = o.find('[data-id="' + e.parent_id + '"]')),
                delete e.parent_id,
                0 === o.children(s).length &&
                    (o = o.append(this.options.listRenderer("", this.options))),
                (o = o.find(s + ":first")),
        ...
        removeItem: function (e) {
            ...
            t(i)
                ...
                .each(function () {
                    0 === t(this).siblings("." + s.listClass).length &&
                        t(this).remove();
                });
        },
        remove: function (t, e) {
        ...
        asNestedSet: function () {
            function e(i, l, a) {
                var r,
                    ...
                    h = a + 1;
                return (
                    t(i).children(o.listNodeName).children(o.itemNodeName)
                        .length > 0 &&
                        (l++,
                        t(i)
        ...
        toHierarchy: function (e) {
            function s(e) {
                var o = (t(e).attr(i.attribute || "id") || "").match(
                    i.expression || /(.+)[-=_](.+)/,
                );
                if (o) {
                    var n = { id: o[2] };
                    return (
                        t(e).children(i.listType).children(i.items).length >
                            0 &&
                            ((n.children = []),
                            t(e)
                                .children(i.listType)
            ...
            function e(n, l, a) {
                ...
                return (
                    n
                        ...
                        .children(s.options.itemNodeName).length > 0 &&
                        (l++,
                        n
                            .children(s.options.listNodeName)
                    ...
                    (d =
                        l === i + 1
                            ? s.rootID
                            : n
                                  .parent(s.options.listNodeName)
                                  .parent(s.options.itemNodeName)
                                  .data().id),
                    r &&
                        o.push({
                            id: r,
        ...
        setParent: function (e) {
            e.is(this.options.itemNodeName) &&
        ...
        dragStart: function (e) {
            ...
            if (void 0 === l || !1 !== l) {
                (this.placeEl.css("height", o.height()),
                    ...
                    (this.dragEl = t(
                        s.createElement(this.options.listNodeName),
                    ).addClass(
                ...
                for (a = 0; a < d.length; a++)
                    (r = t(d[a]).parents(this.options.listNodeName).length) >
                        this.dragDepth && (this.dragDepth = r);
            }
        },
        createSubLevel: function (e, s) {
            var i = t("<" + this.options.listNodeName + "/>").addClass(
        ...
        setIndexOfItem: function (e, s) {
            ((s = s || []).unshift(e.index()),
                t(e[0].parentNode)[0] !== this.dragRootEl[0]
                    ? this.setIndexOfItem(t(e[0].parentNode), s)
                    : this.dragEl.data("indexOfItem", s));
        },
            ...
            for (var i = this.el, o = s.length - 1, n = 0; n < s.length; n++) {
                if (o === parseInt(n))
                    return void (function (e, i) {
                        0 === s[o]
                            ? t(e).prepend(i.clone(!0))
                            : t(e.children[s[o] - 1]).after(i.clone(!0));
                    })(i, e);
                var l = i[0] ? i[0] : i,
                    a = l.children[s[n]];
        ...
        dragStop: function (t) {
            ...
            var o = this.options.beforeDragStop.call(
                this,
                this.el,
                i,
                this.placeEl.parent(),
        ...
        dragMove: function (i) {
            ...
            if (r.scroll)
                if (void 0 !== e.jQuery.fn.scrollParent) {
                    ...
                    p !== s && "HTML" !== p.tagName
                        ? (r.scrollTriggers.bottom + p.offsetHeight - i.pageY <
                          r.scrollSensitivity
                              ? (p.scrollTop = c = p.scrollTop + r.scrollSpeed)
                              : i.pageY - r.scrollTriggers.top <
                                    r.scrollSensitivity &&
                                (p.scrollTop = c = p.scrollTop - r.scrollSpeed),
                          r.scrollTriggers.right + p.offsetWidth - i.pageX <
                          r.scrollSensitivity
                              ? (p.scrollLeft = c =
                                    p.scrollLeft + r.scrollSpeed)
                              : i.pageX - r.scrollTriggers.left <
                                    r.scrollSensitivity &&
                                (p.scrollLeft = c =
                                    p.scrollLeft - r.scrollSpeed))
                        : (i.pageY - t(s).scrollTop() < r.scrollSensitivity
                              ? (c = t(s).scrollTop(
                                    t(s).scrollTop() - r.scrollSpeed,
                                ))
                              : t(e).height() - (i.pageY - t(s).scrollTop()) <
                                    r.scrollSensitivity &&
                                (c = t(s).scrollTop(
                                    t(s).scrollTop() + r.scrollSpeed,
                                )),
                          i.pageX - t(s).scrollLeft() < r.scrollSensitivity
                              ? (c = t(s).scrollLeft(
                                    t(s).scrollLeft() - r.scrollSpeed,
                                ))
                              : t(e).width() - (i.pageX - t(s).scrollLeft()) <
                                    r.scrollSensitivity &&
                                (c = t(s).scrollLeft(
                                    t(s).scrollLeft() + r.scrollSpeed,
                                )));
            ...
            (this.scrollTimer && clearTimeout(this.scrollTimer),
                ...
                d.dirAx &&
                    ...
                    d.distX > 0 &&
                        ...
                        this.placeEl.parents(r.listNodeName).length +
                            this.dragDepth <=
                            r.maxDepth &&
                            (o.length
                                ? (o = a
                                      .children(r.listNodeName)
                                      .last()).append(this.placeEl)
                                : this.createSubLevel(a, this.placeEl))),
                    d.distX < 0 &&
                        (this.placeEl.next(r.itemNodeName).length ||
                            ((n = this.placeEl.parent()),
                            this.placeEl
                                .closest(r.itemNodeName)
                                .after(this.placeEl),
                            n.children().length ||
                                this.unsetParent(n.parent())))));
            var f = !1;
            if (
                ...
                (this.pointEl = t(
                    s.elementFromPoint(
                        ...
                        i.pageY -
                            (e.pageYOffset || s.documentElement.scrollTop),
                    ),
                )),
                l || (this.dragEl[0].style.visibility = "visible"),
                this.pointEl.hasClass(r.handleClass) &&
                    (this.pointEl = this.pointEl.closest(r.itemNodeName)),
                this.pointEl.hasClass(r.emptyClass))
            )
                f = !0;
            else if (
                !this.pointEl.length ||
                !this.pointEl.hasClass(r.itemClass)
            )
                return;
            ...
            if (!d.dirAx || m || f) {
                ...
                if (
                    ...
                    this.dragDepth + 1 !==
                        this.pointEl.parents(r.listNodeName).length
                )
                    return;
                if (
                    this.dragDepth -
                ...
                ((n = this.placeEl.parent()),
                    f
                        ? ((o = t(s.createElement(r.listNodeName)).addClass(
                              r.listClass,
                          )).append(this.placeEl),
                          this.pointEl.replaceWith(o))
                        : g
