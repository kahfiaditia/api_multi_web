            ...
            ? jvm.SVGShapeElement.images[value]
                ...
                : jvm.whenImageLoaded(value).then(function (img) {
                      ((imageEl = new jvm.SVGElement("image")),
                          ...
                          that.canvas.defsElement.node.appendChild(
                              patternEl.node,
                          ),
                          (jvm.SVGShapeElement.images[value] = jvm
                ...
                case "r":
                    jvm.$("<div/>")
                        .css({
                            ...
                            background:
                                this.map.params.markerStyle.initial.fill,
                        })
                        .appendTo(sample);
            }
            (tick.append(sample),
    ...
    (jvm.Proj = {
        ...
        lcc: function (lat, lng, c) {
            var fi0 = 0,
                ...
                F =
                    (Math.cos(fi1) *
                        Math.pow(Math.tan(Math.PI / 4 + fi1 / 2), n)) /
                    n,
                ...
                (this.container
                    .mousemove(function (e) {
                        return (
                            mouseDown &&
                                ((map.transX -=
                                    (oldPageX - e.pageX) / map.scale),
                                (map.transY -=
                                    (oldPageY - e.pageY) / map.scale),
                                map.applyTransform(),
                                (oldPageX = e.pageX),
                                (oldPageY = e.pageY)),
                            !1
                    ...
                    ("touchstart" == e.type && (lastTouchesLength = 0),
                        1 == touches.length
                            ? (1 == lastTouchesLength &&
                                  ...
                                  (map.transX -=
                                      (touchX - touches[0].pageX) / map.scale),
                                  (map.transY -=
                                      (touchY - touches[0].pageY) / map.scale),
                                  map.applyTransform(),
                                  map.tip.hide(),
                                  (transXOld != map.transX ||
                                      transYOld != map.transY) &&
                ...
                this.container.delegate(
                    ...
                    function (e) {
                        var baseVal =
                            ...
                            tipShowEvent = jvm.$.Event(
                                type + "TipShow.jvectormap",
                            ),
                            overEvent = jvm.$.Event(type + "Over.jvectormap");
                        "mouseover" == e.type
                            ? (map.container.trigger(overEvent, [code]),
                              overEvent.isDefaultPrevented() ||
                                  element.setHovered(!0),
                              map.tip.text(tipText),
                              map.container.trigger(tipShowEvent, [
                                  map.tip,
                                  code,
                              ]),
                            ...
                            : (element.setHovered(!1),
                              map.tip.hide(),
                              map.container.trigger(type + "Out.jvectormap", [
                                  code,
                              ]));
                    },
                ),
                ...
                this.container.delegate(
                    ...
                    function () {
                        ...
                        mouseMoved ||
                            ...
                            (("region" === type &&
                                map.params.regionsSelectable) ||
                                ("marker" === type &&
                                    map.params.markersSelectable)) &&
                    ...
                    isCentered
                        ? ((transX =
                          ...
                          (transY =
                              ...
                              (this.defaultHeight *
                                  (this.height /
                                      (this.defaultHeight * scale))) /
                                  2))
                        : ((transX =
                              this.transX - ((zoomStep - 1) / scale) * anchorX),
                          (transY =
                              this.transY -
                              ((zoomStep - 1) / scale) * anchorY))),
                animate && count > 0
                    ? ((scaleStart = this.scale),
                      ...
                      (interval = setInterval(function () {
                          ((i += 1),
                              ...
                              (that.transX =
                                  (transXStart + transXDiff * i) / that.scale),
                              (that.transY =
                                  (transYStart + transYDiff * i) / that.scale),
                              that.applyTransform(),
                              i == count &&
            ...
            if (
                ...
                for (i = 0; i < codes.length; i++)
                    this.regions[codes[i]] &&
                        ((itemBbox =
                            this.regions[codes[i]].element.shape.getBBox()),
                        itemBbox &&
        ...
        createRegions: function () {
            ...
            for (key in this.mapData.paths)
                ((region = new jvm.Region({
                    ...
                    jvm
                        .$(region.shape)
                        .bind("selected", function (e, isSelected) {
                    ...
                    ? ((bbox = inset.bbox),
                          ...
                          this.scale),
                      {
                          x:
                              point.x +
                              this.transX * this.scale +
                              inset.left * this.scale,
                          y:
                              point.y +
                              this.transY * this.scale +
                              inset.top * this.scale,
                      })
                    : !1
            );
        },
        pointToLatLng: function (x, y) {
            ...
            for (i = 0; i < insets.length; i++)
                if (
                    ...
                    (nx =
                        x -
                        (this.transX * this.scale + inset.left * this.scale)),
                    (ny =
                        y -
                        (this.transY * this.scale + inset.top * this.scale)),
                    (nx =
                        (nx / (inset.width * this.scale)) *
                            (bbox[1].x - bbox[0].x) +
                        bbox[0].x),
                    (ny =
                        (ny / (inset.height * this.scale)) *
                            (bbox[1].y - bbox[0].y) +
                        bbox[0].y),
                    nx > bbox[0].x &&
                        nx < bbox[1].x &&
                    ...
                    return jvm.Proj[proj.type + "_inv"](
                        nx,
                        -ny,
                        centralMeridian,
                    );
    ...
    (jvm.MultiMap.prototype = {
                    ...
                    this.maps[name].container.on(
                        ...
                        function (e, code) {
                            var multimap = e.data.scope,
                                mapName = multimap.params.mapNameByCode(
                                    code,
                                    multimap,
                                );
                            (multimap.drillDownPromise &&
                                "pending" ===
                                    multimap.drillDownPromise.state()) ||
        ...
        drillDown: function (name, code) {
            ...
            (focusPromise.then(function () {
                ...
                (this.drillDownPromise = jvm.$.when(
                    downloadPromise,
                    focusPromise,
                )),
                    ...
                    (currentMap.params.container.hide(),
                        that.maps[name]
                            ...
                            : that.addMap(name, {
                                  map: name,
                                  multiMapLevel:
                                      currentMap.params.multiMapLevel + 1,
                              }),
