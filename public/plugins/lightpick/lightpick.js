...
(function (root, factory) {
    ...
    var document = window.document,
        ...
        weekdayName = function (opts, day, weekdayStyle) {
            return new Date(1970, 0, day, 12, 0, 0, 0).toLocaleString(
                opts.lang,
        ...
        renderDay = function (opts, date, dummy, extraClass) {
            ...
            if (opts.disableDates) {
                for (var i = 0; i < opts.disableDates.length; i++) {
                    if (
                        ...
                        moment(opts.disableDates[i], opts.format).isSame(
                            date,
                            "day",
                        )
                    ) {
            ...
            if (opts.minDays && opts.startDate && !opts.endDate) {
                if (
                    date.isBetween(
                        moment(opts.startDate).subtract(
                            opts.minDays - 1,
                            "day",
                        ),
                    ...
                    if (
                        opts.selectForward &&
                        date.isSameOrAfter(opts.startDate)
                    ) {
        ...
        renderMonthsList = function (date, opts) {
            ...
            for (var idx = 0; idx < 12; idx++) {
                ...
                option.text = d
                    .toDate()
                    .toLocaleString(opts.lang, { month: "long" });
        ...
        Lightpick = function (options) {
            ...
            self._onMouseDown = function (e) {
                ...
                if (
                    ...
                    var day = moment(
                        parseInt(target.getAttribute("data-time")),
                    );
                    ...
                    if (
                        ...
                        var start = day.isAfter(opts.startDate)
                                ...
                                ? moment(day)
                                : moment(opts.startDate),
                            isInvalidRange = opts.disableDates.filter(
                                function (d) {
                                    if (
                                        d instanceof Array ||
                    ...
                    target.classList.contains("lightpick__previous-action")
                ) {
                    self.prevMonth();
                } else if (
                    target.classList.contains("lightpick__next-action")
                ) {
                    self.nextMonth();
                } else if (
                    ...
                    target.classList.contains("lightpick__reset-action")
                ) {
                    self.reset();
                }
            };
            self._onMouseEnter = function (e) {
                ...
                if ((opts.startDate && !opts.endDate) || opts.repick) {
                    ...
                    if (opts.hoveringTooltip) {
                        ...
                        var tooltip = self.el.querySelector(
                            ".lightpick__tooltip",
                        );
            ...
            self._onChange = function (e) {
                ...
                if (target.classList.contains("lightpick__select-months")) {
                    ...
                    target.classList.contains("lightpick__select-years")
                ) {
            ...
            self._onClick = function (e) {
                ...
                do {
                    if (
                        (parentEl.classList &&
                            parentEl.classList.contains("lightpick")) ||
                        parentEl === opts.field ||
            ...
            self.showTooltip = function (target, text) {
                ...
                var hasParentEl =
                        self.el.classList.contains("lightpick--inlined"),
            ...
            if (opts.secondField) {
                opts.secondField.addEventListener(
                    "change",
                    self._onInputChange,
                );
    ...
    Lightpick.prototype = {
        config: function (options) {
            ...
            if (
                Object.prototype.toString.call(options.locale) ===
                "[object Object]"
            ) {
        ...
        syncFields: function () {
            if (this._opts.singleDate || this._opts.secondField) {
                if (
                    moment(this._opts.field.value, this._opts.format).isValid()
                ) {
        ...
        destroy: function () {
            ...
            if (opts.secondField) {
                opts.secondField.removeEventListener(
                    "change",
                    this._onInputChange,
                );
                opts.secondField.removeEventListener(
