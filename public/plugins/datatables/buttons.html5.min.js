(function (i) {
    "function" === typeof define && define.amd
        ...
        : "object" === typeof exports
          ? (module.exports = function (j, l, v, u) {
                j || (j = window);
                if (!l || !l.fn.dataTable)
                    l = require("datatables.net")(j, l).$;
                l.fn.dataTable.Buttons ||
                    require("datatables.net-buttons")(j, l);
    ...
    function A(a, b) {
        w === s &&
            (w =
                ...
                y
                    .serializeToString(
                        i.parseXML(B["xl/worksheets/sheet1.xml"]),
                    )
                    .indexOf("xmlns:r"));
            ...
            if (i.isPlainObject(c)) {
                ...
                if (w) {
                    ...
                    for (g = b.attributes.length - 1; 0 <= g; g--) {
                        ...
                        -1 !== e.indexOf(":") &&
                            (n.push({ name: e, value: h }),
                            b.removeAttribute(e));
                    }
                    g = 0;
                    for (e = n.length; g < e; g++)
                        ((h = c.createAttribute(
                            n[g].name.replace(":", "_dt_b_namespace_token_"),
                        )),
                            (h.value = n[g].value),
                            b.setAttributeNode(h));
                }
    ...
    function q(a, b, d) {
        ...
        d &&
            (d.attr && i(c).attr(d.attr),
            d.children &&
                i.each(d.children, function (a, b) {
                    c.appendChild(b);
                }),
            null !== d.text &&
                d.text !== s &&
        ...
        var x = h.document.createElementNS("http://www.w3.org/1999/xhtml", "a"),
            ...
            F = function (a, b, d) {
                ...
                if (L)
                    ...
                    (f || (f = (h.URL || h.webkitURL || h).createObjectURL(a)),
                        d
                            ? (h.location.href = f)
                            : h.open(f, "_blank") || (h.location.href = f),
                        (c.readyState = c.DONE),
                        g(),
                        D(f));
            },
        ...
        H = function (a, b) {
            for (
                var d = G(b),
                    ...
                    g = b.fieldSeparator,
                    e = RegExp(f, "g"),
                    n = b.escapeChar !== s ? b.escapeChar : "\\",
                    i = function (a) {
                        for (var c = "", b = 0, d = a.length; b < d; b++)
                            (0 < b && (c += g),
                                (c += f
                                    ? f + ("" + a[b]).replace(e, n + f) + f
                                    : a[b]));
                        return c;
                    },
                    h = b.header ? i(c.header) + d : "",
    ...
    o.ext.buttons.pdfHtml5 = {
        ...
        available: function () {
            return j.FileReader !== s && (u || j.pdfMake);
        },
        text: function (a) {
        ...
        action: function (a, b, d, c) {
            ...
            for (var g = 0, e = d.body.length; g < e; g++)
                f.push(
                    i.map(d.body[g], function (a) {
                        return {
                            text: "string" === typeof a ? a : a + "",
            ...
            d = {
                ...
                content: [
                    { table: { headerRows: 1, body: f }, layout: "noBorders" },
                ],
                styles: {
                    tableHeader: {
                        bold: !0,
