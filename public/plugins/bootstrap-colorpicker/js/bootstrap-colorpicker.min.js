    ...
    return (function (e) {
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        ...
                                        if (Array.isArray(t)) o = t;
                                            ...
                                            if (
                                                !e.colorFormulas.hasOwnProperty(
                                                    t,
                                                )
                                            )
                                                throw new Error(
                                                    "No color formula found with the name '" +
                                                        t +
                                                        "'.",
                                                );
                                            o = e.colorFormulas[t];
        ...
        function (e, t, o) {
            ...
            var r = { bar_size_short: 16, base_margin: 6, columns: 6 },
                n =
                    r.bar_size_short * r.columns +
                    r.base_margin * (r.columns - 1);
            t.default = {
                customClass: null,
                color: !1,
                fallbackColor: !1,
                                ...
                                value: function () {
                                    return this.options.colors
                                        ? Array.isArray(this.options.colors)
                                            ...
                                            : "object" ===
                                                l(this.options.colors)
                                              ? Object.keys(this.options.colors)
                                                    .length
                                              : 0
                                        : 0;
                                },
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    return (
                                        !(this.getLength() <= 0) &&
                                        (Array.isArray(this.options.colors)
                                            ? this.options.colors.indexOf(e) >=
                                              0
                                                ? e
                                                : this.options.colors.indexOf(
                                                        e.toUpperCase(),
                                                    ) >= 0
                                                  ? e.toUpperCase()
                                                  : this.options.colors.indexOf(
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    for (var o in this.options.colors)
                                        if (
                                            this.options.colors.hasOwnProperty(
                                                o,
                                            ) &&
                                            this.options.colors[
                                                o
        ...
        function (e, t, o) {
            ...
            for (var s in l)
                if (l.hasOwnProperty(s)) {
                    ...
                    if (!("labels" in l[s]))
                        throw new Error(
                            "missing channel labels property: " + s,
                        );
                    if (l[s].labels.length !== l[s].channels)
                        throw new Error(
                            "channel and label counts mismatch: " + s,
                        );
                    var c = l[s].channels,
                        u = l[s].labels;
                    (delete l[s].channels,
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    (Array.isArray(this.options.extensions) ||
                                        ...
                                        this.options.extensions.forEach(
                                            function (o) {
                                                t.registerExtension(
                                                    e.extensions[
                                                        o.name.toLowerCase()
                        ...
                        l(t, [
                            {
                                ...
                                value: function (e) {
                                    (s(
                                        ...
                                        this.colorpicker.picker.append(
                                            this.element,
                                        ));
                                },
                            },
                                ...
                                value: function (e, t) {
                                    if (this.currentSlider) {
                                        ...
                                        ((o.guideStyle.left = t + "px"),
                                            ...
                                            o.callLeft &&
                                                i[o.callLeft](t / o.maxLeft),
                                            o.callTop &&
                                                i[o.callTop](e / o.maxTop),
                                            r.setValue(i),
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    if (!this.colorpicker.isDisabled()) {
                                        ((this.colorpicker.lastEvent.alias =
                                            "pressed"),
                                        ...
                                        if (!o.is(".colorpicker")) {
                                            ...
                                            var l = o
                                                .find(".colorpicker-guide")
                                                .get(0);
                                            if (
                                                null !== this.currentSlider &&
                                                null !== l
                                            ) {
                                                var s = o.offset();
                                                ((this.currentSlider.guideStyle =
                                                    l.style),
                        ...
                        i(e, [
                            {
                                ...
                                value: function () {
                                    ...
                                    (e.picker.addClass(
                                        "colorpicker-popup colorpicker-hidden",
                                    ),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    return (
                                        this.colorpicker.picker.hasClass(
                                            "colorpicker-visible",
                                        ) &&
                                        !this.colorpicker.picker.hasClass(
                                            "colorpicker-hidden",
                            ...
                            },
                            {
                                ...
                                get: function () {
                                    return (
                                        !this.colorpicker.options.inline &&
                                        !!this.popoverTip
                                    );
                                },
                            },
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    return (e =
                                        ...
                                        ? ((e =
                                              this.colorpicker.colorHandler.resolveColorDelegate(
                                                  e,
                                                  !1,
                                              )),
                                          !1 ===
        ...
        function (e, t, o) {
            ...
            function r(e, t) {
                ...
                if (void 0 === e)
                    ...
                    if (null === i)
                        throw new Error(
                            "Unable to parse color from string: " + e,
                        );
                    ((this.model = i.model),
                        (n = h[this.model].channels),
                        (this.color = i.value.slice(0, n)),
                        (this.valpha =
                            "number" == typeof i.value[n] ? i.value[n] : 1));
                } else if (e.length) {
                    ...
                    "alpha" in e &&
                        ...
                        (this.valpha =
                            "number" == typeof e.alpha ? e.alpha : 0));
                    var s = l.sort().join("");
                    if (!(s in d))
                        throw new Error(
            ...
            ((r.prototype = {
                ...
                string: function (e) {
                    ...
                    var o =
                        1 === t.valpha ? t.color : t.color.concat(this.valpha);
                ...
                round: function (e) {
                    return (
                        (e = Math.max(e || 0, 0)),
                        new r(
                            this.color.map(i(e)).concat(this.valpha),
                            this.model,
                        )
                    );
                },
                ...
                Object.keys(h).forEach(function (e) {
                    if (-1 === f.indexOf(e)) {
                        ...
                        ((r.prototype[e] = function () {
                            ...
                            var o =
                                "number" == typeof arguments[t]
                                    ? t
                                    : this.valpha;
                            return new r(
                                s(h[this.model][e].raw(this.color)).concat(o),
                                e,
                            );
                        }),
                            (r[e] = function (o) {
            ...
            ((c.get = function (e) {
                ...
                (c.get.rgb = function (e) {
                    ...
                    if ((t = e.match(l))) {
                        ...
                        n &&
                            (h[3] =
                                Math.round((parseInt(n, 16) / 255) * 100) /
                                100);
                    } else if ((t = e.match(a))) {
                        ...
                        n &&
                            (h[3] =
                                Math.round((parseInt(n + n, 16) / 255) * 100) /
                                100);
                    } else if ((t = e.match(s))) {
        ...
        function (e, t, o) {
            ...
            (Object.keys(i).forEach(function (e) {
                ((l[e] = {}),
                    Object.defineProperty(l[e], "channels", {
                        value: i[e].channels,
                    }),
        ...
        function (e, t, o) {
            function r() {
                for (
                    var e = {}, t = Object.keys(l), o = t.length, r = 0;
                    r < o;
                    r++
                )
                    ...
                    return (
                        i(e, [
                            ...
                            },
                            {
                                key: "unbind",
                                value: function () {
                                    this.colorpicker.element.removeData(
                                        "color",
                                    );
                                },
                            },
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    if (
                                        this.fallback &&
                                        this.fallback === this.color
                                    )
                                        return this.color;
                                    var e = this.resolveColorDelegate(
                                            this.fallback,
                                        ),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    return (
                                        !1 !== this.colorpicker.options.useAlpha
                                    );
                                },
                            },
                            {
                            ...
                            },
                            {
                                key: "color",
                                get: function () {
                                    return this.colorpicker.element.data(
                                        "color",
                                    );
                                },
                                set: function (e) {
                    ...
                    return (
                        n(e, [
                            ...
                            },
                            {
                                key: "bind",
                                value: function () {
                                    ((this.addon = this.colorpicker.options
                                        .addon
                                        ? this.colorpicker.element.find(
